...
`)}function Be(e){return{idle:pe(Oe(e,`idle`)),thinking:pe(Oe(e,`thinking`))}}function Ve(e,t){let n=Be(e),r=JSON.stringify(Re);return`<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
...
private let orbRibbonInstanceCount = ${F}
...
}`}var Ue=`apple-orc`;function We(e){if(!e||typeof e!=`object`||Array.isArray(e))return!1;let t=e;return t.source===`apple-orc`?t.type===`ping`?!0:t.type===`setState`?t.state===`idle`||t.state===`thinking`:t.type===`setText`&&typeof t.text==`string`&&t.text.length<=280:!1}function Ge(e,t){let n=new URLSearchParams(e).get(`parentOrigin`)??t;if(!n)return null;try{let e=new URL(n);return e.protocol===`https:`||e.protocol===`http:`?e.origin:null}catch{return null}}function Ke(e,t=`/`){return`${e.replace(/\/$/,``)}${t===`/`?``:t.replace(/\/$/,``)}`}function qe(e,t){let n=new URL(`${Ke(e)}/embed.html`);if(n.protocol!==`https:`&&n.protocol!==`http:`)throw Error(`Embed URLs require HTTP(S)`);return n.hash=t.replace(/^#/,``),n.href}function Je(e){return e.replaceAll(`&`,`&amp;`).replaceAll(`"`,`&quot;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`)}function Ye(e){return Number.isFinite(e)?Math.round(Math.min(1200,Math.max(72,e))):120}function Xe(e,t,n=120){return`<iframe\n  title="Apple Orc"\n  src="${Je(qe(e,t))}"\n  style="border:0;width:100%;max-width:420px;height:${Ye(n)}px;background:transparent"\n></iframe>`}function Ze(e,t,n=120){let r=qe(e,t),i=new URL(r).origin;return`import { useRef } from "react";\n\nexport function AppleOrcEmbed() {\n  const frame = useRef(null);\n  return (\n    <>\n      <iframe\n        ref={frame}\n        title="Apple Orc"\n        src=${JSON.stringify(r)}\n        style={{ border: 0, width: "100%", maxWidth: 420, height: ${Ye(n)}, background: "transparent" }}\n      />\n      <button onClick={() => frame.current?.contentWindow?.postMessage(\n        { source: "apple-orc", type: "setState", state: "thinking" },\n        ${JSON.stringify(i)},\n      )}>Thinking</button>\n    </>\n  );\n}\n\n// JavaScript / JSX example. In TSX use useRef<HTMLIFrameElement>(null).\n// Wait for the iframe load or ready event before sending commands.\n// Add ?parentOrigin=YOUR_ENCODED_ORIGIN before # when using no-referrer.`}function Qe(){return`import { AppleOrc } from "@/lib/orb";
...
// required styles and license notices; see the integration guide.`}function $e(e,t,n){let r=Oe(e.configuration,`thinking`),i=Oe(e.configuration,`idle`);return JSON.stringify({preset:r.style,state:e.activeState,preview:t,text:n,activationDuration:e.configuration.activationDuration,transitionDuration:e.configuration.transitionDuration,thinking:r,idle:i},null,2)}function et(e,t,n,r,i){let a=r===`scene`?120:360;return{web:Ve(e.configuration,e.activeState),swift:He(e.configuration,e.activeState),iframe:Xe(t,n,a),react:Ze(t,n,a),dropin:Qe(),json:$e(e,r,i)}}function tt(){return typeof window<`u`}function nt(){if(!tt())return`en`;try{let e=window.localStorage.getItem(te);if(e===`zh`||e===`en`)return e}catch{}return navigator.language.toLowerCase().startsWith(`zh`)?`zh`:`en`}function rt(e){if(tt())try{window.localStorage.setItem(te,e)}catch{}}function it(){return new URLSearchParams(window.location.hash.replace(/^#/,``))}function at(){return tt()&&it().get(`preview`)===`scene`?`scene`:`orb`}function ot(){if(!tt())return w;let e=it().get(`text`);return e===null?w:M(e)}function st(e,t){return e===`thinking`?t:`idle${t.charAt(0).toUpperCase()}${t.slice(1)}`}function ct(){return{configuration:De(C.style),activeState:ve}}function lt(){if(!tt())return ct();let e=it(),t=e.get(`style`),n=t&&ee.includes(t)?t:C.style,r={style:n,...x[n]},i=e.get(`glass`);i===`1`&&(r.glassEnabled=!0),i===`0`&&(r.glassEnabled=!1);for(let t of oe){let n=e.get(t.key);if(n===null)continue;let i=Number(n);Number.isFinite(i)&&(r[t.key]=le(i,t.min,t.max))}for(let t of A){let n=e.get(t);if(n===null)continue;let i=j(n);i&&(r[t]=i)}let a=e.get(`transition`),o=a===null?null:Number(a),s=o!==null&&Number.isFinite(o)?le(o,T.min,T.max):be,c=e.get(`activation`),l=c===null?null:Number(c),u=Ee(r,s,l!==null&&Number.isFinite(l)?le(l,ne.min,ne.max):ye);for(let t of _e){let n=e.get(st(`idle`,t));if(n!==null){if(typeof u.profiles.idle[t]==`number`){let e=k.get(t),r=Number(n);e&&Number.isFinite(r)&&(u=ke(u,`idle`,t,le(r,e.min,e.max)))}else{let e=j(n);e&&(u=ke(u,`idle`,t,e))}}}let d=e.get(`state`),f=d&&me.includes(d)?d:ve;return{configuration:u,activeState:f}}function ut(e,t,n){let{configuration:r,activeState:i}=e,a=Oe(r,`thinking`),o=new URLSearchParams;o.set(`effect`,`orb-glass-liquid`),o.set(`style`,a.style),o.set(`glass`,a.glassEnabled?`1`:`0`),o.set(`state`,i),o.set(`activation`,String(r.activationDuration)),o.set(`transition`,String(r.transitionDuration)),o.set(`preview`,t),o.set(`text`,n);for(let e of oe)o.set(e.key,String(a[e.key])),Ce(e.key)&&o.set(st(`idle`,e.key),String(r.profiles.idle[e.key]));for(let e of A)o.set(e,a[e]),Ce(e)&&o.set(st(`idle`,e),r.profiles.idle[e]);return o.toString()}function dt(e,t,n){tt()&&window.history.replaceState(window.history.state,``,`#${ut(e,t,n)}`)}var ft=[`sphere`,`ellipse`,`wave`,`capsule`],pt={sphere:0,ellipse:.34,wave:.67,capsule:1},mt={zh:{sphere:`圆球`,ellipse:`椭圆`,wave:`波纹`,capsule:`胶囊`},en:{sphere:`Sphere`,ellipse:`Ellipse`,wave:`Wave`,capsule:`Capsule`}},ht=[{shape:`sphere`,morph:0,widthScale:1,heightScale:1,waveY:0,waveAmp:.16,waveThick:.11,waveSoft:.22,bodyAlpha:1,glass:1,corner:1,silhouette:0},{shape:`ellipse`,morph:.34,widthScale:1.58,heightScale:.86,waveY:.32,waveAmp:.14,waveThick:.12,waveSoft:.58,bodyAlpha:1,glass:1,corner:1,silhouette:0},{shape:`wave`,morph:.67,widthScale:2.12,heightScale:.44,waveY:0,waveAmp:.46,waveThick:.18,waveSoft:.18,bodyAlpha:0,glass:0,corner:.5,silhouette:.35},{shape:`capsule`,morph:1,widthScale:1.86,heightScale:1.02,waveY:.48,waveAmp:.16,waveThick:.12,waveSoft:.66,bodyAlpha:1,glass:1,corner:1,silhouette:1}];function gt(e,t,n){return e+(t-e)*n}function _t(e){let t=Math.min(1,Math.max(0,e));return t*t*(3-2*t)}function vt(e){return 1-(1-Math.min(1,Math.max(0,e)))**4}function yt(e){return e<.17?`sphere`:e<.505?`ellipse`:e<.835?`wave`:`capsule`}function bt(e){let t=Math.min(1,Math.max(0,e)),n=ht[0],r=ht[1];for(let e=0;e<ht.length-1;e+=1){if(t>=ht[e].morph&&t<=ht[e+1].morph){n=ht[e],r=ht[e+1];break}t>ht[e+1].morph&&(n=ht[e+1],r=ht[Math.min(e+2,ht.length-1)])}let i=Math.max(r.morph-n.morph,1e-4),a=_t((t-n.morph)/i);return{shape:a<.5?n.shape:r.shape,widthScale:gt(n.widthScale,r.widthScale,a),heightScale:gt(n.heightScale,r.heightScale,a),waveY:gt(n.waveY,r.waveY,a),waveAmp:gt(n.waveAmp,r.waveAmp,a),waveThick:gt(n.waveThick,r.waveThick,a),waveSoft:gt(n.waveSoft,r.waveSoft,a),bodyAlpha:gt(n.bodyAlpha,r.bodyAlpha,a),glass:gt(n.glass,r.glass,a),corner:gt(n.corner,r.corner,a),silhouette:gt(n.silhouette,r.silhouette,a)}}function xt(e){return e.silhouette>.5?`stadium`:`ellipse`}function St(e){return[Number.parseInt(e.slice(1,3),16),Number.parseInt(e.slice(3,5),16),Number.parseInt(e.slice(5,7),16)]}function I(e,t){let[n,r,i]=St(e);return`rgba(${n}, ${r}, ${i}, ${t})`}function Ct(e,t,n){let r=St(e),i=St(t),a=Math.min(1,Math.max(0,n));return`#${[Math.round(r[0]+(i[0]-r[0])*a),Math.round(r[1]+(i[1]-r[1])*a),Math.round(r[2]+(i[2]-r[2])*a)].map(e=>e.toString(16).padStart(2,`0`)).join(``)}`}function wt(e,t){let n=(t%1+1)%1;return n<.25?Ct(e.colorA,e.colorB,n/.25):n<.5?Ct(e.colorB,e.colorC,(n-.25)/.25):n<.75?Ct(e.colorC,e.colorD,(n-.5)/.25):Ct(e.colorD,e.colorA,(n-.75)/.25)}function Tt(e,t,n,r,i,a){let o=Math.max(0,Math.min(a,r/2,i/2));if(e.beginPath(),typeof e.roundRect==`function`){e.roundRect(t,n,r,i,o);return}e.moveTo(t+o,n),e.arcTo(t+r,n,t+r,n+i,o),e.arcTo(t+r,n+i,t,n+i,o),e.arcTo(t,n+i,t,n,o),e.arcTo(t,n,t+r,n,o),e.closePath()}function Et(e,t,n,r,i,a){if(a){Tt(e,t-r/2,n-i/2,r,i,Math.min(r,i)/2);return}e.beginPath(),e.ellipse(t,n,r/2,i/2,0,0,Math.PI*2)}function Dt(e,t,n,r,i,a,o,s,c=0,l=!1,u=.3){let d=i*(.92+.08*Math.sin(o*.85)),f=[{color:s.colorD,offset:-.7,freq:1.82,lag:.28,width:1.22,alpha:.62},{color:s.colorC,offset:-.34,freq:2.12,lag:1.02,width:1.08,alpha:.86},{color:s.highlightColor,offset:0,freq:2.02,lag:.12,width:.48,alpha:1},{color:s.colorB,offset:.32,freq:2.26,lag:2.05,width:1.12,alpha:.88},{color:s.colorA,offset:.68,freq:1.9,lag:2.68,width:1.24,alpha:.78}],p=l?[0,Math.PI]:[0],m=l?128:96,h=(e,t,n,r,i)=>{let a=Math.max(0,Math.cos(Math.min(Math.abs(e),1)*Math.PI*.5))**1.22,c=i===0?1:-.82;return Math.sin(e*(2.02+s.zoom*2.6)*t+o*2.08+n+i)*d*a+Math.sin(e*4.7-o*1.18+n*.42+i*.45)*d*.24*a+r*d*.88*c*a},g=(t,n,i,a,o,s,c)=>{e.beginPath();for(let s=0;s<=m;s+=1){let c=s/m*2-1,l=c*r,u=.42+.58*Math.cos(c*Math.PI*.5),d=h(c,t,n,i,a)-o*u;s===0?e.moveTo(l,d):e.lineTo(l,d)}for(let s=m;s>=0;--s){let c=s/m*2-1,l=c*r,u=.42+.58*Math.cos(c*Math.PI*.5),d=h(c,t,n,i,a)+o*u;e.lineTo(l,d)}e.closePath();let l=e.createLinearGradient(-r,0,r,0);l.addColorStop(0,I(s,0)),l.addColorStop(.1,I(s,c*.4)),l.addColorStop(.5,I(s,c)),l.addColorStop(.9,I(s,c*.4)),l.addColorStop(1,I(s,0)),e.fillStyle=l,e.fill()};e.save(),e.translate(t,n+c),e.globalCompositeOperation=`lighter`,e.filter=`blur(${Math.max(2.4,a*(.5+u*1.6))}px)`;for(let e of p)g(2.05,.2,0,e,a*(1.5+u),s.glowColor,.3*s.exposure),g(2.12,1.1,-.2,e,a*(1.15+u*.4),s.colorC,.24*s.exposure);e.filter=u>.4?`blur(${Math.max(1.2,a*.45*u)}px)`:`none`;for(let e of p)for(let t of f)g(t.freq,t.lag,t.offset,e,Math.max(1.1,a*t.width*(e===0?.52:.44)*(1+u*.35)),t.color,t.alpha*(e===0?1:.82)*(1-u*.12));e.filter=`blur(${Math.max(1.1,a*(.28+u*.4))}px)`,e.lineCap=`round`,e.lineJoin=`round`,e.strokeStyle=I(s.highlightColor,.78-u*.2),e.lineWidth=Math.max(1.1,a*.28),e.beginPath();for(let t=0;t<=m;t+=1){let n=t/m*2-1,i=n*r,a=Math.max(0,Math.cos(Math.min(Math.abs(n),1)*Math.PI*.5))**1.35,c=Math.sin(n*(2.12+s.zoom*2.4)+o*2.08)*d*a*.72;t===0?e.moveTo(i,c):e.lineTo(i,c)}e.stroke(),e.filter=`none`;let _=e.createRadialGradient(0,0,1,0,0,Math.max(r*.42,d*2.4));_.addColorStop(0,I(s.highlightColor,.22*s.exposure)),_.addColorStop(.35,I(s.colorA,.08*s.exposure)),_.addColorStop(1,`rgba(0,0,0,0)`),e.fillStyle=_,e.beginPath(),e.ellipse(0,0,r*.34,Math.max(d*1.6,a*1.8),0,0,Math.PI*2),e.fill(),e.restore()}function Ot(e,t,n,r,i){let a=bt(i.shapeMorph),o=Math.min(t,n),s=1+i.contourDeform*.42,c=1+.012*Math.sin(r*.62),l=Math.min(t*.94,o*a.widthScale*i.radius)*s*c,u=Math.min(n*.9,o*a.heightScale*i.radius)/Math.sqrt(s)/c,d=t/2,f=n/2,p=xt(a)===`stadium`,m=a.bodyAlpha<.18,h=a.waveAmp>.12,g=m?t*.46:l*.46,_=(m?n*.2:Math.min(u,l)*a.waveAmp)*(.82+i.ridgeAmt*.4),v=m?Math.max(12,t*.036):Math.min(u,l)*a.waveThick*(.92+i.zoom*.35),y=f+(m?0:u*.5*a.waveY);if(e.clearRect(0,0,t,n),i.edgeGlow>.01||a.bodyAlpha<.45||a.glass>.4){let r=Math.max(l,u)*(.62+i.edgeGlow*.5),a=e.createRadialGradient(d,y,2,d,y,r);a.addColorStop(0,I(i.glowColor,.32*Math.max(i.edgeGlow,.18)*i.exposure)),a.addColorStop(.42,I(i.colorB,.08*i.exposure)),a.addColorStop(1,`rgba(0,0,0,0)`),e.fillStyle=a,e.fillRect(0,0,t,n)}if(m)Dt(e,d,y,Math.min(t*.48,Math.max(l*.52,t*.42)),_*1.28,v*1.28,r,i,0,!0,a.waveSoft);else{let t=Math.min(l,u);e.save(),e.globalCompositeOperation=`lighter`,e.filter=`blur(${Math.max(4,t*.05)}px)`,e.strokeStyle=I(i.highlightColor,.42*a.glass),e.lineWidth=Math.max(3,t*.055),Et(e,d,f,l,u,p),e.stroke(),e.filter=`blur(${Math.max(2,t*.018)}px)`,e.strokeStyle=I(i.colorB,.28*a.glass),e.lineWidth=Math.max(1.4,t*.02),Et(e,d,f,l,u,p),e.stroke(),e.restore(),e.save(),e.globalAlpha=a.bodyAlpha,Et(e,d,f,l,u,p),e.clip();let n=e.createRadialGradient(d,f-u*.22,Math.min(l,u)*.05,d,f,Math.max(l,u)*.78);n.addColorStop(0,Ct(i.colorA,`#08080f`,.82+i.shade*.12)),n.addColorStop(.48,Ct(i.colorD,`#04040a`,.88)),n.addColorStop(1,`#010104`),e.fillStyle=n,e.fillRect(d-l,f-u,l*2,u*2);let o=e.createLinearGradient(d,f-u/2,d,f+u/2);if(o.addColorStop(0,`rgba(255,255,255,0.14)`),o.addColorStop(.4,`rgba(0,0,0,0)`),o.addColorStop(1,`rgba(0,0,0,0.48)`),e.fillStyle=o,e.fillRect(d-l,f-u,l*2,u*2),Dt(e,d,y,g,_,v,r,i,0,h,a.waveSoft),e.restore(),i.glassEnabled&&a.glass>.05){if(e.save(),e.globalAlpha=a.glass*Math.max(i.glassOpacity,.35),Et(e,d,f,l,u,p),e.clip(),typeof e.createConicGradient==`function`){let n=e.createConicGradient(-Math.PI*.55,d,f);n.addColorStop(0,I(i.colorA,.38)),n.addColorStop(.18,I(i.highlightColor,.22)),n.addColorStop(.4,I(i.colorB,.28)),n.addColorStop(.62,I(i.colorC,.24)),n.addColorStop(.82,I(i.colorD,.22)),n.addColorStop(1,I(i.colorA,.38)),e.globalCompositeOperation=`lighter`,e.strokeStyle=n,e.lineWidth=Math.max(1.6,t*.022),Et(e,d,f,l-3,u-3,p),e.stroke(),e.globalCompositeOperation=`source-over`}let n=e.createLinearGradient(d-l*.5,f-u*.5,d+l*.5,f+u*.5);n.addColorStop(0,I(i.sheenColor,.28+i.sheen*.16)),n.addColorStop(.42,`rgba(255,255,255,0)`),n.addColorStop(1,I(i.shellEdge,.16+i.shellEdgeAlpha*.2)),e.fillStyle=n,e.fillRect(d-l,f-u,l*2,u*2),e.globalCompositeOperation=`lighter`;let r=e.createRadialGradient(d-l*.24,f-u*.32,2,d-l*.18,f-u*.24,Math.min(l,u)*.48);r.addColorStop(0,I(i.sheenColor,.62)),r.addColorStop(.36,I(i.specColor,.16)),r.addColorStop(1,`rgba(255,255,255,0)`),e.fillStyle=r,e.beginPath(),e.ellipse(d-l*.18,f-u*.26,l*.3,u*.22,-.5,0,Math.PI*2),e.fill(),e.restore()}e.save(),e.strokeStyle=I(i.highlightColor,.34+i.sheen*.16),e.lineWidth=Math.max(1.2,t*(.01+i.edgeSoftness*.3)),Et(e,d,f,l-1.4,u-1.4,p),e.stroke(),e.restore()}}function kt(e,t,n,r,i,a){let o=r*(.1+a.warp*.018)*(.45+a.ridgeAmt),s=r*(.16+a.zoom*.22),c=n+Math.sin(i*1.15)*r*.1;e.save(),e.translate(t,c),e.rotate(Math.sin(i*.27)*.12*(.4+a.contourDeform)),e.filter=`blur(${Math.max(1.2,r*.055)}px)`;let l=e.createLinearGradient(-r,0,r,0);l.addColorStop(0,I(a.colorD,0)),l.addColorStop(.18,I(a.colorD,.85)),l.addColorStop(.38,a.colorC),l.addColorStop(.52,a.colorB),l.addColorStop(.7,a.colorA),l.addColorStop(.88,I(a.colorD,.7)),l.addColorStop(1,I(a.colorD,0)),e.beginPath(),e.moveTo(-r,0);for(let t=0;t<=48;t+=1){let n=-r+2*r*t/48,s=n/r,c=Math.sin(s*(2.2+a.zoom*4)+i*2.1)*o+Math.sin(s*5.4-i*1.3)*o*.28;e.lineTo(n,c)}e.strokeStyle=l,e.lineWidth=s,e.lineCap=`round`,e.stroke(),e.filter=`blur(${Math.max(.6,r*.03)}px)`,e.globalCompositeOperation=`lighter`,e.strokeStyle=I(a.highlightColor,.45),e.lineWidth=s*.28,e.stroke(),e.restore()}function At(e,t,n,r,i,a){let o=Math.max(2,Math.round(a.ribbonCount));e.save(),e.globalCompositeOperation=`lighter`;for(let s=0;s<o;s+=1){let o=i*.7+s*.6;e.beginPath();for(let i=0;i<=40;i+=1){let a=i/40*Math.PI*2+o*.4+s,c=r*(.22+.18*Math.cos(a*2+o)),l=t+Math.cos(a+s*.4)*c*1.6,u=n+Math.sin(a*.85+o)*c*.55;i===0?e.moveTo(l,u):e.lineTo(l,u)}e.strokeStyle=I(wt(a,s*.18+i*.02),.55),e.lineWidth=Math.max(1.2,r*.045*a.ribbonWidth*2),e.lineCap=`round`,e.filter=`blur(${Math.max(.8,r*.02*a.particleBloom)}px)`,e.stroke()}e.restore()}function jt(e,t,n,r,i,a){e.save(),e.translate(t,n),e.rotate(a.metalAngle*Math.PI/180);let o=10+Math.round(a.bandDensity*3);for(let t=0;t<o;t+=1){let n=-r+2*r*t/o+Math.sin(i+t)*r*.04,s=e.createLinearGradient(n,-r,n+r*.18,r);s.addColorStop(0,I(a.colorA,.15)),s.addColorStop(.4,I(a.colorB,.55)),s.addColorStop(.7,I(a.shellMid,.4)),s.addColorStop(1,I(a.colorD,.2)),e.fillStyle=s,e.fillRect(n,-r,r*(.08+a.metalStretch*.1),r*2)}e.restore()}function Mt(e,t,n,r,i){if(!i.glassEnabled)return;let a=e.createRadialGradient(t,n,r*.55,t,n,r);a.addColorStop(0,`rgba(255,255,255,0)`),a.addColorStop(.72,I(i.shellInner,.02)),a.addColorStop(.88,I(i.shellMid,.18+i.sheen*.12)),a.addColorStop(1,I(i.shellEdge,.42+i.shellEdgeAlpha*.35)),e.fillStyle=a,e.beginPath(),e.arc(t,n,r,0,Math.PI*2),e.fill(),e.save(),e.globalCompositeOperation=`lighter`;let o=e.createRadialGradient(t-r*.32,n-r*.38,r*.02,t-r*.22,n-r*.32,r*.42);o.addColorStop(0,I(i.sheenColor,.55)),o.addColorStop(.45,I(i.specColor,.12)),o.addColorStop(1,`rgba(255,255,255,0)`),e.fillStyle=o,e.beginPath(),e.ellipse(t-r*.18,n-r*.28,r*.42,r*.28,-.5,0,Math.PI*2),e.fill(),e.restore()}function Nt(e,t,n,r,i){if(i.style===`siriAi`){Ot(e,t,n,r,i);return}let a=t/2,o=n/2,s=Math.max(8,Math.min(t,n)*.5*i.radius);if(e.clearRect(0,0,t,n),i.edgeGlow>.01){let r=e.createRadialGradient(a,o,s*.7,a,o,s*(1.35+i.edgeGlow));r.addColorStop(0,I(i.glowColor,.22*i.edgeGlow*i.exposure)),r.addColorStop(1,`rgba(0,0,0,0)`),e.fillStyle=r,e.fillRect(0,0,t,n)}e.save(),e.beginPath(),e.arc(a,o,s,0,Math.PI*2),e.clip();let c=e.createRadialGradient(a,o-s*.15,s*.08,a,o,s);c.addColorStop(0,Ct(i.colorA,`#0a0a12`,.55+i.shade*.2)),c.addColorStop(.55,Ct(i.colorD,`#050509`,.72)),c.addColorStop(1,`#030308`),e.fillStyle=c,e.fillRect(a-s,o-s,s*2,s*2);let l=i.style;l===`particleRibbon`?At(e,a,o,s,r,i):l===`chromaticMetal`||l===`chrome`?(jt(e,a,o,s,r,i),l===`chromaticMetal`&&(e.save(),e.globalCompositeOperation=`screen`,e.filter=`blur(${s*.04}px)`,e.fillStyle=I(i.shellMid,.25*i.chromaticShift),e.fillRect(a-s+3,o-s,s*2,s*2),e.fillStyle=I(i.shellEdge,.2*i.chromaticShift),e.fillRect(a-s-3,o-s,s*2,s*2),e.restore())):(kt(e,a,o,s,r,i),(l===`aurora`||l===`plasma`)&&(e.save(),e.globalAlpha=.55,e.translate(0,s*.18),e.rotate(.4),kt(e,a,o,s*.85,r*.7+1.2,i),e.restore())),e.restore(),Mt(e,a,o,s,i),e.beginPath(),e.arc(a,o,s,0,Math.PI*2),e.strokeStyle=I(i.highlightColor,.22+i.sheen*.1),e.lineWidth=Math.max(1,s*(.012+i.edgeSoftness)),e.stroke()}function Pt({canvas:e,getTarget:t}){let n=e.getContext(`2d`);if(!n)return()=>{};let r=n,i=!1,a=0,o=null,s=0,c=Le(t());function l(n){if(i)return;let u=Math.min(window.devicePixelRatio||1,2),d=Math.max(1,Math.floor(e.clientWidth*u)),f=Math.max(1,Math.floor(e.clientHeight*u));(e.width!==d||e.height!==f)&&(e.width=d,e.height=f);let p=c.sample(t(),n),m=o===null?0:Math.min(.1,Math.max(0,(n-o)/1e3));o=n,s+=m*Math.max(p.speed,0),Nt(r,d,f,s,p),a=requestAnimationFrame(l)}return a=requestAnimationFrame(l),()=>{i=!0,cancelAnimationFrame(a)}}function Ft({canvas:e,getTarget:t,onError:n,onReady:r}){let i=!1,a=0,o=null,s=null,c=!1,l=!1,u=null,d=0;function f(e){i||l||(l=!0,cancelAnimationFrame(a),s?.destroy(),o?.destroy(),n(e))}async function p(){if(!navigator.gpu)throw Error(`当前浏览器不支持 WebGPU`);let n=await navigator.gpu.requestAdapter();if(!n)throw Error(`未找到可用的 WebGPU 适配器`);if(o=await n.requestDevice(),i){o.destroy();return}let p=e.getContext(`webgpu`);if(!p)throw Error(`无法创建 WebGPU 画布上下文`);let m=p,h=navigator.gpu.getPreferredCanvasFormat();m.configure({device:o,format:h,alphaMode:`premultiplied`});let g=o.createShaderModule({label:`orb-glass-liquid`,code:Re}),_=(await g.getCompilationInfo()).messages.filter(e=>e.type===`error`);if(_.length>0)throw Error(_.map(e=>`${e.lineNum}:${e.linePos} ${e.message}`).join(`
`));if(i||l)return;let v=o.createRenderPipeline({label:`orb-glass-liquid-pipeline`,layout:`auto`,vertex:{module:g,entryPoint:`vs_main`},fragment:{module:g,entryPoint:`fs_main`,targets:[{format:h,blend:{color:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}}}]},primitive:{topology:`triangle-list`}}),y=o.createRenderPipeline({label:`particle-ribbon-pipeline`,layout:`auto`,vertex:{module:g,entryPoint:`ribbon_vs_main`},fragment:{module:g,entryPoint:`ribbon_fs_main`,targets:[{format:h,blend:{color:{srcFactor:`one`,dstFactor:`one`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}}}]},primitive:{topology:`triangle-list`}}),b=o.createRenderPipeline({label:`particle-ribbon-glass-composite-pipeline`,layout:`auto`,vertex:{module:g,entryPoint:`vs_main`},fragment:{module:g,entryPoint:`ribbon_composite_fs_main`,targets:[{format:h,blend:{color:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}}}]},primitive:{topology:`triangle-list`}}),x=new Float32Array(140),ee=o.createBuffer({size:x.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),C=o.createBindGroup({layout:v.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:ee}}]}),w=o.createBindGroup({layout:y.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:ee}}]}),te=o.createSampler({addressModeU:`clamp-to-edge`,addressModeV:`clamp-to-edge`,magFilter:`linear`,minFilter:`linear`}),ne=null,T=Le(t());o.lost.then(e=>{f(Error(`WebGPU 设备已断开：${e.message||e.reason}`))}),o.addEventListener(`uncapturederror`,e=>{e.preventDefault(),f(Error(`WebGPU 渲染错误：${e.error.message}`))});function re(){let t=Math.min(window.devicePixelRatio||1,2),n=Math.max(1,Math.floor(e.clientWidth*t)),r=Math.max(1,Math.floor(e.clientHeight*t));(e.width!==n||e.height!==r)&&(e.width=n,e.height=r,s?.destroy(),s=null,ne=null)}function E(){s&&ne||(s=o.createTexture({label:`particle-ribbon-offscreen-texture`,size:{width:e.width,height:e.height},format:h,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),ne=o.createBindGroup({layout:b.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:ee}},{binding:1,resource:s.createView()},{binding:2,resource:te}]}))}function D(n){if(!(i||l||!o))try{re();let p=T.sample(t(),n),h=u===null?0:Math.min(.1,Math.max(0,(n-u)/1e3));u=n,d+=h*Math.max(p.speed,0);let g=d/Math.max(p.speed,.001);fe(x,e.width,e.height,g,p),o.queue.writeBuffer(ee,0,x);let _=S[p.style]===S.particleRibbon,te=o.createCommandEncoder();if(_){E();let e=te.beginRenderPass({colorAttachments:[{view:s.createView(),clearValue:{r:0,g:0,b:0,a:0},loadOp:`clear`,storeOp:`store`}]});e.setPipeline(y),e.setBindGroup(0,w),e.draw(6,F,0,0),e.end()}let O=te.beginRenderPass({colorAttachments:[{view:m.getCurrentTexture().createView(),clearValue:{r:0,g:0,b:0,a:0},loadOp:`clear`,storeOp:`store`}]});_?(O.setPipeline(b),O.setBindGroup(0,ne)):(O.setPipeline(v),O.setBindGroup(0,C)),O.draw(3,1,0,0),O.end(),o.queue.submit([te.finish()]),o.queue.onSubmittedWorkDone().then(()=>{i||l||(c||(c=!0,r()),a=requestAnimationFrame(D))}).catch(e=>{f(e instanceof Error?e:Error(String(e)))})}catch(e){f(e instanceof Error?e:Error(String(e)))}}a=requestAnimationFrame(D)}return p().catch(e=>{f(e instanceof Error?e:Error(String(e)))}),()=>{i=!0,cancelAnimationFrame(a),s?.destroy(),o?.destroy()}}function It(e){var t,n,r=``;if(typeof e==`string`||typeof e==`number`)r+=e;else if(typeof e==`object`){if(Array.isArray(e)){var i=e.length;for(t=0;t<i;t++)e[t]&&(n=It(e[t]))&&(r&&(r+=` `),r+=n)}else for(n in e)e[n]&&(r&&(r+=` `),r+=n)}return r}function Lt(){for(var e,t,n=0,r=``,i=arguments.length;n<i;n++)(e=arguments[n])&&(t=It(e))&&(r&&(r+=` `),r+=t);return r}var Rt=(e,t)=>{let n=Array(e.length+t.length);for(let t=0;t<e.length;t++)n[t]=e[t];for(let r=0;r<t.length;r++)n[e.length+r]=t[r];return n},zt=(e,t)=>({classGroupId:e,validator:t}),Bt=(e=new Map,t=null,n)=>({nextPart:e,validators:t,classGroupId:n}),Vt=`-`,Ht=[],Ut=`arbitrary..`,Wt=e=>{let t=qt(e),{conflictingClassGroups:n,conflictingClassGroupModifiers:r}=e;return{getClassGroupId:e=>{if(e.startsWith(`[`)&&e.endsWith(`]`))return Kt(e);let n=e.split(Vt);return Gt(n,+(n[0]===``&&n.length>1),t)},getConflictingClassGroupIds:(e,t)=>{if(t){let t=r[e],i=n[e];return t?i?Rt(i,t):t:i||Ht}return n[e]||Ht}}},Gt=(e,t,n)=>{if(e.length-t===0)return n.classGroupId;let r=e[t],i=n.nextPart.get(r);if(i){let n=Gt(e,t+1,i);if(n)return n}let a=n.validators;if(a===null)return;let o=t===0?e.join(Vt):e.slice(t).join(Vt),s=a.length;for(let e=0;e<s;e++){let t=a[e];if(t.validator(o))return t.classGroupId}},Kt=e=>e.slice(1,-1).indexOf(`:`)===-1?void 0:(()=>{let t=e.slice(1,-1),n=t.indexOf(`:`),r=t.slice(0,n);return r?Ut+r:void 0})(),qt=e=>{let{theme:t,classGroups:n}=e;return Jt(n,t)},Jt=(e,t)=>{let n=Bt();for(let r in e){let i=e[r];Yt(i,n,r,t)}return n},Yt=(e,t,n,r)=>{let i=e.length;for(let a=0;a<i;a++){let i=e[a];Xt(i,t,n,r)}},Xt=(e,t,n,r)=>{if(typeof e==`string`){Zt(e,t,n);return}if(typeof e==`function`){Qt(e,t,n,r);return}$t(e,t,n,r)},Zt=(e,t,n)=>{let r=e===``?t:en(t,e);r.classGroupId=n},Qt=(e,t,n,r)=>{if(tn(e)){Yt(e(r),t,n,r);return}t.validators===null&&(t.validators=[]),t.validators.push(zt(n,e))},$t=(e,t,n,r)=>{let i=Object.entries(e),a=i.length;for(let e=0;e<a;e++){let[a,o]=i[e];Yt(o,en(t,a),n,r)}},en=(e,t)=>{let n=e,r=t.split(Vt),i=r.length;for(let e=0;e<i;e++){let t=r[e],i=n.nextPart.get(t);i||(i=Bt(),n.nextPart.set(t,i)),n=i}return n},tn=e=>`isThemeGetter`in e&&e.isThemeGetter===!0,nn=e=>{if(e<1)return{get:()=>void 0,set:()=>{}};let t=0,n=Object.create(null),r=Object.create(null),i=(i,a)=>{n[i]=a,t++,t>e&&(t=0,r=n,n=Object.create(null))};return{get(e){let t=n[e];if(t!==void 0)return t;if((t=r[e])!==void 0)return i(e,t),t},set(e,t){e in n?n[e]=t:i(e,t)}}},rn=`!`,an=`:`,on=[],sn=(e,t,n,r,i)=>({modifiers:e,hasImportantModifier:t,baseClassName:n,maybePostfixModifierPosition:r,isExternal:i}),cn=e=>{let{prefix:t,experimentalParseClassName:n}=e,r=e=>{let t=[],n=0,r=0,i=0,a,o=e.length;for(let s=0;s<o;s++){let o=e[s];if(n===0&&r===0){if(o===an){t.push(e.slice(i,s)),i=s+1;continue}if(o===`/`){a=s;continue}}o===`[`?n++:o===`]`?n--:o===`(`?r++:o===`)`&&r--}let s=t.length===0?e:e.slice(i),c=s,l=!1;s.endsWith(rn)?(c=s.slice(0,-1),l=!0):s.startsWith(rn)&&(c=s.slice(1),l=!0);let u=a&&a>i?a-i:void 0;return sn(t,l,c,u)};if(t){let e=t+an,n=r;r=t=>t.startsWith(e)?n(t.slice(e.length)):sn(on,!1,t,void 0,!0)}if(n){let e=r;r=t=>n({className:t,parseClassName:e})}return r},ln=e=>{let t=new Map;return e.orderSensitiveModifiers.forEach((e,n)=>{t.set(e,1e6+n)}),e=>{let n=[],r=[];for(let i=0;i<e.length;i++){let a=e[i],o=a[0]===`[`,s=t.has(a);o||s?(r.length>0&&(r.sort(),n.push(...r),r=[]),n.push(a)):r.push(a)}return r.length>0&&(r.sort(),n.push(...r)),n}},un=e=>({cache:nn(e.cacheSize),parseClassName:cn(e),sortModifiers:ln(e),postfixLookupClassGroupIds:dn(e),...Wt(e)}),dn=e=>{let t=Object.create(null),n=e.postfixLookupClassGroups;if(n)for(let e=0;e<n.length;e++)t[n[e]]=!0;return t},fn=/\s+/,pn=(e,t)=>{let{parseClassName:n,getClassGroupId:r,getConflictingClassGroupIds:i,sortModifiers:a,postfixLookupClassGroupIds:o}=t,s=[],c=e.trim().split(fn),l=``;for(let e=c.length-1;e>=0;--e){let t=c[e],{isExternal:u,modifiers:d,hasImportantModifier:f,baseClassName:p,maybePostfixModifierPosition:m}=n(t);if(u){l=t+(l.length>0?` `+l:l);continue}let h=!!m,g;if(h){g=r(p.substring(0,m));let e=g&&o[g]?r(p):void 0;e&&e!==g&&(g=e,h=!1)}else g=r(p);if(!g){if(!h){l=t+(l.length>0?` `+l:l);continue}if(g=r(p),!g){l=t+(l.length>0?` `+l:l);continue}h=!1}let _=d.length===0?``:d.length===1?d[0]:a(d).join(`:`),v=f?_+rn:_,y=v+g;if(s.indexOf(y)>-1)continue;s.push(y);let b=i(g,h);for(let e=0;e<b.length;++e){let t=b[e];s.push(v+t)}l=t+(l.length>0?` `+l:l)}return l},mn=(...e)=>{let t=0,n,r,i=``;for(;t<e.length;)(n=e[t++])&&(r=hn(n))&&(i&&(i+=` `),i+=r);return i},hn=e=>{if(typeof e==`string`)return e;let t,n=``;for(let r=0;r<e.length;r++)e[r]&&(t=hn(e[r]))&&(n&&(n+=` `),n+=t);return n},gn=(e,...t)=>{let n,r,i,a,o=o=>(n=un(t.reduce((e,t)=>t(e),e())),r=n.cache.get,i=n.cache.set,a=s,s(o)),s=e=>{let t=r(e);if(t)return t;let a=pn(e,n);return i(e,a),a};return a=o,(...e)=>a(mn(...e))},_n=[],vn=e=>{let t=t=>t[e]||_n;return t.isThemeGetter=!0,t},yn=/^\[(?:(\w[\w-]*):)?(.+)\]$/i,bn=/^\((?:(\w[\w-]*):)?(.+)\)$/i,xn=/^\d+(?:\.\d+)?\/\d+(?:\.\d+)?$/,Sn=/^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/,Cn=/\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/,wn=/^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/,Tn=/^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/,En=/^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/,Dn=e=>xn.test(e),L=e=>!!e&&!Number.isNaN(Number(e)),On=e=>!!e&&Number.isInteger(Number(e)),kn=e=>e.endsWith(`%`)&&L(e.slice(0,-1)),An=e=>Sn.test(e),jn=()=>!0,Mn=e=>Cn.test(e)&&!wn.test(e),Nn=()=>!1,Pn=e=>Tn.test(e),Fn=e=>En.test(e),In=e=>!R(e)&&!z(e),Ln=e=>e.startsWith(`@container`)&&(e[10]===`/`&&e[11]!==void 0||e[11]===`s`&&e[16]!==void 0&&e.startsWith(`-size/`,10)||e[11]===`n`&&e[18]!==void 0&&e.startsWith(`-normal/`,10)),Rn=e=>$n(e,rr,Nn),R=e=>yn.test(e),zn=e=>$n(e,ir,Mn),Bn=e=>$n(e,ar,L),Vn=e=>$n(e,sr,jn),Hn=e=>$n(e,or,Nn),Un=e=>$n(e,tr,Nn),Wn=e=>$n(e,nr,Fn),Gn=e=>$n(e,cr,Pn),z=e=>bn.test(e),Kn=e=>er(e,ir),qn=e=>er(e,or),Jn=e=>er(e,tr),Yn=e=>er(e,rr),Xn=e=>er(e,nr),Zn=e=>er(e,cr,!0),Qn=e=>er(e,sr,!0),$n=(e,t,n)=>{let r=yn.exec(e);return r?r[1]?t(r[1]):n(r[2]):!1},er=(e,t,n=!1)=>{let r=bn.exec(e);return r?r[1]?t(r[1]):n:!1},tr=e=>e===`position`||e===`percentage`,nr=e=>e===`image`||e===`url`,rr=e=>e===`length`||e===`size`||e===`bg-size`,ir=e=>e===`length`,ar=e=>e===`number`,or=e=>e===`family-name`,sr=e=>e===`number`||e===`weight`,cr=e=>e===`shadow`,lr=gn(()=>{let e=vn(`color`),t=vn(`font`),n=vn(`text`),r=vn(`font-weight`),i=vn(`tracking`),a=vn(`leading`),o=vn(`breakpoint`),s=vn(`container`),c=vn(`spacing`),l=vn(`radius`),u=vn(`shadow`),d=vn(`inset-shadow`),f=vn(`text-shadow`),p=vn(`drop-shadow`),m=vn(`blur`),h=vn(`perspective`),g=vn(`aspect`),_=vn(`ease`),v=vn(`animate`),y=()=>[`auto`,`avoid`,`all`,`avoid-page`,`page`,`left`,`right`,`column`],b=()=>[`center`,`top`,`bottom`,`left`,`right`,`top-left`,`left-top`,`top-right`,`right-top`,`bottom-right`,`right-bottom`,`bottom-left`,`left-bottom`],x=()=>[...b(),z,R],ee=()=>[`auto`,`hidden`,`clip`,`visible`,`scroll`],S=()=>[`auto`,`contain`,`none`],C=()=>[z,R,c],w=()=>[Dn,`full`,`auto`,...C()],te=()=>[On,`none`,`subgrid`,z,R],ne=()=>[`auto`,{span:[`full`,On,z,R]},On,z,R],T=()=>[On,`auto`,z,R],re=()=>[`auto`,`min`,`max`,`fr`,z,R],E=()=>[`start`,`end`,`center`,`between`,`around`,`evenly`,`stretch`,`baseline`,`center-safe`,`end-safe`],D=()=>[`start`,`end`,`center`,`stretch`,`center-safe`,`end-safe`],O=()=>[`auto`,...C()],ie=()=>[Dn,`auto`,`full`,`dvw`,`dvh`,`lvw`,`lvh`,`svw`,`svh`,`min`,`max`,`fit`,...C()],ae=()=>[Dn,`screen`,`full`,`dvw`,`lvw`,`svw`,`min`,`max`,`fit`,...C()],oe=()=>[Dn,`screen`,`full`,`lh`,`dvh`,`lvh`,`svh`,`min`,`max`,`fit`,...C()],k=()=>[e,z,R],A=()=>[...b(),Jn,Un,{position:[z,R]}],se=()=>[`no-repeat`,{repeat:[``,`x`,`y`,`space`,`round`]}],ce=()=>[`auto`,`cover`,`contain`,Yn,Rn,{size:[z,R]}],le=()=>[kn,Kn,zn],j=()=>[``,`none`,`full`,l,z,R],M=()=>[``,L,Kn,zn],N=()=>[`solid`,`dashed`,`dotted`,`double`],ue=()=>[`normal`,`multiply`,`screen`,`overlay`,`darken`,`lighten`,`color-dodge`,`color-burn`,`hard-light`,`soft-light`,`difference`,`exclusion`,`hue`,`saturation`,`color`,`luminosity`],P=()=>[L,kn,Jn,Un],de=()=>[``,`none`,m,z,R],fe=()=>[`none`,L,z,R],pe=()=>[`none`,L,z,R],F=()=>[L,z,R],me=()=>[Dn,`full`,...C()];return{cacheSize:500,theme:{animate:[`spin`,`ping`,`pulse`,`bounce`],aspect:[`video`],blur:[An],breakpoint:[An],color:[jn],container:[An],"drop-shadow":[An],ease:[`in`,`out`,`in-out`],font:[In],"font-weight":[`thin`,`extralight`,`light`,`normal`,`medium`,`semibold`,`bold`,`extrabold`,`black`],"inset-shadow":[An],leading:[`none`,`tight`,`snug`,`normal`,`relaxed`,`loose`],perspective:[`dramatic`,`near`,`normal`,`midrange`,`distant`,`none`],radius:[An],shadow:[An],spacing:[`px`,L],text:[An],"text-shadow":[An],tracking:[`tighter`,`tight`,`normal`,`wide`,`wider`,`widest`]},classGroups:{aspect:[{aspect:[`auto`,`square`,Dn,R,z,g]}],container:[`container`],"container-type":[{"@container":[``,`normal`,`size`,z,R]}],"container-named":[Ln],columns:[{columns:[L,R,z,s]}],"break-after":[{"break-after":y()}],"break-before":[{"break-before":y()}],"break-inside":[{"break-inside":[`auto`,`avoid`,`avoid-page`,`avoid-column`]}],"box-decoration":[{"box-decoration":[`slice`,`clone`]}],box:[{box:[`border`,`content`]}],display:[`block`,`inline-block`,`inline`,`flex`,`inline-flex`,`table`,`inline-table`,`table-caption`,`table-cell`,`table-column`,`table-column-group`,`table-footer-group`,`table-header-group`,`table-row-group`,`table-row`,`flow-root`,`grid`,`inline-grid`,`contents`,`list-item`,`hidden`],sr:[`sr-only`,`not-sr-only`],float:[{float:[`right`,`left`,`none`,`start`,`end`]}],clear:[{clear:[`left`,`right`,`both`,`none`,`start`,`end`]}],isolation:[`isolate`,`isolation-auto`],"object-fit":[{object:[`contain`,`cover`,`fill`,`none`,`scale-down`]}],"object-position":[{object:x()}],overflow:[{overflow:ee()}],"overflow-x":[{"overflow-x":ee()}],"overflow-y":[{"overflow-y":ee()}],overscroll:[{overscroll:S()}],"overscroll-x":[{"overscroll-x":S()}],"overscroll-y":[{"overscroll-y":S()}],position:[`static`,`fixed`,`absolute`,`relative`,`sticky`],inset:[{inset:w()}],"inset-x":[{"inset-x":w()}],"inset-y":[{"inset-y":w()}],start:[{"inset-s":w(),start:w()}],end:[{"inset-e":w(),end:w()}],"inset-bs":[{"inset-bs":w()}],"inset-be":[{"inset-be":w()}],top:[{top:w()}],right:[{right:w()}],bottom:[{bottom:w()}],left:[{left:w()}],visibility:[`visible`,`invisible`,`collapse`],z:[{z:[On,`auto`,z,R]}],basis:[{basis:[Dn,`full`,`auto`,s,...C()]}],"flex-direction":[{flex:[`row`,`row-reverse`,`col`,`col-reverse`]}],"flex-wrap":[{flex:[`nowrap`,`wrap`,`wrap-reverse`]}],flex:[{flex:[L,Dn,`auto`,`initial`,`none`,R]}],grow:[{grow:[``,L,z,R]}],shrink:[{shrink:[``,L,z,R]}],order:[{order:[On,`first`,`last`,`none`,z,R]}],"grid-cols":[{"grid-cols":te()}],"col-start-end":[{col:ne()}],"col-start":[{"col-start":T()}],"col-end":[{"col-end":T()}],"grid-rows":[{"grid-rows":te()}],"row-start-end":[{row:ne()}],"row-start":[{"row-start":T()}],"row-end":[{"row-end":T()}],"grid-flow":[{"grid-flow":[`row`,`col`,`dense`,`row-dense`,`col-dense`]}],"auto-cols":[{"auto-cols":re()}],"auto-rows":[{"auto-rows":re()}],gap:[{gap:C()}],"gap-x":[{"gap-x":C()}],"gap-y":[{"gap-y":C()}],"justify-content":[{justify:[...E(),`normal`]}],"justify-items":[{"justify-items":[...D(),`normal`]}],"justify-self":[{"justify-self":[`auto`,...D()]}],"align-content":[{content:[`normal`,...E()]}],"align-items":[{items:[...D(),{baseline:[``,`last`]}]}],"align-self":[{self:[`auto`,...D(),{baseline:[``,`last`]}]}],"place-content":[{"place-content":E()}],"place-items":[{"place-items":[...D(),`baseline`]}],"place-self":[{"place-self":[`auto`,...D()]}],p:[{p:C()}],px:[{px:C()}],py:[{py:C()}],ps:[{ps:C()}],pe:[{pe:C()}],pbs:[{pbs:C()}],pbe:[{pbe:C()}],pt:[{pt:C()}],pr:[{pr:C()}],pb:[{pb:C()}],pl:[{pl:C()}],m:[{m:O()}],mx:[{mx:O()}],my:[{my:O()}],ms:[{ms:O()}],me:[{me:O()}],mbs:[{mbs:O()}],mbe:[{mbe:O()}],mt:[{mt:O()}],mr:[{mr:O()}],mb:[{mb:O()}],ml:[{ml:O()}],"space-x":[{"space-x":C()}],"space-x-reverse":[`space-x-reverse`],"space-y":[{"space-y":C()}],"space-y-reverse":[`space-y-reverse`],size:[{size:ie()}],"inline-size":[{inline:[`auto`,...ae()]}],"min-inline-size":[{"min-inline":[`auto`,...ae()]}],"max-inline-size":[{"max-inline":[`none`,...ae()]}],"block-size":[{block:[`auto`,...oe()]}],"min-block-size":[{"min-block":[`auto`,...oe()]}],"max-block-size":[{"max-block":[`none`,...oe()]}],w:[{w:[s,`screen`,...ie()]}],"min-w":[{"min-w":[s,`screen`,`none`,...ie()]}],"max-w":[{"max-w":[s,`screen`,`none`,`prose`,{screen:[o]},...ie()]}],h:[{h:[`screen`,`lh`,...ie()]}],"min-h":[{"min-h":[`screen`,`lh`,`none`,...ie()]}],"max-h":[{"max-h":[`screen`,`lh`,...ie()]}],"font-size":[{text:[`base`,n,Kn,zn]}],"font-smoothing":[`antialiased`,`subpixel-antialiased`],"font-style":[`italic`,`not-italic`],"font-weight":[{font:[r,Qn,Vn]}],"font-stretch":[{"font-stretch":[`ultra-condensed`,`extra-condensed`,`condensed`,`semi-condensed`,`normal`,`semi-expanded`,`expanded`,`extra-expanded`,`ultra-expanded`,kn,R]}],"font-family":[{font:[qn,Hn,t]}],"font-features":[{"font-features":[R]}],"fvn-normal":[`normal-nums`],"fvn-ordinal":[`ordinal`],"fvn-slashed-zero":[`slashed-zero`],"fvn-figure":[`lining-nums`,`oldstyle-nums`],"fvn-spacing":[`proportional-nums`,`tabular-nums`],"fvn-fraction":[`diagonal-fractions`,`stacked-fractions`],tracking:[{tracking:[i,z,R]}],"line-clamp":[{"line-clamp":[L,`none`,z,Bn]}],leading:[{leading:[a,...C()]}],"list-image":[{"list-image":[`none`,z,R]}],"list-style-position":[{list:[`inside`,`outside`]}],"list-style-type":[{list:[`disc`,`decimal`,`none`,z,R]}],"text-alignment":[{text:[`left`,`center`,`right`,`justify`,`start`,`end`]}],"placeholder-color":[{placeholder:k()}],"text-color":[{text:k()}],"text-decoration":[`underline`,`overline`,`line-through`,`no-underline`],"text-decoration-style":[{decoration:[...N(),`wavy`]}],"text-decoration-thickness":[{decoration:[L,`from-font`,`auto`,z,zn]}],"text-decoration-color":[{decoration:k()}],"underline-offset":[{"underline-offset":[L,`auto`,z,R]}],"text-transform":[`uppercase`,`lowercase`,`capitalize`,`normal-case`],"text-overflow":[`truncate`,`text-ellipsis`,`text-clip`],"text-wrap":[{text:[`wrap`,`nowrap`,`balance`,`pretty`]}],indent:[{indent:C()}],"tab-size":[{tab:[On,z,R]}],"vertical-align":[{align:[`baseline`,`top`,`middle`,`bottom`,`text-top`,`text-bottom`,`sub`,`super`,z,R]}],whitespace:[{whitespace:[`normal`,`nowrap`,`pre`,`pre-line`,`pre-wrap`,`break-spaces`]}],break:[{break:[`normal`,`words`,`all`,`keep`]}],wrap:[{wrap:[`break-word`,`anywhere`,`normal`]}],hyphens:[{hyphens:[`none`,`manual`,`auto`]}],content:[{content:[`none`,z,R]}],"bg-attachment":[{bg:[`fixed`,`local`,`scroll`]}],"bg-clip":[{"bg-clip":[`border`,`padding`,`content`,`text`]}],"bg-origin":[{"bg-origin":[`border`,`padding`,`content`]}],"bg-position":[{bg:A()}],"bg-repeat":[{bg:se()}],"bg-size":[{bg:ce()}],"bg-image":[{bg:[`none`,{linear:[{to:[`t`,`tr`,`r`,`br`,`b`,`bl`,`l`,`tl`]},On,z,R],radial:[``,z,R],conic:[On,z,R]},Xn,Wn]}],"bg-color":[{bg:k()}],"gradient-from-pos":[{from:le()}],"gradient-via-pos":[{via:le()}],"gradient-to-pos":[{to:le()}],"gradient-from":[{from:k()}],"gradient-via":[{via:k()}],"gradient-to":[{to:k()}],rounded:[{rounded:j()}],"rounded-s":[{"rounded-s":j()}],"rounded-e":[{"rounded-e":j()}],"rounded-t":[{"rounded-t":j()}],"rounded-r":[{"rounded-r":j()}],"rounded-b":[{"rounded-b":j()}],"rounded-l":[{"rounded-l":j()}],"rounded-ss":[{"rounded-ss":j()}],"rounded-se":[{"rounded-se":j()}],"rounded-ee":[{"rounded-ee":j()}],"rounded-es":[{"rounded-es":j()}],"rounded-tl":[{"rounded-tl":j()}],"rounded-tr":[{"rounded-tr":j()}],"rounded-br":[{"rounded-br":j()}],"rounded-bl":[{"rounded-bl":j()}],"border-w":[{border:M()}],"border-w-x":[{"border-x":M()}],"border-w-y":[{"border-y":M()}],"border-w-s":[{"border-s":M()}],"border-w-e":[{"border-e":M()}],"border-w-bs":[{"border-bs":M()}],"border-w-be":[{"border-be":M()}],"border-w-t":[{"border-t":M()}],"border-w-r":[{"border-r":M()}],"border-w-b":[{"border-b":M()}],"border-w-l":[{"border-l":M()}],"divide-x":[{"divide-x":M()}],"divide-x-reverse":[`divide-x-reverse`],"divide-y":[{"divide-y":M()}],"divide-y-reverse":[`divide-y-reverse`],"border-style":[{border:[...N(),`hidden`,`none`]}],"divide-style":[{divide:[...N(),`hidden`,`none`]}],"border-color":[{border:k()}],"border-color-x":[{"border-x":k()}],"border-color-y":[{"border-y":k()}],"border-color-s":[{"border-s":k()}],"border-color-e":[{"border-e":k()}],"border-color-bs":[{"border-bs":k()}],"border-color-be":[{"border-be":k()}],"border-color-t":[{"border-t":k()}],"border-color-r":[{"border-r":k()}],"border-color-b":[{"border-b":k()}],"border-color-l":[{"border-l":k()}],"divide-color":[{divide:k()}],"outline-style":[{outline:[...N(),`none`,`hidden`]}],"outline-offset":[{"outline-offset":[L,z,R]}],"outline-w":[{outline:[``,L,Kn,zn]}],"outline-color":[{outline:k()}],shadow:[{shadow:[``,`none`,u,Zn,Gn]}],"shadow-color":[{shadow:k()}],"inset-shadow":[{"inset-shadow":[`none`,d,Zn,Gn]}],"inset-shadow-color":[{"inset-shadow":k()}],"ring-w":[{ring:M()}],"ring-w-inset":[`ring-inset`],"ring-color":[{ring:k()}],"ring-offset-w":[{"ring-offset":[L,zn]}],"ring-offset-color":[{"ring-offset":k()}],"inset-ring-w":[{"inset-ring":M()}],"inset-ring-color":[{"inset-ring":k()}],"text-shadow":[{"text-shadow":[`none`,f,Zn,Gn]}],"text-shadow-color":[{"text-shadow":k()}],opacity:[{opacity:[L,z,R]}],"mix-blend":[{"mix-blend":[...ue(),`plus-darker`,`plus-lighter`]}],"bg-blend":[{"bg-blend":ue()}],"mask-clip":[{"mask-clip":[`border`,`padding`,`content`,`fill`,`stroke`,`view`]},`mask-no-clip`],"mask-composite":[{mask:[`add`,`subtract`,`intersect`,`exclude`]}],"mask-image-linear-pos":[{"mask-linear":[L]}],"mask-image-linear-from-pos":[{"mask-linear-from":P()}],"mask-image-linear-to-pos":[{"mask-linear-to":P()}],"mask-image-linear-from-color":[{"mask-linear-from":k()}],"mask-image-linear-to-color":[{"mask-linear-to":k()}],"mask-image-t-from-pos":[{"mask-t-from":P()}],"mask-image-t-to-pos":[{"mask-t-to":P()}],"mask-image-t-from-color":[{"mask-t-from":k()}],"mask-image-t-to-color":[{"mask-t-to":k()}],"mask-image-r-from-pos":[{"mask-r-from":P()}],"mask-image-r-to-pos":[{"mask-r-to":P()}],"mask-image-r-from-color":[{"mask-r-from":k()}],"mask-image-r-to-color":[{"mask-r-to":k()}],"mask-image-b-from-pos":[{"mask-b-from":P()}],"mask-image-b-to-pos":[{"mask-b-to":P()}],"mask-image-b-from-color":[{"mask-b-from":k()}],"mask-image-b-to-color":[{"mask-b-to":k()}],"mask-image-l-from-pos":[{"mask-l-from":P()}],"mask-image-l-to-pos":[{"mask-l-to":P()}],"mask-image-l-from-color":[{"mask-l-from":k()}],"mask-image-l-to-color":[{"mask-l-to":k()}],"mask-image-x-from-pos":[{"mask-x-from":P()}],"mask-image-x-to-pos":[{"mask-x-to":P()}],"mask-image-x-from-color":[{"mask-x-from":k()}],"mask-image-x-to-color":[{"mask-x-to":k()}],"mask-image-y-from-pos":[{"mask-y-from":P()}],"mask-image-y-to-pos":[{"mask-y-to":P()}],"mask-image-y-from-color":[{"mask-y-from":k()}],"mask-image-y-to-color":[{"mask-y-to":k()}],"mask-image-radial":[{"mask-radial":[z,R]}],"mask-image-radial-from-pos":[{"mask-radial-from":P()}],"mask-image-radial-to-pos":[{"mask-radial-to":P()}],"mask-image-radial-from-color":[{"mask-radial-from":k()}],"mask-image-radial-to-color":[{"mask-radial-to":k()}],"mask-image-radial-shape":[{"mask-radial":[`circle`,`ellipse`]}],"mask-image-radial-size":[{"mask-radial":[{closest:[`side`,`corner`],farthest:[`side`,`corner`]}]}],"mask-image-radial-pos":[{"mask-radial-at":b()}],"mask-image-conic-pos":[{"mask-conic":[L]}],"mask-image-conic-from-pos":[{"mask-conic-from":P()}],"mask-image-conic-to-pos":[{"mask-conic-to":P()}],"mask-image-conic-from-color":[{"mask-conic-from":k()}],"mask-image-conic-to-color":[{"mask-conic-to":k()}],"mask-mode":[{mask:[`alpha`,`luminance`,`match`]}],"mask-origin":[{"mask-origin":[`border`,`padding`,`content`,`fill`,`stroke`,`view`]}],"mask-position":[{mask:A()}],"mask-repeat":[{mask:se()}],"mask-size":[{mask:ce()}],"mask-type":[{"mask-type":[`alpha`,`luminance`]}],"mask-image":[{mask:[`none`,z,R]}],filter:[{filter:[``,`none`,z,R]}],blur:[{blur:de()}],brightness:[{brightness:[L,z,R]}],contrast:[{contrast:[L,z,R]}],"drop-shadow":[{"drop-shadow":[``,`none`,p,Zn,Gn]}],"drop-shadow-color":[{"drop-shadow":k()}],grayscale:[{grayscale:[``,L,z,R]}],"hue-rotate":[{"hue-rotate":[L,z,R]}],invert:[{invert:[``,L,z,R]}],saturate:[{saturate:[L,z,R]}],sepia:[{sepia:[``,L,z,R]}],"backdrop-filter":[{"backdrop-filter":[``,`none`,z,R]}],"backdrop-blur":[{"backdrop-blur":de()}],"backdrop-brightness":[{"backdrop-brightness":[L,z,R]}],"backdrop-contrast":[{"backdrop-contrast":[L,z,R]}],"backdrop-grayscale":[{"backdrop-grayscale":[``,L,z,R]}],"backdrop-hue-rotate":[{"backdrop-hue-rotate":[L,z,R]}],"backdrop-invert":[{"backdrop-invert":[``,L,z,R]}],"backdrop-opacity":[{"backdrop-opacity":[L,z,R]}],"backdrop-saturate":[{"backdrop-saturate":[L,z,R]}],"backdrop-sepia":[{"backdrop-sepia":[``,L,z,R]}],"border-collapse":[{border:[`collapse`,`separate`]}],"border-spacing":[{"border-spacing":C()}],"border-spacing-x":[{"border-spacing-x":C()}],"border-spacing-y":[{"border-spacing-y":C()}],"table-layout":[{table:[`auto`,`fixed`]}],caption:[{caption:[`top`,`bottom`]}],transition:[{transition:[``,`all`,`colors`,`opacity`,`shadow`,`transform`,`none`,z,R]}],"transition-behavior":[{transition:[`normal`,`discrete`]}],duration:[{duration:[L,`initial`,z,R]}],ease:[{ease:[`linear`,`initial`,_,z,R]}],delay:[{delay:[L,z,R]}],animate:[{animate:[`none`,v,z,R]}],backface:[{backface:[`hidden`,`visible`]}],perspective:[{perspective:[h,z,R]}],"perspective-origin":[{"perspective-origin":x()}],rotate:[{rotate:fe()}],"rotate-x":[{"rotate-x":fe()}],"rotate-y":[{"rotate-y":fe()}],"rotate-z":[{"rotate-z":fe()}],scale:[{scale:pe()}],"scale-x":[{"scale-x":pe()}],"scale-y":[{"scale-y":pe()}],"scale-z":[{"scale-z":pe()}],"scale-3d":[`scale-3d`],skew:[{skew:F()}],"skew-x":[{"skew-x":F()}],"skew-y":[{"skew-y":F()}],transform:[{transform:[z,R,``,`none`,`gpu`,`cpu`]}],"transform-origin":[{origin:x()}],"transform-style":[{transform:[`3d`,`flat`]}],translate:[{translate:me()}],"translate-x":[{"translate-x":me()}],"translate-y":[{"translate-y":me()}],"translate-z":[{"translate-z":me()}],"translate-none":[`translate-none`],zoom:[{zoom:[On,z,R]}],accent:[{accent:k()}],appearance:[{appearance:[`none`,`auto`]}],"caret-color":[{caret:k()}],"color-scheme":[{scheme:[`normal`,`dark`,`light`,`light-dark`,`only-dark`,`only-light`]}],cursor:[{cursor:[`auto`,`default`,`pointer`,`wait`,`text`,`move`,`help`,`not-allowed`,`none`,`context-menu`,`progress`,`cell`,`crosshair`,`vertical-text`,`alias`,`copy`,`no-drop`,`grab`,`grabbing`,`all-scroll`,`col-resize`,`row-resize`,`n-resize`,`e-resize`,`s-resize`,`w-resize`,`ne-resize`,`nw-resize`,`se-resize`,`sw-resize`,`ew-resize`,`ns-resize`,`nesw-resize`,`nwse-resize`,`zoom-in`,`zoom-out`,z,R]}],"field-sizing":[{"field-sizing":[`fixed`,`content`]}],"pointer-events":[{"pointer-events":[`auto`,`none`]}],resize:[{resize:[`none`,``,`y`,`x`]}],"scroll-behavior":[{scroll:[`auto`,`smooth`]}],"scrollbar-thumb-color":[{"scrollbar-thumb":k()}],"scrollbar-track-color":[{"scrollbar-track":k()}],"scrollbar-gutter":[{"scrollbar-gutter":[`auto`,`stable`,`both`]}],"scrollbar-w":[{scrollbar:[`auto`,`thin`,`none`]}],"scroll-m":[{"scroll-m":C()}],"scroll-mx":[{"scroll-mx":C()}],"scroll-my":[{"scroll-my":C()}],"scroll-ms":[{"scroll-ms":C()}],"scroll-me":[{"scroll-me":C()}],"scroll-mbs":[{"scroll-mbs":C()}],"scroll-mbe":[{"scroll-mbe":C()}],"scroll-mt":[{"scroll-mt":C()}],"scroll-mr":[{"scroll-mr":C()}],"scroll-mb":[{"scroll-mb":C()}],"scroll-ml":[{"scroll-ml":C()}],"scroll-p":[{"scroll-p":C()}],"scroll-px":[{"scroll-px":C()}],"scroll-py":[{"scroll-py":C()}],"scroll-ps":[{"scroll-ps":C()}],"scroll-pe":[{"scroll-pe":C()}],"scroll-pbs":[{"scroll-pbs":C()}],"scroll-pbe":[{"scroll-pbe":C()}],"scroll-pt":[{"scroll-pt":C()}],"scroll-pr":[{"scroll-pr":C()}],"scroll-pb":[{"scroll-pb":C()}],"scroll-pl":[{"scroll-pl":C()}],"snap-align":[{snap:[`start`,`end`,`center`,`align-none`]}],"snap-stop":[{snap:[`normal`,`always`]}],"snap-type":[{snap:[`none`,`x`,`y`,`both`]}],"snap-strictness":[{snap:[`mandatory`,`proximity`]}],touch:[{touch:[`auto`,`none`,`manipulation`]}],"touch-x":[{"touch-pan":[`x`,`left`,`right`]}],"touch-y":[{"touch-pan":[`y`,`up`,`down`]}],"touch-pz":[`touch-pinch-zoom`],select:[{select:[`none`,`text`,`all`,`auto`]}],"will-change":[{"will-change":[`auto`,`scroll`,`contents`,`transform`,z,R]}],fill:[{fill:[`none`,...k()]}],"stroke-w":[{stroke:[L,Kn,zn,Bn]}],stroke:[{stroke:[`none`,...k()]}],"forced-color-adjust":[{"forced-color-adjust":[`auto`,`none`]}]},conflictingClassGroups:{"container-named":[`container-type`],overflow:[`overflow-x`,`overflow-y`],overscroll:[`overscroll-x`,`overscroll-y`],inset:[`inset-x`,`inset-y`,`inset-bs`,`inset-be`,`start`,`end`,`top`,`right`,`bottom`,`left`],"inset-x":[`right`,`left`],"inset-y":[`top`,`bottom`],flex:[`basis`,`grow`,`shrink`],gap:[`gap-x`,`gap-y`],p:[`px`,`py`,`ps`,`pe`,`pbs`,`pbe`,`pt`,`pr`,`pb`,`pl`],px:[`pr`,`pl`],py:[`pt`,`pb`],m:[`mx`,`my`,`ms`,`me`,`mbs`,`mbe`,`mt`,`mr`,`mb`,`ml`],mx:[`mr`,`ml`],my:[`mt`,`mb`],size:[`w`,`h`],"font-size":[`leading`],"fvn-normal":[`fvn-ordinal`,`fvn-slashed-zero`,`fvn-figure`,`fvn-spacing`,`fvn-fraction`],"fvn-ordinal":[`fvn-normal`],"fvn-slashed-zero":[`fvn-normal`],"fvn-figure":[`fvn-normal`],"fvn-spacing":[`fvn-normal`],"fvn-fraction":[`fvn-normal`],"line-clamp":[`display`,`overflow`],rounded:[`rounded-s`,`rounded-e`,`rounded-t`,`rounded-r`,`rounded-b`,`rounded-l`,`rounded-ss`,`rounded-se`,`rounded-ee`,`rounded-es`,`rounded-tl`,`rounded-tr`,`rounded-br`,`rounded-bl`],"rounded-s":[`rounded-ss`,`rounded-es`],"rounded-e":[`rounded-se`,`rounded-ee`],"rounded-t":[`rounded-tl`,`rounded-tr`],"rounded-r":[`rounded-tr`,`rounded-br`],"rounded-b":[`rounded-br`,`rounded-bl`],"rounded-l":[`rounded-tl`,`rounded-bl`],"border-spacing":[`border-spacing-x`,`border-spacing-y`],"border-w":[`border-w-x`,`border-w-y`,`border-w-s`,`border-w-e`,`border-w-bs`,`border-w-be`,`border-w-t`,`border-w-r`,`border-w-b`,`border-w-l`],"border-w-x":[`border-w-r`,`border-w-l`],"border-w-y":[`border-w-t`,`border-w-b`],"border-color":[`border-color-x`,`border-color-y`,`border-color-s`,`border-color-e`,`border-color-bs`,`border-color-be`,`border-color-t`,`border-color-r`,`border-color-b`,`border-color-l`],"border-color-x":[`border-color-r`,`border-color-l`],"border-color-y":[`border-color-t`,`border-color-b`],translate:[`translate-x`,`translate-y`,`translate-none`],"translate-none":[`translate`,`translate-x`,`translate-y`,`translate-z`],"scroll-m":[`scroll-mx`,`scroll-my`,`scroll-ms`,`scroll-me`,`scroll-mbs`,`scroll-mbe`,`scroll-mt`,`scroll-mr`,`scroll-mb`,`scroll-ml`],"scroll-mx":[`scroll-mr`,`scroll-ml`],"scroll-my":[`scroll-mt`,`scroll-mb`],"scroll-p":[`scroll-px`,`scroll-py`,`scroll-ps`,`scroll-pe`,`scroll-pbs`,`scroll-pbe`,`scroll-pt`,`scroll-pr`,`scroll-pb`,`scroll-pl`],"scroll-px":[`scroll-pr`,`scroll-pl`],"scroll-py":[`scroll-pt`,`scroll-pb`],touch:[`touch-x`,`touch-y`,`touch-pz`],"touch-x":[`touch`],"touch-y":[`touch`],"touch-pz":[`touch`]},conflictingClassGroupModifiers:{"font-size":[`leading`]},postfixLookupClassGroups:[`container-type`],orderSensitiveModifiers:[`*`,`**`,`after`,`backdrop`,`before`,`details-content`,`file`,`first-letter`,`first-line`,`marker`,`placeholder`,`selection`]}});function ur(...e){return lr(Lt(e))}var dr=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),B=o(((e,t)=>{t.exports=dr()}))();function fr({getTarget:e,className:t,label:n,onStatus:r}){let i=(0,_.useRef)(null),a=(0,_.useRef)(null),o=(0,_.useRef)(e),[s,c]=(0,_.useState)(`loading`);return o.current=e,(0,_.useEffect)(()=>{r?.(s)},[r,s]),(0,_.useEffect)(()=>{let e=a.current;if(e&&s!==`gpu`)return Pt({canvas:e,getTarget:()=>o.current()})},[s]),(0,_.useEffect)(()=>{let e=i.current;if(!e||typeof navigator>`u`||!navigator.gpu){c(`fallback`);return}let t=!1,n=Ft({canvas:e,getTarget:()=>o.current(),onError:()=>{t||c(`fallback`)},onReady:()=>{t||c(`gpu`)}}),r=window.setTimeout(()=>c(e=>e===`loading`?`fallback`:e),2200);return()=>{t=!0,window.clearTimeout(r),n()}},[]),(0,B.jsxs)(`div`,{className:ur(`orc-canvas-stack`,t),"data-renderer":s,role:`img`,"aria-label":n??`Animated liquid glass orb`,children:[(0,B.jsx)(`canvas`,{ref:a,className:`orc-canvas orc-canvas-fallback`,"aria-hidden":`true`}),(0,B.jsx)(`canvas`,{ref:i,className:`orc-canvas orc-canvas-gpu`,"data-ready":s===`gpu`?`true`:`false`,"aria-hidden":`true`})]})}function pr(){let e=new URLSearchParams(window.location.search);if(window.location.hash)return{editor:lt(),preview:at(),text:ot()};let t=e.get(`style`)??e.get(`preset`),n=t&&ee.includes(t)?t:C.style,r=e.get(`state`),i=r===`idle`||r===`thinking`?r:ve;return{editor:{configuration:De(n),activeState:i},preview:e.get(`preview`)===`orb`?`orb`:`scene`,text:(e.get(`text`)??`Thinking...`).slice(0,280)}}function mr(){let[e]=(0,_.useState)(pr),[t,n]=(0,_.useState)(e.editor),[r,i]=(0,_.useState)(e.preview),[a,o]=(0,_.useState)(e.text),s=(0,_.useMemo)(()=>Ge(window.location.search,document.referrer),[]);(0,_.useEffect)(()=>(document.documentElement.classList.add(`is-orc-embed`),()=>document.documentElement.classList.remove(`is-orc-embed`)),[]),(0,_.useEffect)(()=>{let e=()=>{let e=pr();n(e.editor),i(e.preview),o(e.text)};return window.addEventListener(`hashchange`,e),()=>window.removeEventListener(`hashchange`,e)},[]),(0,_.useEffect)(()=>{let t=e=>{if(window.parent===window||e.source!==window.parent||!s||e.origin!==s||!We(e.data))return;let t=e.data;t.type===`setState`?n(e=>({...e,activeState:t.state})):t.type===`setText`?o(t.text):window.parent.postMessage({source:Ue,type:`pong`},s)};return window.addEventListener(`message`,t),s&&window.parent!==window&&window.parent.postMessage({source:Ue,type:`ready`,state:e.editor.activeState},s),()=>window.removeEventListener(`message`,t)},[e.editor.activeState,s]),(0,_.useEffect)(()=>{s&&window.parent!==window&&window.parent.postMessage({source:Ue,type:`state`,state:t.activeState},s)},[t.activeState,s]);let c=(0,_.useMemo)(()=>Oe(t.configuration,t.activeState),[t]),l=(0,_.useRef)({state:t.activeState,params:c,activationDuration:t.configuration.activationDuration,transitionDuration:t.configuration.transitionDuration});return l.current={state:t.activeState,params:c,activationDuration:t.configuration.activationDuration,transitionDuration:t.configuration.transitionDuration},(0,B.jsx)(`main`,{className:`orc-embed`,"data-state":t.activeState,"data-preview":r,children:r===`scene`?(0,B.jsxs)(`div`,{className:`orc-scene-pill`,children:[(0,B.jsx)(`div`,{className:`orc-scene-pill-orb`,children:(0,B.jsx)(fr,{getTarget:()=>l.current})}),(0,B.jsx)(`span`,{className:`orc-scene-pill-text`,children:a||`\xA0`})]}):(0,B.jsx)(`div`,{className:`orc-embed-orb`,children:(0,B.jsx)(fr,{getTarget:()=>l.current})})})}var hr=e=>e.replace(/([a-z0-9])([A-Z])/g,`$1-$2`).toLowerCase(),gr=e=>e.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,t,n)=>n?n.toUpperCase():t.toLowerCase()),_r=e=>{let t=gr(e);return t.charAt(0).toUpperCase()+t.slice(1)},vr=(...e)=>e.filter((e,t,n)=>!!e&&e.trim()!==``&&n.indexOf(e)===t).join(` `).trim(),yr=e=>{for(let t in e)if(t.startsWith(`aria-`)||t===`role`||t===`title`)return!0},br={xmlns:`http://www.w3.org/2000/svg`,width:24,height:24,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:2,strokeLinecap:`round`,strokeLinejoin:`round`},xr=(0,_.forwardRef)(({color:e=`currentColor`,size:t=24,strokeWidth:n=2,absoluteStrokeWidth:r,className:i=``,children:a,iconNode:o,...s},c)=>(0,_.createElement)(`svg`,{ref:c,...br,width:t,height:t,stroke:e,strokeWidth:r?Number(n)*24/Number(t):n,className:vr(`lucide`,i),...!a&&!yr(s)&&{"aria-hidden":`true`},...s},[...o.map(([e,t])=>(0,_.createElement)(e,t)),...Array.isArray(a)?a:[a]])),Sr=(e,t)=>{let n=(0,_.forwardRef)(({className:n,...r},i)=>(0,_.createElement)(xr,{ref:i,iconNode:t,className:vr(`lucide-${hr(_r(e))}`,`lucide-${e}`,n),...r}));return n.displayName=_r(e),n},Cr=Sr(`arrow-up-right`,[[`path`,{d:`M7 7h10v10`,key:`1tivn9`}],[`path`,{d:`M7 17 17 7`,key:`1vkiza`}]]),wr=Sr(`check`,[[`path`,{d:`M20 6 9 17l-5-5`,key:`1gmf2c`}]]),Tr=Sr(`chevron-down`,[[`path`,{d:`m6 9 6 6 6-6`,key:`qrunsl`}]]),Er=Sr(`code-xml`,[[`path`,{d:`m18 16 4-4-4-4`,key:`1inbqp`}],[`path`,{d:`m6 8-4 4 4 4`,key:`15zrgr`}],[`path`,{d:`m14.5 4-5 16`,key:`e7oirm`}]]),Dr=Sr(`copy`,[[`rect`,{width:`14`,height:`14`,x:`8`,y:`8`,rx:`2`,ry:`2`,key:`17jyea`}],[`path`,{d:`M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2`,key:`zix9uf`}]]),Or=Sr(`link-2`,[[`path`,{d:`M9 17H7A5 5 0 0 1 7 7h2`,key:`8i5ue5`}],[`path`,{d:`M15 7h2a5 5 0 1 1 0 10h-2`,key:`1b9ql8`}],[`line`,{x1:`8`,x2:`16`,y1:`12`,y2:`12`,key:`1jonct`}]]),kr=Sr(`play`,[[`polygon`,{points:`6 3 20 12 6 21 6 3`,key:`1oa8hb`}]]),Ar=Sr(`rotate-ccw`,[[`path`,{d:`M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8`,key:`1357e3`}],[`path`,{d:`M3 3v5h5`,key:`1xhq8a`}]]),jr=Sr(`square`,[[`rect`,{width:`18`,height:`18`,x:`3`,y:`3`,rx:`2`,key:`afitv7`}]]),Mr=Sr(`x`,[[`path`,{d:`M18 6 6 18`,key:`1bl5f8`}],[`path`,{d:`m6 6 12 12`,key:`d8bk6v`}]]);function Nr({tone:e=`dark`,sheen:t=!0,radius:n=`2rem`,padding:r=`1.5rem`,className:i,style:a,children:o,...s}){let c=[`glass-panel`,e===`light`?`tone-light`:``,i??``].filter(Boolean).join(` `);return(0,B.jsxs)(`article`,{className:c,style:{borderRadius:n,padding:r,...a},...s,children:[(0,B.jsx)(`div`,{className:`glass-read`,"aria-hidden":`true`}),t?(0,B.jsx)(`div`,{className:`glass-sheen`,"aria-hidden":`true`}):null,(0,B.jsx)(`div`,{className:`type-legible`,style:{position:`relative`,zIndex:10},children:o})]})}var Pr=Object.defineProperty,Fr=(e,t)=>Pr(e,`name`,{value:t,configurable:!0});function Ir(e,[t,n]){return Math.min(n,Math.max(t,e))}Fr(Ir,`clamp`);var Lr=Object.defineProperty,Rr=(e,t)=>Lr(e,`name`,{value:t,configurable:!0}),zr=!!(typeof window<`u`&&window.document&&window.document.createElement);function Br(e,t,{checkForDefaultPrevented:n=!0}={}){return Rr(function(r){if(e?.(r),n===!1||!r||!r.defaultPrevented)return t?.(r)},`handleEvent`)}Rr(Br,`composeEventHandlers`);function Vr(e){if(!zr)throw Error(`Cannot access window outside of the DOM`);return e?.ownerDocument?.defaultView??window}Rr(Vr,`getOwnerWindow`);function Hr(e){if(!zr)throw Error(`Cannot access document outside of the DOM`);return e?.ownerDocument??document}Rr(Hr,`getOwnerDocument`);function Ur(e,t=!1){let{activeElement:n}=Hr(e);if(!n?.nodeName)return null;if(Wr(n)&&n.contentDocument)return Ur(n.contentDocument.body,t);if(t){let e=n.getAttribute(`aria-activedescendant`);if(e){let t=Hr(n).getElementById(e);if(t)return t}}return n}Rr(Ur,`getActiveElement`);function Wr(e){return e.tagName===`IFRAME`}Rr(Wr,`isFrame`);var Gr=Object.defineProperty,Kr=(e,t)=>Gr(e,`name`,{value:t,configurable:!0});function qr(e,t){if(typeof e==`function`)return e(t);e!=null&&(e.current=t)}Kr(qr,`setRef`);function Jr(...e){return t=>{let n=!1,r=e.map(e=>{let r=qr(e,t);return!n&&typeof r==`function`&&(n=!0),r});if(n)return()=>{for(let t=0;t<r.length;t++){let n=r[t];typeof n==`function`?n():qr(e[t],null)}}}}Kr(Jr,`composeRefs`);function Yr(...e){return _.useCallback(Jr(...e),e)}Kr(Yr,`useComposedRefs`);var Xr=Object.defineProperty,Zr=(e,t)=>Xr(e,`name`,{value:t,configurable:!0});function Qr(e,t){let n=_.createContext(t);n.displayName=e+`Context`;let r=Zr(e=>{let{children:t,...r}=e,i=_.useMemo(()=>r,Object.values(r));return(0,B.jsx)(n.Provider,{value:i,children:t})},`Provider`);r.displayName=e+`Provider`;function i(r,i={}){let{optional:a=!1}=i,o=_.useContext(n);if(o)return o;if(t!==void 0)return t;if(!a)throw Error(`\`${r}\` must be used within \`${e}\``)}return Zr(i,`useContext`),[r,i]}Zr(Qr,`createContext`);function $r(e,t=[]){let n=[];function r(t,r){let i=_.createContext(r);i.displayName=t+`Context`;let a=n.length;n=[...n,r];let o=Zr(t=>{let{scope:n,children:r,...o}=t,s=n?.[e]?.[a]||i,c=_.useMemo(()=>o,Object.values(o));return(0,B.jsx)(s.Provider,{value:c,children:r})},`Provider`);o.displayName=t+`Provider`;function s(n,o,s={}){let{optional:c=!1}=s,l=o?.[e]?.[a]||i,u=_.useContext(l);if(u)return u;if(r!==void 0)return r;if(!c)throw Error(`\`${n}\` must be used within \`${t}\``)}return Zr(s,`useContext`),[o,s]}Zr(r,`createContext`);let i=Zr(()=>{let t=n.map(e=>_.createContext(e));return Zr(function(n){let r=n?.[e]||t;return _.useMemo(()=>({[`__scope${e}`]:{...n,[e]:r}}),[n,r])},`useScope`)},`createScope`);return i.scopeName=e,[r,ei(i,...t)]}Zr($r,`createContextScope`);function ei(...e){let t=e[0];if(e.length===1)return t;let n=Zr(()=>{let n=e.map(e=>({useScope:e(),scopeName:e.scopeName}));return Zr(function(e){let r=n.reduce((t,{useScope:n,scopeName:r})=>{let i=n(e)[`__scope${r}`];return{...t,...i}},{});return _.useMemo(()=>({[`__scope${t.scopeName}`]:r}),[r])},`useComposedScopes`)},`createScope`);return n.scopeName=t.scopeName,n}Zr(ei,`composeContextScopes`);var ti=globalThis?.document?_.useLayoutEffect:()=>{},ni=Object.defineProperty,ri=(e,t)=>ni(e,`name`,{value:t,configurable:!0}),ii=_.useEffectEvent,ai=_.useInsertionEffect;function oi(e){if(typeof ii==`function`)return ii(e);let t=_.useRef(()=>{throw Error(`Cannot call an event handler while rendering.`)});return typeof ai==`function`?ai(()=>{t.current=e}):ti(()=>{t.current=e}),_.useMemo(()=>((...e)=>t.current?.(...e)),[])}ri(oi,`useEffectEvent`);var si=Object.defineProperty,ci=(e,t)=>si(e,`name`,{value:t,configurable:!0}),li=_.useInsertionEffect||ti;function ui({prop:e,defaultProp:t,onChange:n=ci(()=>{},`onChange`),caller:r}){let[i,a,o]=di({defaultProp:t,onChange:n}),s=e!==void 0;return[s?e:i,_.useCallback(t=>{if(s){let n=fi(t)?t(e):t;n!==e&&o.current?.(n)}else a(t)},[s,e,a,o])]}ci(ui,`useControllableState`);function di({defaultProp:e,onChange:t}){let[n,r]=_.useState(e),i=_.useRef(n),a=_.useRef(t);return li(()=>{a.current=t},[t]),_.useEffect(()=>{i.current!==n&&(a.current?.(n),i.current=n)},[n,i]),[n,r,a]}ci(di,`useUncontrolledState`);function fi(e){return typeof e==`function`}ci(fi,`isFunction`);var pi=Symbol(`RADIX:SYNC_STATE`);function mi(e,t,n,r){let{prop:i,defaultProp:a,onChange:o,caller:s}=t,c=i!==void 0,l=oi(o),u=[{...n,state:a}];r&&u.push(r);let[d,f]=_.useReducer((t,n)=>{if(n.type===pi)return{...t,state:n.state};let r=e(t,n);return c&&!Object.is(r.state,t.state)&&l(r.state),r},...u),p=d.state,m=_.useRef(p);_.useEffect(()=>{m.current!==p&&(m.current=p,c||l(p))},[p,m,c]);let h=_.useMemo(()=>i===void 0?d:{...d,state:i},[d,i]);return _.useEffect(()=>{c&&!Object.is(i,d.state)&&f({type:pi,state:i})},[i,d.state,c]),[h,f]}ci(mi,`useControllableStateReducer`);var hi=Object.defineProperty,gi=(e,t)=>hi(e,`name`,{value:t,configurable:!0}),_i=_.createContext(void 0);function vi(e){let t=_.useContext(_i);return e||t||`ltr`}gi(vi,`useDirection`);var yi=Object.defineProperty,bi=(e,t)=>yi(e,`name`,{value:t,configurable:!0});function xi(e){let t=_.useRef({value:e,previous:e});return _.useMemo(()=>(t.current.value!==e&&(t.current.previous=t.current.value,t.current.value=e),t.current.previous),[e])}bi(xi,`usePrevious`);var Si=Object.defineProperty,Ci=(e,t)=>Si(e,`name`,{value:t,configurable:!0});function wi(e){let[t,n]=_.useState(void 0);return ti(()=>{if(e){n({width:e.offsetWidth,height:e.offsetHeight});let t=new ResizeObserver(t=>{if(!Array.isArray(t)||!t.length)return;let r=t[0],i,a;if(`borderBoxSize`in r){let e=r.borderBoxSize,t=Array.isArray(e)?e[0]:e;i=t.inlineSize,a=t.blockSize}else i=e.offsetWidth,a=e.offsetHeight;n({width:i,height:a})});return t.observe(e,{box:`border-box`}),()=>t.unobserve(e)}n(void 0)},[e]),t}Ci(wi,`useSize`);var Ti=c(m(),1),Ei=Object.defineProperty,Di=(e,t)=>Ei(e,`name`,{value:t,configurable:!0});function Oi(e){let t=_.forwardRef((t,n)=>{let{children:r,...i}=t,a=null,o=!1,s=[];Fi(r)&&typeof zi==`function`&&(r=zi(r._payload)),_.Children.forEach(r,e=>{if(Ni(e)){o=!0;let t=e,n=`child`in t.props?t.props.child:t.props.children;Fi(n)&&typeof zi==`function`&&(n=zi(n._payload)),a=ji(t,n),s.push(a?.props?.children)}else s.push(e)}),a?a=_.cloneElement(a,void 0,s):!o&&_.Children.count(r)===1&&_.isValidElement(r)&&(a=r);let c=a?V(a):void 0,l=Yr(n,c);if(!a){if(r||r===0)throw Error(o?Ri(e):Li(e));return r}let u=Mi(i,a.props??{});return a.type!==_.Fragment&&(u.ref=n?l:c),_.cloneElement(a,u)});return t.displayName=`${e}.Slot`,t}Di(Oi,`createSlot`);var ki=Symbol.for(`radix.slottable`);function Ai(e){let t=Di(e=>`child`in e?e.children(e.child):e.children,`Slottable`);return t.displayName=`${e}.Slottable`,t.__radixId=ki,t}Di(Ai,`createSlottable`);var ji=Di((e,t)=>{if(`child`in e.props){let t=e.props.child;return _.isValidElement(t)?_.cloneElement(t,void 0,e.props.children(t.props.children)):null}return _.isValidElement(t)?t:null},`getSlottableElementFromSlottable`);function Mi(e,t){let n={...t};for(let r in t){let i=e[r],a=t[r];/^on[A-Z]/.test(r)?i&&a?n[r]=(...e)=>{let t=a(...e);return i(...e),t}:i&&(n[r]=i):r===`style`?n[r]={...i,...a}:r===`className`&&(n[r]=[i,a].filter(Boolean).join(` `))}return{...e,...n}}Di(Mi,`mergeProps`);function V(e){let t=Object.getOwnPropertyDescriptor(e.props,`ref`)?.get,n=t&&`isReactWarning`in t&&t.isReactWarning;return n?e.ref:(t=Object.getOwnPropertyDescriptor(e,`ref`)?.get,n=t&&`isReactWarning`in t&&t.isReactWarning,n?e.props.ref:e.props.ref||e.ref)}Di(V,`getElementRef`);function Ni(e){return _.isValidElement(e)&&typeof e.type==`function`&&`__radixId`in e.type&&e.type.__radixId===ki}Di(Ni,`isSlottable`);var Pi=Symbol.for(`react.lazy`);function Fi(e){return typeof e==`object`&&!!e&&`$$typeof`in e&&e.$$typeof===Pi&&`_payload`in e&&Ii(e._payload)}Di(Fi,`isLazyComponent`);function Ii(e){return typeof e==`object`&&!!e&&`then`in e}Di(Ii,`isPromiseLike`);var Li=Di(e=>`${e} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`,`createSlotError`),Ri=Di(e=>`${e} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`,`createSlottableError`),zi=_.use,Bi=Object.defineProperty,Vi=(e,t)=>Bi(e,`name`,{value:t,configurable:!0}),Hi=[`a`,`button`,`div`,`form`,`h2`,`h3`,`img`,`input`,`label`,`li`,`nav`,`ol`,`p`,`select`,`span`,`svg`,`ul`].reduce((e,t)=>{let n=Oi(`Primitive.${t}`),r=_.forwardRef((e,r)=>{let{asChild:i,...a}=e,o=i?n:t;return typeof window<`u`&&(window[Symbol.for(`radix-ui`)]=!0),(0,B.jsx)(o,{...a,ref:r})});return r.displayName=`Primitive.${t}`,{...e,[t]:r}},{});function Ui(e,t){e&&Ti.flushSync(()=>e.dispatchEvent(t))}Vi(Ui,`dispatchDiscreteCustomEvent`);var Wi=Object.defineProperty,H=(e,t)=>Wi(e,`name`,{value:t,configurable:!0});function Gi(e){let t=e+`CollectionProvider`,[n,r]=$r(t),[i,a]=n(t,{collectionRef:{current:null},itemMap:new Map}),o=H(e=>{let{scope:t,children:n}=e,r=_.useRef(null),a=_.useRef(new Map).current;return(0,B.jsx)(i,{scope:t,itemMap:a,collectionRef:r,children:n})},`CollectionProvider`);o.displayName=t;let s=e+`CollectionSlot`,c=Oi(s),l=_.forwardRef((e,t)=>{let{scope:n,children:r}=e,i=Yr(t,a(s,n).collectionRef);return(0,B.jsx)(c,{ref:i,children:r})});l.displayName=s;let u=e+`CollectionItemSlot`,d=`data-radix-collection-item`,f=Oi(u),p=_.forwardRef((e,t)=>{let{scope:n,children:r,...i}=e,o=_.useRef(null),s=Yr(t,o),c=a(u,n);return _.useEffect(()=>(c.itemMap.set(o,{ref:o,...i}),()=>void c.itemMap.delete(o))),(0,B.jsx)(f,{[d]:``,ref:s,children:r})});p.displayName=u;function m(t){let n=a(e+`CollectionConsumer`,t);return _.useCallback(()=>{let e=n.collectionRef.current;if(!e)return[];let t=Array.from(e.querySelectorAll(`[${d}]`));return Array.from(n.itemMap.values()).sort((e,n)=>t.indexOf(e.ref.current)-t.indexOf(n.ref.current))},[n.collectionRef,n.itemMap])}return H(m,`useCollection`),[{Provider:o,Slot:l,ItemSlot:p},m,r]}H(Gi,`createCollection`);var Ki=new WeakMap,qi=class e extends Map{static{H(this,`OrderedDict`)}#e;constructor(e){super(e),this.#e=[...super.keys()],Ki.set(this,!0)}set(e,t){return Ki.get(this)&&(this.has(e)?this.#e[this.#e.indexOf(e)]=e:this.#e.push(e)),super.set(e,t),this}insert(e,t,n){let r=this.has(t),i=this.#e.length,a=Xi(e),o=a>=0?a:i+a,s=o<0||o>=i?-1:o;if(s===this.size||r&&s===this.size-1||s===-1)return this.set(t,n),this;let c=this.size+ +!r;a<0&&o++;let l=[...this.#e],u,d=!1;for(let e=o;e<c;e++)if(o===e){let i=l[e];l[e]===t&&(i=l[e+1]),r&&this.delete(t),u=this.get(i),this.set(t,n)}else{!d&&l[e-1]===t&&(d=!0);let n=l[d?e:e-1],r=u;u=this.get(n),this.delete(n),this.set(n,r)}return this}with(t,n,r){let i=new e(this);return i.insert(t,n,r),i}before(e){let t=this.#e.indexOf(e)-1;if(!(t<0))return this.entryAt(t)}setBefore(e,t,n){let r=this.#e.indexOf(e);return r===-1?this:this.insert(r,t,n)}after(e){let t=this.#e.indexOf(e);if(t=t===-1||t===this.size-1?-1:t+1,t!==-1)return this.entryAt(t)}setAfter(e,t,n){let r=this.#e.indexOf(e);return r===-1?this:this.insert(r+1,t,n)}first(){return this.entryAt(0)}last(){return this.entryAt(-1)}clear(){return this.#e=[],super.clear()}delete(e){let t=super.delete(e);return t&&this.#e.splice(this.#e.indexOf(e),1),t}deleteAt(e){let t=this.keyAt(e);return t!==void 0&&this.delete(t)}at(e){let t=Ji(this.#e,e);if(t!==void 0)return this.get(t)}entryAt(e){let t=Ji(this.#e,e);if(t!==void 0)return[t,this.get(t)]}indexOf(e){return this.#e.indexOf(e)}keyAt(e){return Ji(this.#e,e)}from(e,t){let n=this.indexOf(e);if(n===-1)return;let r=n+t;return r<0&&(r=0),r>=this.size&&(r=this.size-1),this.at(r)}keyFrom(e,t){let n=this.indexOf(e);if(n===-1)return;let r=n+t;return r<0&&(r=0),r>=this.size&&(r=this.size-1),this.keyAt(r)}find(e,t){let n=0;for(let r of this){if(Reflect.apply(e,t,[r,n,this]))return r;n++}}findIndex(e,t){let n=0;for(let r of this){if(Reflect.apply(e,t,[r,n,this]))return n;n++}return-1}filter(t,n){let r=[],i=0;for(let e of this)Reflect.apply(t,n,[e,i,this])&&r.push(e),i++;return new e(r)}map(t,n){let r=[],i=0;for(let e of this)r.push([e[0],Reflect.apply(t,n,[e,i,this])]),i++;return new e(r)}reduce(...e){let[t,n]=e,r=0,i=n??this.at(0);for(let n of this)i=r===0&&e.length===1?n:Reflect.apply(t,this,[i,n,r,this]),r++;return i}reduceRight(...e){let[t,n]=e,r=n??this.at(-1);for(let n=this.size-1;n>=0;n--){let i=this.at(n);r=n===this.size-1&&e.length===1?i:Reflect.apply(t,this,[r,i,n,this])}return r}toSorted(t){let n=[...this.entries()].sort(t);return new e(n)}toReversed(){let t=new e;for(let e=this.size-1;e>=0;e--){let n=this.keyAt(e),r=this.get(n);t.set(n,r)}return t}toSpliced(...t){let n=[...this.entries()];return n.splice(...t),new e(n)}slice(t,n){let r=new e,i=this.size-1;if(t===void 0)return r;t<0&&(t+=this.size),n!==void 0&&n>0&&(i=n-1);for(let e=t;e<=i;e++){let t=this.keyAt(e),n=this.get(t);r.set(t,n)}return r}every(e,t){let n=0;for(let r of this){if(!Reflect.apply(e,t,[r,n,this]))return!1;n++}return!0}some(e,t){let n=0;for(let r of this){if(Reflect.apply(e,t,[r,n,this]))return!0;n++}return!1}};function Ji(e,t){if(`at`in Array.prototype)return Array.prototype.at.call(e,t);let n=Yi(e,t);return n===-1?void 0:e[n]}H(Ji,`at`);function Yi(e,t){let n=e.length,r=Xi(t),i=r>=0?r:n+r;return i<0||i>=n?-1:i}H(Yi,`toSafeIndex`);function Xi(e){return e!==e||e===0?0:Math.trunc(e)}H(Xi,`toSafeInteger`);function Zi(e){let t=e+`CollectionProvider`,[n,r]=$r(t),[i,a]=n(t,{collectionElement:null,collectionRef:{current:null},collectionRefObject:{current:null},itemMap:new qi,setItemMap:H(()=>void 0,`setItemMap`)}),o=H(({state:e,...t})=>e?(0,B.jsx)(c,{...t,state:e}):(0,B.jsx)(s,{...t}),`CollectionProvider`);o.displayName=t;let s=H(e=>{let t=h();return(0,B.jsx)(c,{...e,state:t})},`CollectionInit`);s.displayName=t+`Init`;let c=H(e=>{let{scope:t,children:n,state:r}=e,a=_.useRef(null),[o,s]=_.useState(null),c=Yr(a,s),[l,u]=r;return _.useEffect(()=>{if(!o)return;let e=ta(()=>{});return e.observe(o,{childList:!0,subtree:!0}),()=>{e.disconnect()}},[o]),(0,B.jsx)(i,{scope:t,itemMap:l,setItemMap:u,collectionRef:c,collectionRefObject:a,collectionElement:o,children:n})},`CollectionProviderImpl`);c.displayName=t+`Impl`;let l=e+`CollectionSlot`,u=Oi(l),d=_.forwardRef((e,t)=>{let{scope:n,children:r}=e,i=Yr(t,a(l,n).collectionRef);return(0,B.jsx)(u,{ref:i,children:r})});d.displayName=l;let f=e+`CollectionItemSlot`,p=Oi(f),m=_.forwardRef((e,t)=>{let{scope:n,children:r,...i}=e,o=_.useRef(null),[s,c]=_.useState(null),l=Yr(t,o,c),{setItemMap:u}=a(f,n),d=_.useRef(i);Qi(d.current,i)||(d.current=i);let m=d.current;return _.useEffect(()=>{let e=m;return u(t=>s?t.has(s)?t.set(s,{...e,element:s}).toSorted(ea):(t.set(s,{...e,element:s}),t.toSorted(ea)):t),()=>{u(e=>!s||!e.has(s)?e:(e.delete(s),new qi(e)))}},[s,m,u]),(0,B.jsx)(p,{"data-radix-collection-item":``,ref:l,children:r})});m.displayName=f;function h(){return _.useState(new qi)}H(h,`useInitCollection`);function g(t){let{itemMap:n}=a(e+`CollectionConsumer`,t);return n}return H(g,`useCollection`),[{Provider:o,Slot:d,ItemSlot:m},{createCollectionScope:r,useCollection:g,useInitCollection:h}]}H(Zi,`createCollection`);function Qi(e,t){if(e===t)return!0;if(typeof e!=`object`||typeof t!=`object`||e==null||t==null)return!1;let n=Object.keys(e),r=Object.keys(t);if(n.length!==r.length)return!1;for(let r of n)if(!Object.prototype.hasOwnProperty.call(t,r)||e[r]!==t[r])return!1;return!0}H(Qi,`shallowEqual`);function $i(e,t){return!!(t.compareDocumentPosition(e)&Node.DOCUMENT_POSITION_PRECEDING)}H($i,`isElementPreceding`);function ea(e,t){return!e[1].element||!t[1].element?0:$i(e[1].element,t[1].element)?-1:1}H(ea,`sortByDocumentPosition`);function ta(e){return new MutationObserver(t=>{for(let n of t)if(n.type===`childList`){e();return}})}H(ta,`getChildListObserver`);var na=Object.defineProperty,U=(e,t)=>na(e,`name`,{value:t,configurable:!0}),ra=[`PageUp`,`PageDown`],ia=[`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`],aa={"from-left":[`Home`,`PageDown`,`ArrowDown`,`ArrowLeft`],"from-right":[`Home`,`PageDown`,`ArrowDown`,`ArrowRight`],"from-bottom":[`Home`,`PageDown`,`ArrowDown`,`ArrowLeft`],"from-top":[`Home`,`PageDown`,`ArrowUp`,`ArrowLeft`]},oa=`Slider`,[sa,ca,la]=Gi(oa),[ua,da]=$r(oa,[la]),[fa,pa]=ua(oa),ma=_.forwardRef(U(function(e,t){let{name:n,min:r=0,max:i=100,step:a=1,orientation:o=`horizontal`,disabled:s=!1,minStepsBetweenThumbs:c=0,defaultValue:l=[r],value:u,onValueChange:d=U(()=>{},`onValueChange`),onValueCommit:f=U(()=>{},`onValueCommit`),inverted:p=!1,form:m,...h}=e,g=_.useRef(new Set),v=_.useRef(0),y=_.useRef(!1),b=o===`horizontal`?_a:va,[x,ee]=_.useState(null),S=Yr(t,ee),[C=[],w]=ui({prop:u,defaultProp:l,onChange:U(e=>{[...g.current][v.current]?.focus({preventScroll:!0,focusVisible:y.current}),y.current=!1,d(e)},`onChange`)}),te=_.useRef(C),ne=_.useRef(C);_.useEffect(()=>{let e=m?x?.ownerDocument.getElementById(m):x?.closest(`form`);if(e instanceof HTMLFormElement){let t=U(()=>w(ne.current),`reset`);return e.addEventListener(`reset`,t),()=>e.removeEventListener(`reset`,t)}},[x,m,w]);function T(e){D(e,Ia(C,e))}U(T,`handleSlideStart`);function re(e){D(e,v.current)}U(re,`handleSlideMove`);function E(){String(C)!==String(te.current)&&f(C)}U(E,`handleSlideEnd`);function D(e,t,{commit:n}={commit:!1}){let o=Va(a),s=Ir(Ha(Math.round((e-r)/a)*a+r,o),[r,i]);w((e=[])=>{let r=Na(e,s,t);if(za(r,c*a)){v.current=r.indexOf(s);let t=String(r)!==String(e);return t&&n&&f(r),t?r:e}return e})}return U(D,`updateValues`),(0,B.jsx)(fa,{scope:e.__scopeSlider,name:n,disabled:s,min:r,max:i,valueIndexToChangeRef:v,thumbs:g.current,values:C,orientation:o,form:m,children:(0,B.jsx)(sa.Provider,{scope:e.__scopeSlider,children:(0,B.jsx)(sa.Slot,{scope:e.__scopeSlider,children:(0,B.jsx)(b,{"aria-disabled":s,"data-disabled":s?``:void 0,...h,ref:S,onPointerDown:Br(h.onPointerDown,()=>{s||(te.current=C,y.current=!1)}),min:r,max:i,inverted:p,onSlideStart:s?void 0:T,onSlideMove:s?void 0:re,onSlideEnd:s?void 0:E,onHomeKeyDown:()=>{s||(y.current=!0,D(r,0,{commit:!0}))},onEndKeyDown:()=>{s||(y.current=!0,D(i,C.length-1,{commit:!0}))},onStepKeyDown:({event:e,direction:t})=>{if(!s){y.current=!0;let n=ra.includes(e.key)||e.shiftKey&&ia.includes(e.key)?10:1,i=v.current,o=C[i];D(Ua(o,{min:r,step:a,direction:t,multiplier:n}),i,{commit:!0})}}})})})})},`Slider`)),[ha,ga]=ua(oa,{startEdge:`left`,endEdge:`right`,size:`width`,direction:1}),_a=_.forwardRef(U(function(e,t){let{min:n,max:r,dir:i,inverted:a,onSlideStart:o,onSlideMove:s,onSlideEnd:c,onStepKeyDown:l,...u}=e,[d,f]=_.useState(null),p=Yr(t,f),m=_.useRef(void 0),h=vi(i),g=h===`ltr`,v=g&&!a||!g&&a;function y(e){let t=m.current||d.getBoundingClientRect(),i=Ba([0,t.width],v?[n,r]:[r,n]);return m.current=t,i(e-t.left)}return U(y,`getValueFromPointer`),(0,B.jsx)(ha,{scope:e.__scopeSlider,startEdge:v?`left`:`right`,endEdge:v?`right`:`left`,direction:v?1:-1,size:`width`,children:(0,B.jsx)(ya,{dir:h,"data-orientation":`horizontal`,...u,ref:p,style:{...u.style,"--radix-slider-thumb-transform":`translateX(-50%)`},onSlideStart:e=>{let t=y(e.clientX);o?.(t)},onSlideMove:e=>{let t=y(e.clientX);s?.(t)},onSlideEnd:()=>{m.current=void 0,c?.()},onStepKeyDown:e=>{let t=aa[v?`from-left`:`from-right`].includes(e.key);l?.({event:e,direction:t?-1:1})}})})},`SliderHorizontal`)),va=_.forwardRef(U(function(e,t){let{min:n,max:r,inverted:i,onSlideStart:a,onSlideMove:o,onSlideEnd:s,onStepKeyDown:c,...l}=e,u=_.useRef(null),d=Yr(t,u),f=_.useRef(void 0),p=!i;function m(e){let t=f.current||u.current.getBoundingClientRect(),i=Ba([0,t.height],p?[r,n]:[n,r]);return f.current=t,i(e-t.top)}return U(m,`getValueFromPointer`),(0,B.jsx)(ha,{scope:e.__scopeSlider,startEdge:p?`bottom`:`top`,endEdge:p?`top`:`bottom`,size:`height`,direction:p?1:-1,children:(0,B.jsx)(ya,{"data-orientation":`vertical`,...l,ref:d,style:{...l.style,"--radix-slider-thumb-transform":`translateY(50%)`},onSlideStart:e=>{let t=m(e.clientY);a?.(t)},onSlideMove:e=>{let t=m(e.clientY);o?.(t)},onSlideEnd:()=>{f.current=void 0,s?.()},onStepKeyDown:e=>{let t=aa[p?`from-bottom`:`from-top`].includes(e.key);c?.({event:e,direction:t?-1:1})}})})},`SliderVertical`)),ya=_.forwardRef(U(function(e,t){let{__scopeSlider:n,onSlideStart:r,onSlideMove:i,onSlideEnd:a,onHomeKeyDown:o,onEndKeyDown:s,onStepKeyDown:c,...l}=e,u=pa(oa,n);return(0,B.jsx)(Hi.span,{...l,ref:t,onKeyDown:Br(e.onKeyDown,e=>{e.key===`Home`?(o(e),e.preventDefault()):e.key===`End`?(s(e),e.preventDefault()):ra.concat(ia).includes(e.key)&&(c(e),e.preventDefault())}),onPointerDown:Br(e.onPointerDown,e=>{let t=e.target;t.setPointerCapture(e.pointerId),e.preventDefault(),u.thumbs.has(t)?t.focus({preventScroll:!0,focusVisible:!1}):r(e)}),onPointerMove:Br(e.onPointerMove,e=>{e.target.hasPointerCapture(e.pointerId)&&i(e)}),onPointerUp:Br(e.onPointerUp,e=>{let t=e.target;t.hasPointerCapture(e.pointerId)&&(t.releasePointerCapture(e.pointerId),a(e))})})},`SliderImpl`)),ba=`SliderTrack`,xa=_.forwardRef(U(function(e,t){let{__scopeSlider:n,...r}=e,i=pa(ba,n);return(0,B.jsx)(Hi.span,{"data-disabled":i.disabled?``:void 0,"data-orientation":i.orientation,...r,ref:t})},`SliderTrack`)),Sa=`SliderRange`,Ca=_.forwardRef(U(function(e,t){let{__scopeSlider:n,...r}=e,i=pa(Sa,n),a=ga(Sa,n),o=Yr(t,_.useRef(null)),s=i.values.length,c=i.values.map(e=>Pa(e,i.min,i.max)),l=s>1?Math.min(...c):0,u=100-Math.max(...c);return(0,B.jsx)(Hi.span,{"data-orientation":i.orientation,"data-disabled":i.disabled?``:void 0,...r,ref:o,style:{...e.style,[a.startEdge]:l+`%`,[a.endEdge]:u+`%`}})},`SliderRange`)),[wa,Ta]=ua(`SliderThumb`),Ea=`SliderThumbProvider`;function Da(e){let{__scopeSlider:t,name:n,children:r,internal_do_not_use_render:i}=e,a=pa(Ea,t),o=ca(t),[s,c]=_.useState(null),l=_.useMemo(()=>s?o().findIndex(e=>e.ref.current===s):-1,[o,s]),u=wi(s),d=!s||!!a.form||!!s.closest(`form`),f=a.values[l],p=n??(a.name?a.name+(a.values.length>1?`[]`:``):void 0),m=f===void 0?0:Pa(f,a.min,a.max);_.useEffect(()=>{if(s)return a.thumbs.add(s),()=>{a.thumbs.delete(s)}},[s,a.thumbs]);let h={value:f,name:p,form:a.form,isFormControl:d,index:l,thumb:s,onThumbChange:c,percent:m,size:u};return(0,B.jsx)(wa,{scope:t,...h,children:Wa(i)?i(h):r})}U(Da,`SliderThumbProvider`);var Oa=`SliderThumbTrigger`,ka=_.forwardRef(U(function(e,t){let{__scopeSlider:n,...r}=e,i=pa(Oa,n),a=ga(Oa,n),{index:o,value:s,percent:c,size:l,onThumbChange:u}=Ta(Oa,n),d=Yr(t,u),f=Fa(o,i.values.length),p=l?.[a.size],m=p?La(p,c,a.direction):0;return(0,B.jsx)(`span`,{style:{transform:`var(--radix-slider-thumb-transform)`,position:`absolute`,[a.startEdge]:`calc(${c}% + ${m}px)`},children:(0,B.jsx)(sa.ItemSlot,{scope:n,children:(0,B.jsx)(Hi.span,{role:`slider`,"aria-label":e[`aria-label`]||f,"aria-valuemin":i.min,"aria-valuenow":s,"aria-valuemax":i.max,"aria-orientation":i.orientation,"data-orientation":i.orientation,"data-disabled":i.disabled?``:void 0,tabIndex:i.disabled?void 0:0,...r,ref:d,style:s===void 0?{display:`none`}:e.style,onFocus:Br(e.onFocus,()=>{i.valueIndexToChangeRef.current=o})})})})},`SliderThumbTrigger`)),Aa=_.forwardRef(U(function(e,t){let{__scopeSlider:n,name:r,...i}=e;return(0,B.jsx)(Da,{__scopeSlider:n,name:r,internal_do_not_use_render:({index:e,isFormControl:r})=>(0,B.jsxs)(B.Fragment,{children:[(0,B.jsx)(ka,{...i,ref:t,__scopeSlider:n}),r?(0,B.jsx)(Ma,{__scopeSlider:n},e):null]})})},`SliderThumb`)),ja=`SliderBubbleInput`,Ma=_.forwardRef(U(function({__scopeSlider:e,...t},n){let{value:r,name:i,form:a}=Ta(ja,e),o=_.useRef(null),s=Yr(o,n),c=xi(r);return _.useEffect(()=>{let e=o.current;if(!e)return;let t=window.HTMLInputElement.prototype,n=Object.getOwnPropertyDescriptor(t,`value`).set;if(c!==r&&n){let t=new Event(`input`,{bubbles:!0});n.call(e,r),e.dispatchEvent(t)}},[c,r]),(0,B.jsx)(Hi.input,{style:{display:`none`},name:i,form:a,...t,ref:s,defaultValue:r})},`SliderBubbleInput`));function Na(e=[],t,n){let r=[...e];return r[n]=t,r.sort((e,t)=>e-t)}U(Na,`getNextSortedValues`);function Pa(e,t,n){return Ir(100/(n-t)*(e-t),[0,100])}U(Pa,`convertValueToPercentage`);function Fa(e,t){if(t>2)return`Value ${e+1} of ${t}`;if(t===2)return[`Minimum`,`Maximum`][e]}U(Fa,`getLabel`);function Ia(e,t){if(e.length===1)return 0;let n=e.map(e=>Math.abs(e-t)),r=Math.min(...n);return n.indexOf(r)}U(Ia,`getClosestValueIndex`);function La(e,t,n){let r=e/2;return(r-Ba([0,50],[0,r])(t)*n)*n}U(La,`getThumbInBoundsOffset`);function Ra(e){return e.slice(0,-1).map((t,n)=>e[n+1]-t)}U(Ra,`getStepsBetweenValues`);function za(e,t){if(t>0){let n=Ra(e);return Math.min(...n)>=t}return!0}U(za,`hasMinStepsBetweenValues`);function Ba(e,t){return n=>{if(e[0]===e[1]||t[0]===t[1])return t[0];let r=(t[1]-t[0])/(e[1]-e[0]);return t[0]+r*(n-e[0])}}U(Ba,`linearScale`);function Va(e){if(!Number.isFinite(e))return 0;let t=e.toString();if(t.includes(`e`)){let[e,n]=t.split(`e`),r=e.split(`.`)[1]||``,i=Number(n);return Math.max(0,r.length-i)}let n=t.split(`.`)[1];return n?n.length:0}U(Va,`getDecimalCount`);function Ha(e,t){let n=10**t;return Math.round(e*n)/n}U(Ha,`roundValue`);function Ua(e,{min:t,step:n,direction:r,multiplier:i}){let a=Va(n),o=(e-t)/n,s=Math.round(o),c=Ha(s*n+t,a)===Ha(e,a),l;return l=c?s+i*r:r>0?Math.ceil(o):Math.floor(o),Ha(l*n+t,a)}U(Ua,`getNextStepValue`);function Wa(e){return typeof e==`function`}U(Wa,`isFunction`);function Ga({title:e,open:t,onToggle:n,children:r}){return(0,B.jsxs)(`section`,{className:`orc-section`,children:[(0,B.jsxs)(`button`,{type:`button`,className:`orc-section-head`,onClick:n,"aria-expanded":t,children:[(0,B.jsx)(`span`,{children:e}),(0,B.jsx)(Tr,{className:ur(`orc-section-chevron`,t&&`is-open`)})]}),t?(0,B.jsx)(`div`,{className:`orc-section-body`,children:r}):null]})}function Ka({label:e,value:t,min:n,max:r,step:i,onChange:a,unit:o}){let s=i<.01?3:i<1?2:0,c=`${t.toFixed(s)}${o??``}`;return(0,B.jsxs)(`div`,{className:`orc-slider`,children:[(0,B.jsxs)(`div`,{className:`orc-slider-head`,children:[(0,B.jsx)(`span`,{children:e}),(0,B.jsx)(`span`,{className:`orc-slider-value`,children:c})]}),(0,B.jsxs)(ma,{className:`orc-slider-root`,min:n,max:r,step:i,value:[t],onValueChange:e=>a(e[0]??n),children:[(0,B.jsx)(xa,{className:`orc-slider-track`,children:(0,B.jsx)(Ca,{className:`orc-slider-range`})}),(0,B.jsx)(Aa,{className:`orc-slider-thumb`,"aria-label":e})]})]})}function qa({label:e,hex:t,onChange:n}){return(0,B.jsxs)(`label`,{className:`orc-swatch`,children:[(0,B.jsx)(`input`,{type:`color`,value:t.toLowerCase(),"aria-label":e,onChange:e=>n(e.target.value.toUpperCase())}),(0,B.jsxs)(`span`,{className:`orc-swatch-meta`,children:[(0,B.jsx)(`span`,{className:`orc-swatch-label`,children:e}),(0,B.jsx)(`span`,{className:`orc-swatch-hex`,children:t})]})]})}function Ja({value:e,options:t,ariaLabel:n,onChange:r}){return(0,B.jsx)(`div`,{className:`orc-segmented`,role:`radiogroup`,"aria-label":n,children:t.map(t=>(0,B.jsx)(`button`,{type:`button`,role:`radio`,"aria-checked":e===t.value,className:ur(`orc-segment`,e===t.value&&`is-active`),onClick:()=>r(t.value),children:t.label},t.value))})}function Ya({label:e,checked:t,onChange:n}){return(0,B.jsxs)(`label`,{className:`orc-toggle`,children:[(0,B.jsx)(`span`,{children:e}),(0,B.jsx)(`button`,{type:`button`,role:`switch`,"aria-checked":t,className:ur(`orc-switch`,t&&`is-on`),onClick:()=>n(!t),children:(0,B.jsx)(`span`,{className:`orc-switch-knob`})})]})}var Xa=[{label:`中`,value:`zh`},{label:`EN`,value:`en`}],Za={zh:{siriAi:`Siri Ai`,siri:`Siri 波澜`,voiceWave:`声纹薄膜`,spectrum:`彩色声场`,aurora:`极光帷幕`,frost:`冰霜流体`,plasma:`神经电浆`,chrome:`液态铬`,opal:`虹彩欧泊`,blueDrop:`蓝晶液滴`,violetEmber:`紫焰流核`,refractiveBlob:`折射软体`,particleRibbon:`量子丝带`,chromaticMetal:`色差液态金属`},en:{siriAi:`Siri Ai`,siri:`Siri Wave`,voiceWave:`Voice Membrane`,spectrum:`Prismatic Field`,aurora:`Aurora Veil`,frost:`Frost Flow`,plasma:`Neural Plasma`,chrome:`Liquid Chrome`,opal:`Iridescent Opal`,blueDrop:`Crystal Drop`,violetEmber:`Violet Ember`,refractiveBlob:`Refractive Gel`,particleRibbon:`Particle Ribbons`,chromaticMetal:`Chromatic Metal`}},Qa={zh:{speed:`速度`,radius:`半径`,shapeMorph:`形态`,contourDeform:`轮廓形变`,zoom:`缩放`,warp:`扭曲`,ridgeAmt:`脊线`,sharp:`锐度`,bandDensity:`重复次数`,metalDepth:`金属深度`,metalRoughness:`表面粗糙度`,chromaticShift:`RGB 分离`,metalScale:`图案缩放`,metalStretch:`纵横拉伸`,metalAngle:`流带角度`,metalOffset:`图案偏移`,metalPhase:`循环相位`,metalEvolution:`演化幅度`,particleDensity:`粒子密度`,ribbonCount:`丝带层数`,ribbonWidth:`丝带宽度`,ribbonTwist:`扭转强度`,ribbonFold:`折叠幅度`,ribbonBreath:`呼吸幅度`,particleSize:`粒子尺寸`,particleBloom:`粒子辉光`,shade:`明暗`,exposure:`曝光`,sheen:`边缘高光`,gloss:`色散`,glassOpacity:`折射强度`,shellMidAlpha:`折射宽度`,shellEdgeAlpha:`边缘强度`,edgeSoftness:`边缘柔化`,edgeGlow:`外发光强度`},en:{speed:`Speed`,radius:`Radius`,shapeMorph:`Shape Morph`,contourDeform:`Contour Motion`,zoom:`Flow Scale`,warp:`Flow Distortion`,ridgeAmt:`Ridge Detail`,sharp:`Sharpness`,bandDensity:`Band Count`,metalDepth:`Metallic Depth`,metalRoughness:`Roughness`,chromaticShift:`RGB Split`,metalScale:`Pattern Scale`,metalStretch:`Aspect Stretch`,metalAngle:`Band Angle`,metalOffset:`Pattern Offset`,metalPhase:`Loop Phase`,metalEvolution:`Flow Evolution`,particleDensity:`Particle Density`,ribbonCount:`Ribbon Layers`,ribbonWidth:`Ribbon Width`,ribbonTwist:`Twist`,ribbonFold:`Folding`,ribbonBreath:`Breathing`,particleSize:`Particle Size`,particleBloom:`Particle Bloom`,shade:`Shading`,exposure:`Exposure`,sheen:`Rim Highlight`,gloss:`Dispersion`,glassOpacity:`Refraction Strength`,shellMidAlpha:`Refraction Width`,shellEdgeAlpha:`Edge Intensity`,edgeSoftness:`Edge Softness`,edgeGlow:`Outer Glow`}},$a={zh:{colorA:`颜色 A`,colorB:`颜色 B`,colorC:`颜色 C`,colorD:`颜色 D`,highlightColor:`提亮色`,shellInner:`折射底色`,shellMid:`冷色散`,shellEdge:`暖色散`,sheenColor:`主高光色`,specColor:`辅高光色`,canvasColor:`背景颜色`,glowColor:`外发光颜色`},en:{colorA:`Color A`,colorB:`Color B`,colorC:`Color C`,colorD:`Color D`,highlightColor:`Highlight Tint`,shellInner:`Refraction Base`,shellMid:`Cool Dispersion`,shellEdge:`Warm Dispersion`,sheenColor:`Key Highlight`,specColor:`Fill Highlight`,canvasColor:`Background`,glowColor:`Glow Color`}},eo={zh:{documentTitle:`液态玻璃球编辑器`,presets:`效果预设`,animatedPresets:`动态预设`,orbControls:`球体参数`,collapsePresets:`收起预设面板`,expandPresets:`展开预设面板`,collapseControls:`收起参数面板`,expandControls:`展开参数面板`,resetControls:`重置全部参数`,previewMode:`预览模式`,switchPreviewMode:`切换预览模式`,orbMode:`球体`,sceneMode:`场景`,switchLanguage:`切换界面语言`,orbPreview:`液态玻璃球预览`,scenePreview:`实际场景预览`,staticOrbPreview:`液态玻璃球静态预览`,animatedOrbPreview:`动态液态玻璃球`,loadingOrb:`正在加载球体`,renderFallback:`WebGPU 不可用，当前显示静态预览`,renderErrorTitle:`WebGPU 渲染失败`,sceneText:e=>`场景文字：${e}`,copyCode:`复制代码`,viewSource:`在 GitHub 查看源码`,sceneSection:`场景预览`,displayText:`显示文字`,sceneTextLimit:`最多 20 个字符`,stateSection:`AI 状态`,orbState:`当前状态`,switchOrbState:`切换 AI 球状态`,idleState:`空闲`,thinkingState:`思考中`,activationDuration:`启动时长`,transitionDuration:`回落时长`,collapseSection:e=>`收起${e}`,expandSection:e=>`展开${e}`,editValue:e=>`编辑${e}数值`,selectColor:e=>`选择${e}`,hexValue:e=>`${e}十六进制值`,hexColor:`十六进制颜色`,colorSurface:`颜色饱和度和亮度`,colorChannel:`通道`,cssColorValue:`CSS 颜色值`,hue:`色相`,motionSection:`动态`,colorsSection:`颜色`,shapeSection:`形状动画`,siriShapeSection:`Siri 形态`,switchSiriShape:`切换 Siri Ai 形态`,enableGlass:`开启玻璃罩`,glassSection:`玻璃罩`,edgeSection:`边缘与外发光`,copyFailed:`复制失败`,copied:`已复制`,close:`关闭`,webCode:`Web 代码`,swiftCode:`SwiftUI 代码`},en:{documentTitle:`Liquid Orb Editor`,presets:`Presets`,animatedPresets:`Animated presets`,orbControls:`Orb Controls`,collapsePresets:`Collapse presets`,expandPresets:`Expand presets`,collapseControls:`Collapse controls`,expandControls:`Expand controls`,resetControls:`Reset all controls`,previewMode:`Preview`,switchPreviewMode:`Switch preview mode`,orbMode:`Orb`,sceneMode:`Scene`,switchLanguage:`Switch interface language`,orbPreview:`Liquid glass orb preview`,scenePreview:`In-context preview`,staticOrbPreview:`Static liquid glass orb preview`,animatedOrbPreview:`Animated liquid glass orb`,loadingOrb:`Loading orb`,renderFallback:`WebGPU is unavailable. Showing the fallback preview.`,renderErrorTitle:`WebGPU rendering failed`,sceneText:e=>`Scene text: ${e}`,copyCode:`Copy Code`,viewSource:`View source on GitHub`,sceneSection:`Scene Preview`,displayText:`Display Text`,sceneTextLimit:`Up to 20 characters`,stateSection:`AI State`,orbState:`Current State`,switchOrbState:`Switch AI orb state`,idleState:`Idle`,thinkingState:`Thinking`,activationDuration:`Activation Duration`,transitionDuration:`Settle Duration`,collapseSection:e=>`Collapse ${e}`,expandSection:e=>`Expand ${e}`,editValue:e=>`Edit ${e} value`,selectColor:e=>`Choose ${e}`,hexValue:e=>`${e} hex value`,hexColor:`Hex color`,colorSurface:`Color saturation and brightness`,colorChannel:`channel`,cssColorValue:`CSS color value`,hue:`Hue`,motionSection:`Motion`,colorsSection:`Color`,shapeSection:`Shape Motion`,siriShapeSection:`Siri Shape`,switchSiriShape:`Switch Siri Ai shape`,enableGlass:`Enable Glass Shell`,glassSection:`Glass Shell`,edgeSection:`Edge & Glow`,copyFailed:`Copy Failed`,copied:`Copied`,close:`Close`,webCode:`Web code`,swiftCode:`SwiftUI code`}},to={zh:{appName:`Apple Orc`,appTag:`液态玻璃球工作台`,embedIframe:`iframe 嵌入`,embedReact:`React 组件`,embedDropin:`项目内引用`,embedJson:`JSON 配置`,widgetHint:`把调好的球体嵌入其它网站或工作台。iframe 适合任意站点；JSON 与组件适合本仓库其它项目。`,hostApi:`宿主可通过 postMessage 切换 idle / thinking。`,originNote:`嵌入地址使用当前站点。部署后把域名换成你的公开地址即可。`,fallbackNote:`当前环境没有 WebGPU，已使用画布回退预览。`,gpuReady:`WebGPU 实时渲染`,shareLink:`复制分享链接`,linkCopied:`链接已复制`},en:{appName:`Apple Orc`,appTag:`Liquid glass orb workbench`,embedIframe:`iframe embed`,embedReact:`React embed`,embedDropin:`In-project import`,embedJson:`JSON config`,widgetHint:`Drop the tuned orb into another site or workbench. Use iframe for any page; JSON and the component for other projects in this repo.`,hostApi:`The host page can switch idle / thinking over postMessage.`,originNote:`Embed URLs use this origin. After deploy, swap in your public domain.`,fallbackNote:`WebGPU is unavailable here. Showing a canvas fallback preview.`,gpuReady:`Live WebGPU render`,shareLink:`Copy share link`,linkCopied:`Link copied`}},no=[`shellInner`,`shellMid`,`shellEdge`,`sheenColor`,`specColor`],ro=[`colorA`,`colorB`,`colorC`,`colorD`,`highlightColor`,`canvasColor`];function io(){let[e,t]=(0,_.useState)(`en`),[n,r]=(0,_.useState)(()=>({configuration:De(C.style),activeState:ve})),[i,a]=(0,_.useState)(`orb`),[o,s]=(0,_.useState)(w),[c,l]=(0,_.useState)(1),[u,d]=(0,_.useState)(!1),[f,p]=(0,_.useState)(`iframe`),[m,h]=(0,_.useState)(null),[g,v]=(0,_.useState)(`loading`),[y,b]=(0,_.useState)({scene:!0,state:!0,motion:!0,colors:!1,shape:!0,glass:!0,edge:!0}),x=(0,_.useRef)(0),S=(0,_.useRef)(null),te=(0,_.useRef)(0),re=(0,_.useRef)(null),E=eo[e],D=to[e],O=Oe(n.configuration,n.activeState),ie=S.current!==null&&O.style===`siriAi`?{...O,shapeMorph:S.current}:O,ae=(0,_.useRef)({state:n.activeState,params:ie,activationDuration:n.configuration.activationDuration,transitionDuration:n.configuration.transitionDuration});ae.current={state:n.activeState,params:ie,activationDuration:n.configuration.activationDuration,transitionDuration:n.configuration.transitionDuration},(0,_.useEffect)(()=>{t(nt()),r(lt()),a(at()),s(ot())},[]),(0,_.useEffect)(()=>()=>cancelAnimationFrame(x.current),[]),(0,_.useEffect)(()=>{rt(e),typeof document<`u`&&(document.documentElement.lang=e===`zh`?`zh-CN`:`en`)},[e]),(0,_.useEffect)(()=>{let e=window.setTimeout(()=>{dt(n,i,o)},500);return()=>window.clearTimeout(e)},[n,i,o]),(0,_.useEffect)(()=>{let e=re.current;if(!e)return;let t=e=>{if(e.target instanceof Element&&e.target.closest(`[data-stage-controls]`))return;e.preventDefault();let t=le(-e.deltaY*.001,-.1,.1);l(e=>Math.round(le(e+t,.6,1.6)*100)/100)};return e.addEventListener(`wheel`,t,{passive:!1}),()=>e.removeEventListener(`wheel`,t)},[]);let oe=(0,_.useCallback)((e,t)=>{r(n=>({...n,configuration:ke(n.configuration,n.activeState,e,t)}))},[]),A=(0,_.useCallback)(e=>{S.current=null,cancelAnimationFrame(x.current),r(t=>({activeState:t.activeState,configuration:{...De(e),activationDuration:t.configuration.activationDuration,transitionDuration:t.configuration.transitionDuration}})),e===`siriAi`&&b(e=>({...e,shape:!0}))},[]),j=(0,_.useCallback)((e,t)=>{let n=typeof window<`u`&&window.matchMedia(`(prefers-reduced-motion: reduce)`).matches;if(!t||n){S.current=null,oe(`shapeMorph`,e);return}let r=S.current??ae.current.params.shapeMorph,i=performance.now();cancelAnimationFrame(x.current);let a=t=>{let n=Math.min(1,Math.max(0,(t-i)/780)),o=r+(e-r)*vt(n);S.current=o,ae.current={...ae.current,params:{...ae.current.params,shapeMorph:o}},n<1?(t-te.current>48&&(te.current=t,oe(`shapeMorph`,o)),x.current=requestAnimationFrame(a)):(S.current=null,oe(`shapeMorph`,e))};x.current=requestAnimationFrame(a)},[oe]),ue=(0,_.useCallback)(()=>{r({activeState:ve,configuration:De(C.style)}),s(w),l(1)},[]),P=(0,_.useMemo)(()=>ut(n,i,o),[n,i,o]),de=typeof window>`u`?``:Ke(window.location.origin,`/Apple-orc/`),fe=(0,_.useMemo)(()=>et(n,de,P,i,o),[n,P,de,i,o]),pe=(0,_.useCallback)(async(e,t)=>{try{await navigator.clipboard.writeText(e),h(t)}catch{h(`error`)}window.setTimeout(()=>h(null),1600)},[]);function F(t){let n=k.get(t);return!n||!N(n,O.style)?null:(0,B.jsx)(Ka,{label:Qa[e][t],value:O[t],min:n.min,max:n.max,step:n.step,onChange:e=>oe(t,e)},t)}function me(t){return(0,B.jsx)(qa,{label:$a[e][t],hex:O[t],onChange:e=>oe(t,e)},t)}let he=O.style===`siriAi`?yt(ie.shapeMorph):null,ge=e=>()=>{b(t=>({...t,[e]:!t[e]}))};return(0,B.jsxs)(`div`,{className:`orc-app`,children:[(0,B.jsx)(`div`,{className:`orc-bg`,"aria-hidden":`true`}),(0,B.jsx)(`aside`,{className:`orc-rail orc-rail-left`,children:(0,B.jsxs)(Nr,{sheen:!1,radius:`1.5rem`,padding:`0.9rem`,className:`orc-panel`,children:[(0,B.jsx)(`div`,{className:`orc-panel-title`,children:E.presets}),(0,B.jsx)(`div`,{className:`orc-preset-grid`,children:ee.map(t=>(0,B.jsxs)(`button`,{type:`button`,"aria-pressed":O.style===t,className:ur(`orc-preset`,O.style===t&&`is-active`),onClick:()=>A(t),"aria-label":Za[e][t],children:[(0,B.jsx)(`img`,{src:ce[t],alt:``,className:ur(`orc-preset-thumb`,se.has(t)&&`is-compact`)}),(0,B.jsx)(`span`,{children:Za[e][t]})]},t))})]})}),(0,B.jsxs)(`section`,{ref:re,className:`orc-stage`,"data-preview-mode":i,"aria-label":i===`scene`?E.scenePreview:E.orbPreview,children:[(0,B.jsxs)(`div`,{className:`orc-stage-top`,"data-stage-controls":!0,children:[(0,B.jsx)(Ja,{ariaLabel:E.switchLanguage,value:e,options:Xa,onChange:t}),(0,B.jsx)(Ja,{ariaLabel:E.switchPreviewMode,value:i,options:[{label:E.orbMode,value:`orb`},{label:E.sceneMode,value:`scene`}],onChange:e=>{a(e),l(1)}})]}),(0,B.jsx)(`div`,{className:ur(`orc-preview`,i===`scene`&&`is-scene`,O.style===`siriAi`&&`is-siri-ai`,he&&`is-siri-${he}`),style:{transform:`scale(${c})`},children:i===`scene`?(0,B.jsxs)(`div`,{className:ur(`orc-scene-pill`,O.style===`siriAi`&&`is-siri-ai`),children:[(0,B.jsx)(`div`,{className:`orc-scene-pill-orb`,children:(0,B.jsx)(fr,{getTarget:()=>ae.current,label:E.animatedOrbPreview,onStatus:v})}),(0,B.jsx)(`span`,{className:`orc-scene-pill-text`,children:o||`\xA0`})]}):(0,B.jsx)(`div`,{className:`orc-orb-frame`,children:(0,B.jsx)(fr,{getTarget:()=>ae.current,label:E.animatedOrbPreview,onStatus:v})})}),g===`fallback`?(0,B.jsx)(`p`,{className:`orc-fallback-note`,children:D.fallbackNote}):null,(0,B.jsxs)(`div`,{className:`orc-stage-bottom`,"data-stage-controls":!0,children:[(0,B.jsxs)(`button`,{type:`button`,className:`orc-code-btn`,onClick:()=>d(!0),children:[(0,B.jsx)(Er,{size:16}),E.copyCode]}),(0,B.jsx)(`button`,{type:`button`,className:`orc-icon-btn`,onClick:()=>{let e=`${window.location.origin}${window.location.pathname}#${P}`;pe(e,`link`)},"aria-label":D.shareLink,children:(0,B.jsx)(Or,{size:16})})]})]}),(0,B.jsx)(`aside`,{className:`orc-rail orc-rail-right`,children:(0,B.jsxs)(Nr,{sheen:!1,radius:`1.5rem`,padding:`0.85rem`,className:`orc-panel orc-controls`,children:[(0,B.jsxs)(`div`,{className:`orc-panel-title-row`,children:[(0,B.jsx)(`div`,{className:`orc-panel-title`,children:E.orbControls}),(0,B.jsx)(`button`,{type:`button`,className:`orc-icon-btn`,onClick:ue,"aria-label":E.resetControls,children:(0,B.jsx)(Ar,{size:14})})]}),(0,B.jsxs)(`div`,{className:`orc-controls-scroll`,children:[i===`scene`?(0,B.jsx)(Ga,{title:E.sceneSection,open:y.scene,onToggle:ge(`scene`),children:(0,B.jsxs)(`label`,{className:`orc-field`,children:[(0,B.jsxs)(`span`,{className:`orc-field-label`,children:[E.displayText,(0,B.jsxs)(`span`,{children:[Array.from(o).length,`/20`]})]}),(0,B.jsx)(`input`,{className:`orc-text-input`,value:o,maxLength:40,onChange:e=>s(M(e.target.value))})]})}):null,(0,B.jsxs)(Ga,{title:E.stateSection,open:y.state,onToggle:ge(`state`),children:[(0,B.jsx)(Ja,{ariaLabel:E.switchOrbState,value:n.activeState,options:[{label:E.idleState,value:`idle`},{label:E.thinkingState,value:`thinking`}],onChange:e=>r(t=>({...t,activeState:e}))}),(0,B.jsx)(Ka,{label:E.activationDuration,value:n.configuration.activationDuration,min:ne.min,max:ne.max,step:ne.step,unit:`s`,onChange:e=>r(t=>({...t,configuration:{...t.configuration,activationDuration:e}}))}),(0,B.jsx)(Ka,{label:E.transitionDuration,value:n.configuration.transitionDuration,min:T.min,max:T.max,step:T.step,unit:`s`,onChange:e=>r(t=>({...t,configuration:{...t.configuration,transitionDuration:e}}))})]}),(0,B.jsx)(Ga,{title:E.motionSection,open:y.motion,onToggle:ge(`motion`),children:F(`speed`)}),(0,B.jsxs)(Ga,{title:E.colorsSection,open:y.colors,onToggle:ge(`colors`),children:[(0,B.jsx)(`div`,{className:`orc-swatch-grid`,children:ro.map(me)}),F(`shade`),F(`exposure`)]}),(0,B.jsxs)(Ga,{title:O.style===`siriAi`?E.siriShapeSection:E.shapeSection,open:y.shape,onToggle:ge(`shape`),children:[O.style===`siriAi`?(0,B.jsxs)(B.Fragment,{children:[(0,B.jsx)(Ja,{ariaLabel:E.switchSiriShape,value:yt(ie.shapeMorph),options:ft.map(t=>({label:mt[e][t],value:t})),onChange:e=>j(pt[e],!0)}),F(`shapeMorph`)]}):null,F(`radius`),F(`contourDeform`),F(`zoom`),F(`warp`),F(`ridgeAmt`),F(`sharp`),F(`metalDepth`),F(`metalRoughness`),F(`chromaticShift`),F(`metalScale`),F(`metalStretch`),F(`metalAngle`),F(`bandDensity`),F(`metalOffset`),F(`metalPhase`),F(`metalEvolution`),F(`particleDensity`),F(`ribbonCount`),F(`ribbonWidth`),F(`ribbonTwist`),F(`ribbonFold`),F(`ribbonBreath`),F(`particleSize`),F(`particleBloom`)]}),(0,B.jsxs)(Ga,{title:E.glassSection,open:y.glass,onToggle:ge(`glass`),children:[(0,B.jsx)(Ya,{label:E.enableGlass,checked:O.glassEnabled,onChange:e=>oe(`glassEnabled`,e)}),O.glassEnabled?(0,B.jsxs)(B.Fragment,{children:[F(`glassOpacity`),F(`sheen`),F(`gloss`),F(`shellMidAlpha`),F(`shellEdgeAlpha`),(0,B.jsx)(`div`,{className:`orc-swatch-grid`,children:no.map(me)})]}):null]}),(0,B.jsxs)(Ga,{title:E.edgeSection,open:y.edge,onToggle:ge(`edge`),children:[F(`edgeSoftness`),F(`edgeGlow`),me(`glowColor`)]})]})]})}),u?(0,B.jsx)(`div`,{className:`orc-sheet-backdrop`,role:`presentation`,onClick:()=>d(!1),children:(0,B.jsx)(`div`,{className:`orc-sheet`,role:`dialog`,"aria-modal":`true`,"aria-labelledby":`orc-copy-title`,onClick:e=>e.stopPropagation(),children:(0,B.jsxs)(Nr,{sheen:!1,radius:`1.6rem`,padding:`1.1rem`,className:`orc-sheet-card`,children:[(0,B.jsxs)(`div`,{className:`orc-sheet-head`,children:[(0,B.jsxs)(`div`,{children:[(0,B.jsx)(`h2`,{id:`orc-copy-title`,children:E.copyCode}),(0,B.jsx)(`p`,{children:D.widgetHint})]}),(0,B.jsx)(`button`,{type:`button`,className:`orc-icon-btn`,onClick:()=>d(!1),"aria-label":E.close,children:(0,B.jsx)(Mr,{size:16})})]}),(0,B.jsx)(`div`,{className:`orc-sheet-tabs`,children:[[`iframe`,D.embedIframe],[`react`,D.embedReact],[`dropin`,D.embedDropin],[`json`,D.embedJson],[`web`,E.webCode],[`swift`,E.swiftCode]].map(([e,t])=>(0,B.jsx)(`button`,{type:`button`,className:ur(`orc-tab`,f===e&&`is-active`),onClick:()=>p(e),children:t},e))}),(0,B.jsx)(`pre`,{className:`orc-code`,children:(0,B.jsx)(`code`,{children:fe[f]})}),(0,B.jsxs)(`div`,{className:`orc-sheet-actions`,children:[(0,B.jsx)(`p`,{className:`orc-sheet-hint`,children:D.hostApi}),(0,B.jsxs)(`button`,{type:`button`,className:`orc-code-btn`,onClick:()=>void pe(fe[f],f),children:[(0,B.jsx)(Dr,{size:16}),m===`error`?E.copyFailed:m===f?E.copied:E.copyCode]})]})]})})}):null,m===`link`?(0,B.jsx)(`div`,{className:`orc-toast`,role:`status`,children:D.linkCopied}):null]})}function ao({preset:e=`siri`,state:t=`thinking`,size:n=72,label:r,params:i,className:a,activationDuration:o=ye,transitionDuration:s=be}){let c=(0,_.useMemo)(()=>{let t=De(e);return i?{...t,activationDuration:o,transitionDuration:s,shared:{...t.shared,...oo(i)},profiles:{idle:{...t.profiles.idle,...so(i)},thinking:{...t.profiles.thinking,...so(i)}}}:{...t,activationDuration:o,transitionDuration:s}},[o,i,e,s]),l=Oe(c,t),u=(0,_.useRef)({state:t,params:l,activationDuration:c.activationDuration,transitionDuration:c.transitionDuration});u.current={state:t,params:l,activationDuration:c.activationDuration,transitionDuration:c.transitionDuration};let d=(0,B.jsx)(fr,{getTarget:()=>u.current,className:`orc-widget-canvas`,label:r?`${r} orb`:`Apple Orc`});return r?(0,B.jsxs)(`div`,{className:ur(`orc-scene-pill`,a),children:[(0,B.jsx)(`div`,{className:`orc-scene-pill-orb`,style:{width:n,height:n},children:d}),(0,B.jsx)(`span`,{className:`orc-scene-pill-text`,children:r})]}):(0,B.jsx)(`div`,{className:ur(`orc-widget`,a),style:{width:n,height:n},children:d})}function oo(e){let t={...e};return delete t.speed,delete t.contourDeform,delete t.zoom,delete t.warp,delete t.ridgeAmt,delete t.sharp,delete t.shade,delete t.exposure,delete t.edgeGlow,delete t.colorA,delete t.colorB,delete t.colorC,delete t.colorD,delete t.highlightColor,delete t.glowColor,t}function so(e){let t=[`speed`,`contourDeform`,`bandDensity`,`chromaticShift`,`metalStretch`,`metalEvolution`,`metalRoughness`,`metalDepth`,`ribbonWidth`,`ribbonTwist`,`ribbonFold`,`ribbonBreath`,`zoom`,`warp`,`ridgeAmt`,`sharp`,`shade`,`exposure`,`edgeGlow`,`colorA`,`colorB`,`colorC`,`colorD`,`highlightColor`,`glowColor`],n={};for(let r of t)e[r]!==void 0&&Object.assign(n,{[r]:e[r]});return n}var co=`https://github.com/Simon66-workshop/Apple-orc`,W=`/Apple-orc/`,G=[`interface`,`presets`,`embed`],lo={interface:`In your interface`,presets:`Preset library`,embed:`iframe lab`};function uo({children:e}){let[t,n]=(0,_.useState)(!1),[r,i]=(0,_.useState)(!1);async function a(){try{await navigator.clipboard.writeText(e),n(!0),i(!1)}catch{i(!0)}}return(0,_.useEffect)(()=>{if(!t)return;let e=setTimeout(()=>n(!1),1800);return()=>clearTimeout(e)},[t]),(0,B.jsxs)(`div`,{className:`showcase-code`,children:[(0,B.jsxs)(`div`,{className:`code-caption`,children:[(0,B.jsx)(`span`,{children:`Integration example`}),(0,B.jsxs)(`button`,{onClick:a,"aria-label":`Copy integration code`,children:[t?(0,B.jsx)(wr,{size:15}):(0,B.jsx)(Dr,{size:15}),` `,t?`Copied`:`Copy`]})]}),(0,B.jsx)(`pre`,{tabIndex:0,children:(0,B.jsx)(`code`,{children:e})}),r&&(0,B.jsx)(`p`,{role:`status`,children:`Clipboard unavailable. Select and copy the code.`})]})}function fo(){let[e,t]=(0,_.useState)(`thinking`),[n,r]=(0,_.useState)(`siri`),[i,a]=(0,_.useState)(`Thinking it through`);return(0,B.jsxs)(`div`,{className:`showcase-interface`,children:[(0,B.jsxs)(`section`,{className:`showcase-intro`,children:[(0,B.jsxs)(`h1`,{children:[`A little presence.`,(0,B.jsx)(`br`,{}),(0,B.jsx)(`span`,{children:`A clearer state.`})]}),(0,B.jsx)(`p`,{children:`A liquid-glass orb for the moments between a question and an answer. Tune its look, then put it in your own interface.`}),(0,B.jsxs)(`div`,{className:`showcase-facts`,children:[`13 presets `,(0,B.jsx)(`span`,{children:`·`}),` React + iframe `,(0,B.jsx)(`span`,{children:`·`}),` MIT`]}),(0,B.jsxs)(`a`,{className:`showcase-primary`,href:W,children:[`Open the workbench `,(0,B.jsx)(Cr,{size:18})]}),(0,B.jsx)(`p`,{className:`showcase-small`,children:`Interactive component demo. No model or microphone connected.`})]}),(0,B.jsxs)(`section`,{className:`interface-example`,"aria-label":`Live React integration`,children:[(0,B.jsxs)(`div`,{className:`example-top`,children:[(0,B.jsx)(`span`,{children:`Assistant interface`}),(0,B.jsx)(`span`,{className:`local-label`,children:`Local demo`})]}),(0,B.jsx)(`div`,{className:`example-orb`,children:(0,B.jsx)(ao,{preset:n,state:e,size:260})}),(0,B.jsx)(`h2`,{children:e===`thinking`?i||`Thinking`:`Ready when you are`}),(0,B.jsxs)(`p`,{children:[`The component follows your app state.`,(0,B.jsx)(`br`,{}),`The rest of the conversation is yours.`]}),(0,B.jsxs)(`div`,{className:`state-buttons`,role:`group`,"aria-label":`Component state`,children:[(0,B.jsxs)(`button`,{"aria-pressed":e===`idle`,onClick:()=>t(`idle`),children:[(0,B.jsx)(jr,{size:14}),` Idle`]}),(0,B.jsxs)(`button`,{"aria-pressed":e===`thinking`,onClick:()=>t(`thinking`),children:[(0,B.jsx)(kr,{size:14}),` Thinking`]})]}),(0,B.jsxs)(`div`,{className:`example-config`,children:[(0,B.jsxs)(`label`,{children:[`Preset`,(0,B.jsx)(`select`,{"aria-label":`Preset`,value:n,onChange:e=>r(e.target.value),children:ee.map(e=>(0,B.jsx)(`option`,{value:e,children:Za.en[e]},e))})]}),(0,B.jsxs)(`label`,{children:[`Status text`,(0,B.jsx)(`input`,{value:i,maxLength:60,onChange:e=>a(e.target.value)})]})]})]}),(0,B.jsxs)(`div`,{className:`interface-code`,children:[(0,B.jsx)(uo,{children:`import { AppleOrc } from "@/lib/orb";\n\n<AppleOrc\n  preset="${n}"\n  state="${e}"\n  size={72}\n  label="${e===`thinking`?`Thinking...`:`Ready`}"\n/>`}),(0,B.jsxs)(`p`,{className:`showcase-small`,children:[`Source import, not an npm package. `,(0,B.jsx)(`a`,{href:`${co}/blob/main/docs/INTEGRATION.md`,children:`Integration guide ↗`})]})]})]})}var po=[`siri`,`aurora`,`chromaticMetal`,`plasma`,`opal`,`particleRibbon`];function mo(){let[e,t]=(0,_.useState)(`thinking`),[n,r]=(0,_.useState)(`siri`);return(0,B.jsxs)(`section`,{className:`preset-showcase`,children:[(0,B.jsxs)(`div`,{className:`section-heading`,children:[(0,B.jsxs)(`div`,{children:[(0,B.jsxs)(`h1`,{children:[`Same component.`,(0,B.jsx)(`br`,{}),(0,B.jsx)(`span`,{children:`A different character.`})]}),(0,B.jsx)(`p`,{children:`Six choices from 13 presets. The selected orb is live; the others are preset thumbnails.`})]}),(0,B.jsxs)(`div`,{className:`state-buttons`,"aria-label":`Gallery state`,role:`group`,children:[(0,B.jsx)(`button`,{"aria-pressed":e===`idle`,onClick:()=>t(`idle`),children:`Idle`}),(0,B.jsx)(`button`,{"aria-pressed":e===`thinking`,onClick:()=>t(`thinking`),children:`Thinking`})]})]}),(0,B.jsx)(`div`,{className:`live-preset-grid`,children:po.map((t,i)=>(0,B.jsxs)(`article`,{"data-active":n===t,children:[(0,B.jsx)(`button`,{className:`preset-orb`,"data-preset":t,"aria-label":`Preview ${Za.en[t]}`,"aria-pressed":n===t,onClick:()=>r(t),children:n===t?(0,B.jsx)(ao,{preset:t,state:e,size:170}):(0,B.jsx)(`img`,{src:`${W}presets/${t}.png`,width:170,height:170,alt:``})}),(0,B.jsxs)(`div`,{children:[(0,B.jsxs)(`span`,{className:`preset-number`,children:[`0`,i+1,n===t?` · LIVE`:``]}),(0,B.jsx)(`h2`,{children:Za.en[t]}),(0,B.jsx)(`code`,{children:t})]})]},t))}),(0,B.jsxs)(`a`,{className:`showcase-secondary`,href:W,children:[`Tune all 13 presets in the workbench `,(0,B.jsx)(Cr,{size:17})]})]})}function ho(){let e=(0,_.useRef)(null),[t,n]=(0,_.useState)(!1),[r,i]=(0,_.useState)(`idle`),[a,o]=(0,_.useState)(`Ready when you are`),[s,c]=(0,_.useState)(`Waiting for widget`),l=window.location.origin,u=`${l}${W}embed.html?style=aurora&state=idle&preview=scene&text=Ready%20when%20you%20are&parentOrigin=${encodeURIComponent(l)}`;(0,_.useEffect)(()=>{let t=t=>{if(t.source!==e.current?.contentWindow||t.origin!==l||t.data?.source!==`apple-orc`)return;let r=t.data;r.type===`ready`&&(n(!0),c(`ready · parent origin verified`)),r.type===`state`&&(r.state===`idle`||r.state===`thinking`)&&(i(r.state),c(`state · ${r.state}`)),r.type===`pong`&&(n(!0),c(`pong · round trip confirmed`))};return window.addEventListener(`message`,t),()=>window.removeEventListener(`message`,t)},[l]);function d(t,n={}){e.current?.contentWindow?.postMessage({source:`apple-orc`,type:t,...n},l)}function f(e){d(`setState`,{state:e}),d(`setText`,{text:e===`thinking`?`Thinking it through`:a})}return(0,B.jsxs)(`section`,{className:`embed-showcase`,children:[(0,B.jsxs)(`div`,{className:`section-heading`,children:[(0,B.jsxs)(`div`,{children:[(0,B.jsxs)(`h1`,{children:[`Your page.`,(0,B.jsx)(`br`,{}),(0,B.jsx)(`span`,{children:`One small embed.`})]}),(0,B.jsx)(`p`,{children:`This panel controls an actual iframe. The widget replies with its state.`})]}),(0,B.jsx)(Er,{size:32,strokeWidth:1})]}),(0,B.jsxs)(`div`,{className:`embed-layout`,children:[(0,B.jsxs)(`div`,{className:`embed-live`,children:[(0,B.jsxs)(`div`,{className:`example-top`,children:[(0,B.jsx)(`span`,{children:`Host application`}),(0,B.jsx)(`span`,{className:`local-label`,children:`Live iframe`})]}),(0,B.jsxs)(`div`,{className:`embed-stage`,children:[(0,B.jsx)(`iframe`,{title:`Live Apple Orc widget`,ref:e,src:u,onLoad:()=>d(`ping`)}),(0,B.jsx)(`span`,{className:`embed-boundary-label`,children:`The iframe boundary`})]}),(0,B.jsxs)(`div`,{className:`embed-controls`,children:[(0,B.jsxs)(`div`,{className:`state-buttons`,role:`group`,"aria-label":`Iframe state`,children:[(0,B.jsx)(`button`,{disabled:!t,"aria-pressed":r===`idle`,onClick:()=>f(`idle`),children:`Idle`}),(0,B.jsx)(`button`,{disabled:!t,"aria-pressed":r===`thinking`,onClick:()=>f(`thinking`),children:`Thinking`})]}),(0,B.jsxs)(`label`,{children:[`Widget text`,(0,B.jsx)(`input`,{value:a,maxLength:280,onChange:e=>{o(e.target.value),d(`setText`,{text:e.target.value})}})]}),(0,B.jsx)(`button`,{className:`showcase-secondary`,disabled:!t,onClick:()=>d(`ping`),children:`Ping widget`}),(0,B.jsx)(`output`,{"aria-live":`polite`,"data-testid":`widget-event`,children:s})]})]}),(0,B.jsxs)(`div`,{children:[(0,B.jsx)(uo,{children:`const frame = document.querySelector("iframe");
...
);`}),(0,B.jsxs)(`div`,{className:`embed-notes`,children:[(0,B.jsx)(`h2`,{children:`A small, explicit contract.`}),(0,B.jsxs)(`p`,{children:[(0,B.jsx)(`code`,{children:`setState`}),` — idle or thinking`]}),(0,B.jsxs)(`p`,{children:[(0,B.jsx)(`code`,{children:`setText`}),` — up to 280 characters`]}),(0,B.jsxs)(`p`,{children:[(0,B.jsx)(`code`,{children:`ping → pong`}),` — connection check`]}),(0,B.jsx)(`p`,{children:`Messages are checked against the parent window, parent origin and payload schema.`}),(0,B.jsx)(`a`,{href:`${co}/blob/main/docs/INTEGRATION.md`,children:`Read the integration guide ↗`})]})]})]})]})}function go(){let e=new URLSearchParams(window.location.search).get(`view`),[t,n]=(0,_.useState)(G.includes(e)?e:`interface`);function r(e){n(e);let t=new URL(window.location.href);t.searchParams.set(`view`,e),window.history.replaceState(null,``,t)}return(0,_.useEffect)(()=>{document.title=`Apple Orc — Live integration examples`},[]),(0,B.jsxs)(`div`,{className:`showcase-app`,children:[(0,B.jsxs)(`header`,{className:`orc-product-bar`,children:[(0,B.jsxs)(`a`,{className:`orc-wordmark`,href:W,children:[`Apple Orc `,(0,B.jsx)(`span`,{children:`by 66Workshop`})]}),(0,B.jsx)(`nav`,{"aria-label":`Showcase views`,children:G.map(e=>(0,B.jsx)(`button`,{onClick:()=>r(e),"aria-current":t===e?`page`:void 0,children:lo[e]},e))}),(0,B.jsxs)(`a`,{className:`github-link`,href:co,target:`_blank`,rel:`noreferrer`,children:[`GitHub `,(0,B.jsx)(Cr,{size:15})]})]}),(0,B.jsx)(`main`,{children:t===`interface`?(0,B.jsx)(fo,{}):t===`presets`?(0,B.jsx)(mo,{}):(0,B.jsx)(ho,{})}),(0,B.jsxs)(`footer`,{children:[(0,B.jsx)(`span`,{children:`Open source. Small by design.`}),(0,B.jsxs)(`span`,{children:[`Shader & motion: `,(0,B.jsx)(`a`,{href:`https://github.com/LerSent001/orb`,children:`LerSent001/orb`}),` · MIT · Independent of Apple`]})]})]})}var _o=`/Apple-orc/`,vo=window.location.pathname,yo=/(?:^|\/)embed(?:\.html)?\/?$/.test(vo),bo=/(?:^|\/)showcase(?:\.html)?\/?$/.test(vo);function xo(){return(0,B.jsxs)(`div`,{className:`orc-workbench-shell`,children:[(0,B.jsxs)(`header`,{className:`orc-product-bar`,children:[(0,B.jsxs)(`a`,{href:_o,className:`orc-wordmark`,children:[`Apple Orc `,(0,B.jsx)(`span`,{children:`by 66Workshop`})]}),(0,B.jsxs)(`nav`,{"aria-label":`Product links`,children:[(0,B.jsx)(`a`,{href:`${_o}showcase.html`,children:`Live examples`}),(0,B.jsx)(`a`,{href:`https://github.com/Simon66-workshop/Apple-orc`,target:`_blank`,rel:`noreferrer`,children:`GitHub ↗`})]})]}),(0,B.jsx)(io,{})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,B.jsx)(_.StrictMode,{children:yo?(0,B.jsx)(mr,{}):bo?(0,B.jsx)(go,{}):(0,B.jsx)(xo,{})}));