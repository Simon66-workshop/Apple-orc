...
`)}function ze(e){return{idle:de(De(e,`idle`)),thinking:de(De(e,`thinking`))}}function Be(e,t){let n=ze(e),r=JSON.stringify(Le);return`<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
...
private let orbRibbonInstanceCount = ${fe}
...
// required styles and license notices; see the integration guide.`}function Qe(e,t,n){let r=De(e.configuration,`thinking`),i=De(e.configuration,`idle`);return JSON.stringify({preset:r.style,state:e.activeState,preview:t,text:n,activationDuration:e.configuration.activationDuration,transitionDuration:e.configuration.transitionDuration,thinking:r,idle:i},null,2)}function $e(e,t,n,r,i){let a=r===`scene`?120:360;return{web:Be(e.configuration,e.activeState),swift:Ve(e.configuration,e.activeState),iframe:Ye(t,n,a),react:Xe(t,n,a),dropin:Ze(),json:Qe(e,r,i)}}function et(){return typeof window<`u`}function tt(){if(!et())return`en`;try{let e=window.localStorage.getItem(T);if(e===`zh`||e===`en`)return e}catch{}return navigator.language.toLowerCase().startsWith(`zh`)?`zh`:`en`}function nt(e){if(et())try{window.localStorage.setItem(T,e)}catch{}}function rt(){return new URLSearchParams(window.location.hash.replace(/^#/,``))}function it(){return et()&&rt().get(`preview`)===`scene`?`scene`:`orb`}function at(){if(!et())return w;let e=rt().get(`text`);return e===null?w:j(e)}function ot(e,t){return e===`thinking`?t:`idle${t.charAt(0).toUpperCase()}${t.slice(1)}`}function st(){return{configuration:Ee(C.style),activeState:_e}}function ct(){if(!et())return st();let e=rt(),t=e.get(`style`),n=t&&ee.includes(t)?t:C.style,r={style:n,...x[n]},i=e.get(`glass`);i===`1`&&(r.glassEnabled=!0),i===`0`&&(r.glassEnabled=!1);for(let t of ae){let n=e.get(t.key);if(n===null)continue;let i=Number(n);Number.isFinite(i)&&(r[t.key]=ce(i,t.min,t.max))}for(let t of k){let n=e.get(t);if(n===null)continue;let i=le(n);i&&(r[t]=i)}let a=e.get(`transition`),o=a===null?null:Number(a),s=o!==null&&Number.isFinite(o)?ce(o,E.min,E.max):ye,c=e.get(`activation`),l=c===null?null:Number(c),u=Te(r,s,l!==null&&Number.isFinite(l)?ce(l,te.min,te.max):ve);for(let t of ge){let n=e.get(ot(`idle`,t));if(n!==null){if(typeof u.profiles.idle[t]==`number`){let e=oe.get(t),r=Number(n);e&&Number.isFinite(r)&&(u=Oe(u,`idle`,t,ce(r,e.min,e.max)))}else{let e=le(n);e&&(u=Oe(u,`idle`,t,e))}}}let d=e.get(`state`),f=d&&pe.includes(d)?d:_e;return{configuration:u,activeState:f}}function lt(e,t,n){let{configuration:r,activeState:i}=e,a=De(r,`thinking`),o=new URLSearchParams;o.set(`effect`,`orb-glass-liquid`),o.set(`style`,a.style),o.set(`glass`,a.glassEnabled?`1`:`0`),o.set(`state`,i),o.set(`activation`,String(r.activationDuration)),o.set(`transition`,String(r.transitionDuration)),o.set(`preview`,t),o.set(`text`,n);for(let e of ae)o.set(e.key,String(a[e.key])),Se(e.key)&&o.set(ot(`idle`,e.key),String(r.profiles.idle[e.key]));for(let e of k)o.set(e,a[e]),Se(e)&&o.set(ot(`idle`,e),r.profiles.idle[e]);return o.toString()}function ut(e,t,n){et()&&window.history.replaceState(window.history.state,``,`#${lt(e,t,n)}`)}function dt(e){return[Number.parseInt(e.slice(1,3),16),Number.parseInt(e.slice(3,5),16),Number.parseInt(e.slice(5,7),16)]}function ft(e,t){let[n,r,i]=dt(e);return`rgba(${n}, ${r}, ${i}, ${t})`}function pt(e,t,n){let r=dt(e),i=dt(t),a=Math.min(1,Math.max(0,n));return`#${[Math.round(r[0]+(i[0]-r[0])*a),Math.round(r[1]+(i[1]-r[1])*a),Math.round(r[2]+(i[2]-r[2])*a)].map(e=>e.toString(16).padStart(2,`0`)).join(``)}`}function mt(e,t){let n=(t%1+1)%1;return n<.25?pt(e.colorA,e.colorB,n/.25):n<.5?pt(e.colorB,e.colorC,(n-.25)/.25):n<.75?pt(e.colorC,e.colorD,(n-.5)/.25):pt(e.colorD,e.colorA,(n-.75)/.25)}function ht(e,t,n,r,i,a){let o=r*(.1+a.warp*.018)*(.45+a.ridgeAmt),s=r*(.16+a.zoom*.22),c=n+Math.sin(i*1.15)*r*.1;e.save(),e.translate(t,c),e.rotate(Math.sin(i*.27)*.12*(.4+a.contourDeform)),e.filter=`blur(${Math.max(1.2,r*.055)}px)`;let l=e.createLinearGradient(-r,0,r,0);l.addColorStop(0,ft(a.colorD,0)),l.addColorStop(.18,ft(a.colorD,.85)),l.addColorStop(.38,a.colorC),l.addColorStop(.52,a.colorB),l.addColorStop(.7,a.colorA),l.addColorStop(.88,ft(a.colorD,.7)),l.addColorStop(1,ft(a.colorD,0)),e.beginPath(),e.moveTo(-r,0);for(let t=0;t<=48;t+=1){let n=-r+2*r*t/48,s=n/r,c=Math.sin(s*(2.2+a.zoom*4)+i*2.1)*o+Math.sin(s*5.4-i*1.3)*o*.28;e.lineTo(n,c)}e.strokeStyle=l,e.lineWidth=s,e.lineCap=`round`,e.stroke(),e.filter=`blur(${Math.max(.6,r*.03)}px)`,e.globalCompositeOperation=`lighter`,e.strokeStyle=ft(a.highlightColor,.45),e.lineWidth=s*.28,e.stroke(),e.restore()}function gt(e,t,n,r,i,a){let o=Math.max(2,Math.round(a.ribbonCount));e.save(),e.globalCompositeOperation=`lighter`;for(let s=0;s<o;s+=1){let o=i*.7+s*.6;e.beginPath();for(let i=0;i<=40;i+=1){let a=i/40*Math.PI*2+o*.4+s,c=r*(.22+.18*Math.cos(a*2+o)),l=t+Math.cos(a+s*.4)*c*1.6,u=n+Math.sin(a*.85+o)*c*.55;i===0?e.moveTo(l,u):e.lineTo(l,u)}e.strokeStyle=ft(mt(a,s*.18+i*.02),.55),e.lineWidth=Math.max(1.2,r*.045*a.ribbonWidth*2),e.lineCap=`round`,e.filter=`blur(${Math.max(.8,r*.02*a.particleBloom)}px)`,e.stroke()}e.restore()}function _t(e,t,n,r,i,a){e.save(),e.translate(t,n),e.rotate(a.metalAngle*Math.PI/180);let o=10+Math.round(a.bandDensity*3);for(let t=0;t<o;t+=1){let n=-r+2*r*t/o+Math.sin(i+t)*r*.04,s=e.createLinearGradient(n,-r,n+r*.18,r);s.addColorStop(0,ft(a.colorA,.15)),s.addColorStop(.4,ft(a.colorB,.55)),s.addColorStop(.7,ft(a.shellMid,.4)),s.addColorStop(1,ft(a.colorD,.2)),e.fillStyle=s,e.fillRect(n,-r,r*(.08+a.metalStretch*.1),r*2)}e.restore()}function vt(e,t,n,r,i){if(!i.glassEnabled)return;let a=e.createRadialGradient(t,n,r*.55,t,n,r);a.addColorStop(0,`rgba(255,255,255,0)`),a.addColorStop(.72,ft(i.shellInner,.02)),a.addColorStop(.88,ft(i.shellMid,.18+i.sheen*.12)),a.addColorStop(1,ft(i.shellEdge,.42+i.shellEdgeAlpha*.35)),e.fillStyle=a,e.beginPath(),e.arc(t,n,r,0,Math.PI*2),e.fill(),e.save(),e.globalCompositeOperation=`lighter`;let o=e.createRadialGradient(t-r*.32,n-r*.38,r*.02,t-r*.22,n-r*.32,r*.42);o.addColorStop(0,ft(i.sheenColor,.55)),o.addColorStop(.45,ft(i.specColor,.12)),o.addColorStop(1,`rgba(255,255,255,0)`),e.fillStyle=o,e.beginPath(),e.ellipse(t-r*.18,n-r*.28,r*.42,r*.28,-.5,0,Math.PI*2),e.fill(),e.restore()}function yt(e,t,n,r,i){let a=t/2,o=n/2,s=Math.max(8,Math.min(t,n)*.5*i.radius);if(e.clearRect(0,0,t,n),i.edgeGlow>.01){let r=e.createRadialGradient(a,o,s*.7,a,o,s*(1.35+i.edgeGlow));r.addColorStop(0,ft(i.glowColor,.22*i.edgeGlow*i.exposure)),r.addColorStop(1,`rgba(0,0,0,0)`),e.fillStyle=r,e.fillRect(0,0,t,n)}e.save(),e.beginPath(),e.arc(a,o,s,0,Math.PI*2),e.clip();let c=e.createRadialGradient(a,o-s*.15,s*.08,a,o,s);c.addColorStop(0,pt(i.colorA,`#0a0a12`,.55+i.shade*.2)),c.addColorStop(.55,pt(i.colorD,`#050509`,.72)),c.addColorStop(1,`#030308`),e.fillStyle=c,e.fillRect(a-s,o-s,s*2,s*2);let l=i.style;l===`particleRibbon`?gt(e,a,o,s,r,i):l===`chromaticMetal`||l===`chrome`?(_t(e,a,o,s,r,i),l===`chromaticMetal`&&(e.save(),e.globalCompositeOperation=`screen`,e.filter=`blur(${s*.04}px)`,e.fillStyle=ft(i.shellMid,.25*i.chromaticShift),e.fillRect(a-s+3,o-s,s*2,s*2),e.fillStyle=ft(i.shellEdge,.2*i.chromaticShift),e.fillRect(a-s-3,o-s,s*2,s*2),e.restore())):(ht(e,a,o,s,r,i),(l===`aurora`||l===`plasma`)&&(e.save(),e.globalAlpha=.55,e.translate(0,s*.18),e.rotate(.4),ht(e,a,o,s*.85,r*.7+1.2,i),e.restore())),e.restore(),vt(e,a,o,s,i),e.beginPath(),e.arc(a,o,s,0,Math.PI*2),e.strokeStyle=ft(i.highlightColor,.22+i.sheen*.1),e.lineWidth=Math.max(1,s*(.012+i.edgeSoftness)),e.stroke()}function bt({canvas:e,getTarget:t}){let n=e.getContext(`2d`);if(!n)return()=>{};let r=n,i=!1,a=0,o=null,s=0,c=Ie(t());function l(n){if(i)return;let u=Math.min(window.devicePixelRatio||1,2),d=Math.max(1,Math.floor(e.clientWidth*u)),f=Math.max(1,Math.floor(e.clientHeight*u));(e.width!==d||e.height!==f)&&(e.width=d,e.height=f);let p=c.sample(t(),n),m=o===null?0:Math.min(.1,Math.max(0,(n-o)/1e3));o=n,s+=m*Math.max(p.speed,0),yt(r,d,f,s,p),a=requestAnimationFrame(l)}return a=requestAnimationFrame(l),()=>{i=!0,cancelAnimationFrame(a)}}function xt({canvas:e,getTarget:t,onError:n,onReady:r}){let i=!1,a=0,o=null,s=null,c=!1,l=!1,u=null,d=0;function f(e){i||l||(l=!0,cancelAnimationFrame(a),s?.destroy(),o?.destroy(),n(e))}async function p(){if(!navigator.gpu)throw Error(`当前浏览器不支持 WebGPU`);let n=await navigator.gpu.requestAdapter();if(!n)throw Error(`未找到可用的 WebGPU 适配器`);if(o=await n.requestDevice(),i){o.destroy();return}let p=e.getContext(`webgpu`);if(!p)throw Error(`无法创建 WebGPU 画布上下文`);let m=p,h=navigator.gpu.getPreferredCanvasFormat();m.configure({device:o,format:h,alphaMode:`premultiplied`});let g=o.createShaderModule({label:`orb-glass-liquid`,code:Le}),_=(await g.getCompilationInfo()).messages.filter(e=>e.type===`error`);if(_.length>0)throw Error(_.map(e=>`${e.lineNum}:${e.linePos} ${e.message}`).join(`
`));if(i||l)return;let v=o.createRenderPipeline({label:`orb-glass-liquid-pipeline`,layout:`auto`,vertex:{module:g,entryPoint:`vs_main`},fragment:{module:g,entryPoint:`fs_main`,targets:[{format:h,blend:{color:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}}}]},primitive:{topology:`triangle-list`}}),y=o.createRenderPipeline({label:`particle-ribbon-pipeline`,layout:`auto`,vertex:{module:g,entryPoint:`ribbon_vs_main`},fragment:{module:g,entryPoint:`ribbon_fs_main`,targets:[{format:h,blend:{color:{srcFactor:`one`,dstFactor:`one`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}}}]},primitive:{topology:`triangle-list`}}),b=o.createRenderPipeline({label:`particle-ribbon-glass-composite-pipeline`,layout:`auto`,vertex:{module:g,entryPoint:`vs_main`},fragment:{module:g,entryPoint:`ribbon_composite_fs_main`,targets:[{format:h,blend:{color:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}}}]},primitive:{topology:`triangle-list`}}),x=new Float32Array(136),ee=o.createBuffer({size:x.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),C=o.createBindGroup({layout:v.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:ee}}]}),w=o.createBindGroup({layout:y.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:ee}}]}),T=o.createSampler({addressModeU:`clamp-to-edge`,addressModeV:`clamp-to-edge`,magFilter:`linear`,minFilter:`linear`}),te=null,E=Ie(t());o.lost.then(e=>{f(Error(`WebGPU 设备已断开：${e.message||e.reason}`))}),o.addEventListener(`uncapturederror`,e=>{e.preventDefault(),f(Error(`WebGPU 渲染错误：${e.error.message}`))});function ne(){let t=Math.min(window.devicePixelRatio||1,2),n=Math.max(1,Math.floor(e.clientWidth*t)),r=Math.max(1,Math.floor(e.clientHeight*t));(e.width!==n||e.height!==r)&&(e.width=n,e.height=r,s?.destroy(),s=null,te=null)}function re(){s&&te||(s=o.createTexture({label:`particle-ribbon-offscreen-texture`,size:{width:e.width,height:e.height},format:h,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),te=o.createBindGroup({layout:b.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:ee}},{binding:1,resource:s.createView()},{binding:2,resource:T}]}))}function D(n){if(!(i||l||!o))try{ne();let p=E.sample(t(),n),h=u===null?0:Math.min(.1,Math.max(0,(n-u)/1e3));u=n,d+=h*Math.max(p.speed,0);let g=d/Math.max(p.speed,.001);ue(x,e.width,e.height,g,p),o.queue.writeBuffer(ee,0,x);let _=S[p.style]===S.particleRibbon,T=o.createCommandEncoder();if(_){re();let e=T.beginRenderPass({colorAttachments:[{view:s.createView(),clearValue:{r:0,g:0,b:0,a:0},loadOp:`clear`,storeOp:`store`}]});e.setPipeline(y),e.setBindGroup(0,w),e.draw(6,fe,0,0),e.end()}let O=T.beginRenderPass({colorAttachments:[{view:m.getCurrentTexture().createView(),clearValue:{r:0,g:0,b:0,a:0},loadOp:`clear`,storeOp:`store`}]});_?(O.setPipeline(b),O.setBindGroup(0,te)):(O.setPipeline(v),O.setBindGroup(0,C)),O.draw(3,1,0,0),O.end(),o.queue.submit([T.finish()]),o.queue.onSubmittedWorkDone().then(()=>{i||l||(c||(c=!0,r()),a=requestAnimationFrame(D))}).catch(e=>{f(e instanceof Error?e:Error(String(e)))})}catch(e){f(e instanceof Error?e:Error(String(e)))}}a=requestAnimationFrame(D)}return p().catch(e=>{f(e instanceof Error?e:Error(String(e)))}),()=>{i=!0,cancelAnimationFrame(a),s?.destroy(),o?.destroy()}}function St(e){var t,n,r=``;if(typeof e==`string`||typeof e==`number`)r+=e;else if(typeof e==`object`){if(Array.isArray(e)){var i=e.length;for(t=0;t<i;t++)e[t]&&(n=St(e[t]))&&(r&&(r+=` `),r+=n)}else for(n in e)e[n]&&(r&&(r+=` `),r+=n)}return r}function Ct(){for(var e,t,n=0,r=``,i=arguments.length;n<i;n++)(e=arguments[n])&&(t=St(e))&&(r&&(r+=` `),r+=t);return r}var wt=(e,t)=>{let n=Array(e.length+t.length);for(let t=0;t<e.length;t++)n[t]=e[t];for(let r=0;r<t.length;r++)n[e.length+r]=t[r];return n},Tt=(e,t)=>({classGroupId:e,validator:t}),Et=(e=new Map,t=null,n)=>({nextPart:e,validators:t,classGroupId:n}),Dt=`-`,Ot=[],kt=`arbitrary..`,At=e=>{let t=Nt(e),{conflictingClassGroups:n,conflictingClassGroupModifiers:r}=e;return{getClassGroupId:e=>{if(e.startsWith(`[`)&&e.endsWith(`]`))return Mt(e);let n=e.split(Dt);return jt(n,+(n[0]===``&&n.length>1),t)},getConflictingClassGroupIds:(e,t)=>{if(t){let t=r[e],i=n[e];return t?i?wt(i,t):t:i||Ot}return n[e]||Ot}}},jt=(e,t,n)=>{if(e.length-t===0)return n.classGroupId;let r=e[t],i=n.nextPart.get(r);if(i){let n=jt(e,t+1,i);if(n)return n}let a=n.validators;if(a===null)return;let o=t===0?e.join(Dt):e.slice(t).join(Dt),s=a.length;for(let e=0;e<s;e++){let t=a[e];if(t.validator(o))return t.classGroupId}},Mt=e=>e.slice(1,-1).indexOf(`:`)===-1?void 0:(()=>{let t=e.slice(1,-1),n=t.indexOf(`:`),r=t.slice(0,n);return r?kt+r:void 0})(),Nt=e=>{let{theme:t,classGroups:n}=e;return Pt(n,t)},Pt=(e,t)=>{let n=Et();for(let r in e){let i=e[r];Ft(i,n,r,t)}return n},Ft=(e,t,n,r)=>{let i=e.length;for(let a=0;a<i;a++){let i=e[a];It(i,t,n,r)}},It=(e,t,n,r)=>{if(typeof e==`string`){Lt(e,t,n);return}if(typeof e==`function`){Rt(e,t,n,r);return}zt(e,t,n,r)},Lt=(e,t,n)=>{let r=e===``?t:Bt(t,e);r.classGroupId=n},Rt=(e,t,n,r)=>{if(Vt(e)){Ft(e(r),t,n,r);return}t.validators===null&&(t.validators=[]),t.validators.push(Tt(n,e))},zt=(e,t,n,r)=>{let i=Object.entries(e),a=i.length;for(let e=0;e<a;e++){let[a,o]=i[e];Ft(o,Bt(t,a),n,r)}},Bt=(e,t)=>{let n=e,r=t.split(Dt),i=r.length;for(let e=0;e<i;e++){let t=r[e],i=n.nextPart.get(t);i||(i=Et(),n.nextPart.set(t,i)),n=i}return n},Vt=e=>`isThemeGetter`in e&&e.isThemeGetter===!0,Ht=e=>{if(e<1)return{get:()=>void 0,set:()=>{}};let t=0,n=Object.create(null),r=Object.create(null),i=(i,a)=>{n[i]=a,t++,t>e&&(t=0,r=n,n=Object.create(null))};return{get(e){let t=n[e];if(t!==void 0)return t;if((t=r[e])!==void 0)return i(e,t),t},set(e,t){e in n?n[e]=t:i(e,t)}}},Ut=`!`,Wt=`:`,Gt=[],Kt=(e,t,n,r,i)=>({modifiers:e,hasImportantModifier:t,baseClassName:n,maybePostfixModifierPosition:r,isExternal:i}),qt=e=>{let{prefix:t,experimentalParseClassName:n}=e,r=e=>{let t=[],n=0,r=0,i=0,a,o=e.length;for(let s=0;s<o;s++){let o=e[s];if(n===0&&r===0){if(o===Wt){t.push(e.slice(i,s)),i=s+1;continue}if(o===`/`){a=s;continue}}o===`[`?n++:o===`]`?n--:o===`(`?r++:o===`)`&&r--}let s=t.length===0?e:e.slice(i),c=s,l=!1;s.endsWith(Ut)?(c=s.slice(0,-1),l=!0):s.startsWith(Ut)&&(c=s.slice(1),l=!0);let u=a&&a>i?a-i:void 0;return Kt(t,l,c,u)};if(t){let e=t+Wt,n=r;r=t=>t.startsWith(e)?n(t.slice(e.length)):Kt(Gt,!1,t,void 0,!0)}if(n){let e=r;r=t=>n({className:t,parseClassName:e})}return r},Jt=e=>{let t=new Map;return e.orderSensitiveModifiers.forEach((e,n)=>{t.set(e,1e6+n)}),e=>{let n=[],r=[];for(let i=0;i<e.length;i++){let a=e[i],o=a[0]===`[`,s=t.has(a);o||s?(r.length>0&&(r.sort(),n.push(...r),r=[]),n.push(a)):r.push(a)}return r.length>0&&(r.sort(),n.push(...r)),n}},Yt=e=>({cache:Ht(e.cacheSize),parseClassName:qt(e),sortModifiers:Jt(e),postfixLookupClassGroupIds:Xt(e),...At(e)}),Xt=e=>{let t=Object.create(null),n=e.postfixLookupClassGroups;if(n)for(let e=0;e<n.length;e++)t[n[e]]=!0;return t},Zt=/\s+/,Qt=(e,t)=>{let{parseClassName:n,getClassGroupId:r,getConflictingClassGroupIds:i,sortModifiers:a,postfixLookupClassGroupIds:o}=t,s=[],c=e.trim().split(Zt),l=``;for(let e=c.length-1;e>=0;--e){let t=c[e],{isExternal:u,modifiers:d,hasImportantModifier:f,baseClassName:p,maybePostfixModifierPosition:m}=n(t);if(u){l=t+(l.length>0?` `+l:l);continue}let h=!!m,g;if(h){g=r(p.substring(0,m));let e=g&&o[g]?r(p):void 0;e&&e!==g&&(g=e,h=!1)}else g=r(p);if(!g){if(!h){l=t+(l.length>0?` `+l:l);continue}if(g=r(p),!g){l=t+(l.length>0?` `+l:l);continue}h=!1}let _=d.length===0?``:d.length===1?d[0]:a(d).join(`:`),v=f?_+Ut:_,y=v+g;if(s.indexOf(y)>-1)continue;s.push(y);let b=i(g,h);for(let e=0;e<b.length;++e){let t=b[e];s.push(v+t)}l=t+(l.length>0?` `+l:l)}return l},$t=(...e)=>{let t=0,n,r,i=``;for(;t<e.length;)(n=e[t++])&&(r=en(n))&&(i&&(i+=` `),i+=r);return i},en=e=>{if(typeof e==`string`)return e;let t,n=``;for(let r=0;r<e.length;r++)e[r]&&(t=en(e[r]))&&(n&&(n+=` `),n+=t);return n},tn=(e,...t)=>{let n,r,i,a,o=o=>(n=Yt(t.reduce((e,t)=>t(e),e())),r=n.cache.get,i=n.cache.set,a=s,s(o)),s=e=>{let t=r(e);if(t)return t;let a=Qt(e,n);return i(e,a),a};return a=o,(...e)=>a($t(...e))},nn=[],rn=e=>{let t=t=>t[e]||nn;return t.isThemeGetter=!0,t},an=/^\[(?:(\w[\w-]*):)?(.+)\]$/i,on=/^\((?:(\w[\w-]*):)?(.+)\)$/i,sn=/^\d+(?:\.\d+)?\/\d+(?:\.\d+)?$/,cn=/^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/,ln=/\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/,un=/^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/,dn=/^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/,fn=/^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/,pn=e=>sn.test(e),I=e=>!!e&&!Number.isNaN(Number(e)),mn=e=>!!e&&Number.isInteger(Number(e)),hn=e=>e.endsWith(`%`)&&I(e.slice(0,-1)),gn=e=>cn.test(e),_n=()=>!0,vn=e=>ln.test(e)&&!un.test(e),yn=()=>!1,bn=e=>dn.test(e),xn=e=>fn.test(e),Sn=e=>!L(e)&&!R(e),Cn=e=>e.startsWith(`@container`)&&(e[10]===`/`&&e[11]!==void 0||e[11]===`s`&&e[16]!==void 0&&e.startsWith(`-size/`,10)||e[11]===`n`&&e[18]!==void 0&&e.startsWith(`-normal/`,10)),wn=e=>zn(e,Un,yn),L=e=>an.test(e),Tn=e=>zn(e,Wn,vn),En=e=>zn(e,Gn,I),Dn=e=>zn(e,qn,_n),On=e=>zn(e,Kn,yn),kn=e=>zn(e,Vn,yn),An=e=>zn(e,Hn,xn),jn=e=>zn(e,Jn,bn),R=e=>on.test(e),Mn=e=>Bn(e,Wn),Nn=e=>Bn(e,Kn),Pn=e=>Bn(e,Vn),Fn=e=>Bn(e,Un),In=e=>Bn(e,Hn),Ln=e=>Bn(e,Jn,!0),Rn=e=>Bn(e,qn,!0),zn=(e,t,n)=>{let r=an.exec(e);return r?r[1]?t(r[1]):n(r[2]):!1},Bn=(e,t,n=!1)=>{let r=on.exec(e);return r?r[1]?t(r[1]):n:!1},Vn=e=>e===`position`||e===`percentage`,Hn=e=>e===`image`||e===`url`,Un=e=>e===`length`||e===`size`||e===`bg-size`,Wn=e=>e===`length`,Gn=e=>e===`number`,Kn=e=>e===`family-name`,qn=e=>e===`number`||e===`weight`,Jn=e=>e===`shadow`,Yn=tn(()=>{let e=rn(`color`),t=rn(`font`),n=rn(`text`),r=rn(`font-weight`),i=rn(`tracking`),a=rn(`leading`),o=rn(`breakpoint`),s=rn(`container`),c=rn(`spacing`),l=rn(`radius`),u=rn(`shadow`),d=rn(`inset-shadow`),f=rn(`text-shadow`),p=rn(`drop-shadow`),m=rn(`blur`),h=rn(`perspective`),g=rn(`aspect`),_=rn(`ease`),v=rn(`animate`),y=()=>[`auto`,`avoid`,`all`,`avoid-page`,`page`,`left`,`right`,`column`],b=()=>[`center`,`top`,`bottom`,`left`,`right`,`top-left`,`left-top`,`top-right`,`right-top`,`bottom-right`,`right-bottom`,`bottom-left`,`left-bottom`],x=()=>[...b(),R,L],ee=()=>[`auto`,`hidden`,`clip`,`visible`,`scroll`],S=()=>[`auto`,`contain`,`none`],C=()=>[R,L,c],w=()=>[pn,`full`,`auto`,...C()],T=()=>[mn,`none`,`subgrid`,R,L],te=()=>[`auto`,{span:[`full`,mn,R,L]},mn,R,L],E=()=>[mn,`auto`,R,L],ne=()=>[`auto`,`min`,`max`,`fr`,R,L],re=()=>[`start`,`end`,`center`,`between`,`around`,`evenly`,`stretch`,`baseline`,`center-safe`,`end-safe`],D=()=>[`start`,`end`,`center`,`stretch`,`center-safe`,`end-safe`],O=()=>[`auto`,...C()],ie=()=>[pn,`auto`,`full`,`dvw`,`dvh`,`lvw`,`lvh`,`svw`,`svh`,`min`,`max`,`fit`,...C()],ae=()=>[pn,`screen`,`full`,`dvw`,`lvw`,`svw`,`min`,`max`,`fit`,...C()],oe=()=>[pn,`screen`,`full`,`lh`,`dvh`,`lvh`,`svh`,`min`,`max`,`fit`,...C()],k=()=>[e,R,L],A=()=>[...b(),Pn,kn,{position:[R,L]}],se=()=>[`no-repeat`,{repeat:[``,`x`,`y`,`space`,`round`]}],ce=()=>[`auto`,`cover`,`contain`,Fn,wn,{size:[R,L]}],le=()=>[hn,Mn,Tn],j=()=>[``,`none`,`full`,l,R,L],M=()=>[``,I,Mn,Tn],N=()=>[`solid`,`dashed`,`dotted`,`double`],P=()=>[`normal`,`multiply`,`screen`,`overlay`,`darken`,`lighten`,`color-dodge`,`color-burn`,`hard-light`,`soft-light`,`difference`,`exclusion`,`hue`,`saturation`,`color`,`luminosity`],F=()=>[I,hn,Pn,kn],ue=()=>[``,`none`,m,R,L],de=()=>[`none`,I,R,L],fe=()=>[`none`,I,R,L],pe=()=>[I,R,L],me=()=>[pn,`full`,...C()];return{cacheSize:500,theme:{animate:[`spin`,`ping`,`pulse`,`bounce`],aspect:[`video`],blur:[gn],breakpoint:[gn],color:[_n],container:[gn],"drop-shadow":[gn],ease:[`in`,`out`,`in-out`],font:[Sn],"font-weight":[`thin`,`extralight`,`light`,`normal`,`medium`,`semibold`,`bold`,`extrabold`,`black`],"inset-shadow":[gn],leading:[`none`,`tight`,`snug`,`normal`,`relaxed`,`loose`],perspective:[`dramatic`,`near`,`normal`,`midrange`,`distant`,`none`],radius:[gn],shadow:[gn],spacing:[`px`,I],text:[gn],"text-shadow":[gn],tracking:[`tighter`,`tight`,`normal`,`wide`,`wider`,`widest`]},classGroups:{aspect:[{aspect:[`auto`,`square`,pn,L,R,g]}],container:[`container`],"container-type":[{"@container":[``,`normal`,`size`,R,L]}],"container-named":[Cn],columns:[{columns:[I,L,R,s]}],"break-after":[{"break-after":y()}],"break-before":[{"break-before":y()}],"break-inside":[{"break-inside":[`auto`,`avoid`,`avoid-page`,`avoid-column`]}],"box-decoration":[{"box-decoration":[`slice`,`clone`]}],box:[{box:[`border`,`content`]}],display:[`block`,`inline-block`,`inline`,`flex`,`inline-flex`,`table`,`inline-table`,`table-caption`,`table-cell`,`table-column`,`table-column-group`,`table-footer-group`,`table-header-group`,`table-row-group`,`table-row`,`flow-root`,`grid`,`inline-grid`,`contents`,`list-item`,`hidden`],sr:[`sr-only`,`not-sr-only`],float:[{float:[`right`,`left`,`none`,`start`,`end`]}],clear:[{clear:[`left`,`right`,`both`,`none`,`start`,`end`]}],isolation:[`isolate`,`isolation-auto`],"object-fit":[{object:[`contain`,`cover`,`fill`,`none`,`scale-down`]}],"object-position":[{object:x()}],overflow:[{overflow:ee()}],"overflow-x":[{"overflow-x":ee()}],"overflow-y":[{"overflow-y":ee()}],overscroll:[{overscroll:S()}],"overscroll-x":[{"overscroll-x":S()}],"overscroll-y":[{"overscroll-y":S()}],position:[`static`,`fixed`,`absolute`,`relative`,`sticky`],inset:[{inset:w()}],"inset-x":[{"inset-x":w()}],"inset-y":[{"inset-y":w()}],start:[{"inset-s":w(),start:w()}],end:[{"inset-e":w(),end:w()}],"inset-bs":[{"inset-bs":w()}],"inset-be":[{"inset-be":w()}],top:[{top:w()}],right:[{right:w()}],bottom:[{bottom:w()}],left:[{left:w()}],visibility:[`visible`,`invisible`,`collapse`],z:[{z:[mn,`auto`,R,L]}],basis:[{basis:[pn,`full`,`auto`,s,...C()]}],"flex-direction":[{flex:[`row`,`row-reverse`,`col`,`col-reverse`]}],"flex-wrap":[{flex:[`nowrap`,`wrap`,`wrap-reverse`]}],flex:[{flex:[I,pn,`auto`,`initial`,`none`,L]}],grow:[{grow:[``,I,R,L]}],shrink:[{shrink:[``,I,R,L]}],order:[{order:[mn,`first`,`last`,`none`,R,L]}],"grid-cols":[{"grid-cols":T()}],"col-start-end":[{col:te()}],"col-start":[{"col-start":E()}],"col-end":[{"col-end":E()}],"grid-rows":[{"grid-rows":T()}],"row-start-end":[{row:te()}],"row-start":[{"row-start":E()}],"row-end":[{"row-end":E()}],"grid-flow":[{"grid-flow":[`row`,`col`,`dense`,`row-dense`,`col-dense`]}],"auto-cols":[{"auto-cols":ne()}],"auto-rows":[{"auto-rows":ne()}],gap:[{gap:C()}],"gap-x":[{"gap-x":C()}],"gap-y":[{"gap-y":C()}],"justify-content":[{justify:[...re(),`normal`]}],"justify-items":[{"justify-items":[...D(),`normal`]}],"justify-self":[{"justify-self":[`auto`,...D()]}],"align-content":[{content:[`normal`,...re()]}],"align-items":[{items:[...D(),{baseline:[``,`last`]}]}],"align-self":[{self:[`auto`,...D(),{baseline:[``,`last`]}]}],"place-content":[{"place-content":re()}],"place-items":[{"place-items":[...D(),`baseline`]}],"place-self":[{"place-self":[`auto`,...D()]}],p:[{p:C()}],px:[{px:C()}],py:[{py:C()}],ps:[{ps:C()}],pe:[{pe:C()}],pbs:[{pbs:C()}],pbe:[{pbe:C()}],pt:[{pt:C()}],pr:[{pr:C()}],pb:[{pb:C()}],pl:[{pl:C()}],m:[{m:O()}],mx:[{mx:O()}],my:[{my:O()}],ms:[{ms:O()}],me:[{me:O()}],mbs:[{mbs:O()}],mbe:[{mbe:O()}],mt:[{mt:O()}],mr:[{mr:O()}],mb:[{mb:O()}],ml:[{ml:O()}],"space-x":[{"space-x":C()}],"space-x-reverse":[`space-x-reverse`],"space-y":[{"space-y":C()}],"space-y-reverse":[`space-y-reverse`],size:[{size:ie()}],"inline-size":[{inline:[`auto`,...ae()]}],"min-inline-size":[{"min-inline":[`auto`,...ae()]}],"max-inline-size":[{"max-inline":[`none`,...ae()]}],"block-size":[{block:[`auto`,...oe()]}],"min-block-size":[{"min-block":[`auto`,...oe()]}],"max-block-size":[{"max-block":[`none`,...oe()]}],w:[{w:[s,`screen`,...ie()]}],"min-w":[{"min-w":[s,`screen`,`none`,...ie()]}],"max-w":[{"max-w":[s,`screen`,`none`,`prose`,{screen:[o]},...ie()]}],h:[{h:[`screen`,`lh`,...ie()]}],"min-h":[{"min-h":[`screen`,`lh`,`none`,...ie()]}],"max-h":[{"max-h":[`screen`,`lh`,...ie()]}],"font-size":[{text:[`base`,n,Mn,Tn]}],"font-smoothing":[`antialiased`,`subpixel-antialiased`],"font-style":[`italic`,`not-italic`],"font-weight":[{font:[r,Rn,Dn]}],"font-stretch":[{"font-stretch":[`ultra-condensed`,`extra-condensed`,`condensed`,`semi-condensed`,`normal`,`semi-expanded`,`expanded`,`extra-expanded`,`ultra-expanded`,hn,L]}],"font-family":[{font:[Nn,On,t]}],"font-features":[{"font-features":[L]}],"fvn-normal":[`normal-nums`],"fvn-ordinal":[`ordinal`],"fvn-slashed-zero":[`slashed-zero`],"fvn-figure":[`lining-nums`,`oldstyle-nums`],"fvn-spacing":[`proportional-nums`,`tabular-nums`],"fvn-fraction":[`diagonal-fractions`,`stacked-fractions`],tracking:[{tracking:[i,R,L]}],"line-clamp":[{"line-clamp":[I,`none`,R,En]}],leading:[{leading:[a,...C()]}],"list-image":[{"list-image":[`none`,R,L]}],"list-style-position":[{list:[`inside`,`outside`]}],"list-style-type":[{list:[`disc`,`decimal`,`none`,R,L]}],"text-alignment":[{text:[`left`,`center`,`right`,`justify`,`start`,`end`]}],"placeholder-color":[{placeholder:k()}],"text-color":[{text:k()}],"text-decoration":[`underline`,`overline`,`line-through`,`no-underline`],"text-decoration-style":[{decoration:[...N(),`wavy`]}],"text-decoration-thickness":[{decoration:[I,`from-font`,`auto`,R,Tn]}],"text-decoration-color":[{decoration:k()}],"underline-offset":[{"underline-offset":[I,`auto`,R,L]}],"text-transform":[`uppercase`,`lowercase`,`capitalize`,`normal-case`],"text-overflow":[`truncate`,`text-ellipsis`,`text-clip`],"text-wrap":[{text:[`wrap`,`nowrap`,`balance`,`pretty`]}],indent:[{indent:C()}],"tab-size":[{tab:[mn,R,L]}],"vertical-align":[{align:[`baseline`,`top`,`middle`,`bottom`,`text-top`,`text-bottom`,`sub`,`super`,R,L]}],whitespace:[{whitespace:[`normal`,`nowrap`,`pre`,`pre-line`,`pre-wrap`,`break-spaces`]}],break:[{break:[`normal`,`words`,`all`,`keep`]}],wrap:[{wrap:[`break-word`,`anywhere`,`normal`]}],hyphens:[{hyphens:[`none`,`manual`,`auto`]}],content:[{content:[`none`,R,L]}],"bg-attachment":[{bg:[`fixed`,`local`,`scroll`]}],"bg-clip":[{"bg-clip":[`border`,`padding`,`content`,`text`]}],"bg-origin":[{"bg-origin":[`border`,`padding`,`content`]}],"bg-position":[{bg:A()}],"bg-repeat":[{bg:se()}],"bg-size":[{bg:ce()}],"bg-image":[{bg:[`none`,{linear:[{to:[`t`,`tr`,`r`,`br`,`b`,`bl`,`l`,`tl`]},mn,R,L],radial:[``,R,L],conic:[mn,R,L]},In,An]}],"bg-color":[{bg:k()}],"gradient-from-pos":[{from:le()}],"gradient-via-pos":[{via:le()}],"gradient-to-pos":[{to:le()}],"gradient-from":[{from:k()}],"gradient-via":[{via:k()}],"gradient-to":[{to:k()}],rounded:[{rounded:j()}],"rounded-s":[{"rounded-s":j()}],"rounded-e":[{"rounded-e":j()}],"rounded-t":[{"rounded-t":j()}],"rounded-r":[{"rounded-r":j()}],"rounded-b":[{"rounded-b":j()}],"rounded-l":[{"rounded-l":j()}],"rounded-ss":[{"rounded-ss":j()}],"rounded-se":[{"rounded-se":j()}],"rounded-ee":[{"rounded-ee":j()}],"rounded-es":[{"rounded-es":j()}],"rounded-tl":[{"rounded-tl":j()}],"rounded-tr":[{"rounded-tr":j()}],"rounded-br":[{"rounded-br":j()}],"rounded-bl":[{"rounded-bl":j()}],"border-w":[{border:M()}],"border-w-x":[{"border-x":M()}],"border-w-y":[{"border-y":M()}],"border-w-s":[{"border-s":M()}],"border-w-e":[{"border-e":M()}],"border-w-bs":[{"border-bs":M()}],"border-w-be":[{"border-be":M()}],"border-w-t":[{"border-t":M()}],"border-w-r":[{"border-r":M()}],"border-w-b":[{"border-b":M()}],"border-w-l":[{"border-l":M()}],"divide-x":[{"divide-x":M()}],"divide-x-reverse":[`divide-x-reverse`],"divide-y":[{"divide-y":M()}],"divide-y-reverse":[`divide-y-reverse`],"border-style":[{border:[...N(),`hidden`,`none`]}],"divide-style":[{divide:[...N(),`hidden`,`none`]}],"border-color":[{border:k()}],"border-color-x":[{"border-x":k()}],"border-color-y":[{"border-y":k()}],"border-color-s":[{"border-s":k()}],"border-color-e":[{"border-e":k()}],"border-color-bs":[{"border-bs":k()}],"border-color-be":[{"border-be":k()}],"border-color-t":[{"border-t":k()}],"border-color-r":[{"border-r":k()}],"border-color-b":[{"border-b":k()}],"border-color-l":[{"border-l":k()}],"divide-color":[{divide:k()}],"outline-style":[{outline:[...N(),`none`,`hidden`]}],"outline-offset":[{"outline-offset":[I,R,L]}],"outline-w":[{outline:[``,I,Mn,Tn]}],"outline-color":[{outline:k()}],shadow:[{shadow:[``,`none`,u,Ln,jn]}],"shadow-color":[{shadow:k()}],"inset-shadow":[{"inset-shadow":[`none`,d,Ln,jn]}],"inset-shadow-color":[{"inset-shadow":k()}],"ring-w":[{ring:M()}],"ring-w-inset":[`ring-inset`],"ring-color":[{ring:k()}],"ring-offset-w":[{"ring-offset":[I,Tn]}],"ring-offset-color":[{"ring-offset":k()}],"inset-ring-w":[{"inset-ring":M()}],"inset-ring-color":[{"inset-ring":k()}],"text-shadow":[{"text-shadow":[`none`,f,Ln,jn]}],"text-shadow-color":[{"text-shadow":k()}],opacity:[{opacity:[I,R,L]}],"mix-blend":[{"mix-blend":[...P(),`plus-darker`,`plus-lighter`]}],"bg-blend":[{"bg-blend":P()}],"mask-clip":[{"mask-clip":[`border`,`padding`,`content`,`fill`,`stroke`,`view`]},`mask-no-clip`],"mask-composite":[{mask:[`add`,`subtract`,`intersect`,`exclude`]}],"mask-image-linear-pos":[{"mask-linear":[I]}],"mask-image-linear-from-pos":[{"mask-linear-from":F()}],"mask-image-linear-to-pos":[{"mask-linear-to":F()}],"mask-image-linear-from-color":[{"mask-linear-from":k()}],"mask-image-linear-to-color":[{"mask-linear-to":k()}],"mask-image-t-from-pos":[{"mask-t-from":F()}],"mask-image-t-to-pos":[{"mask-t-to":F()}],"mask-image-t-from-color":[{"mask-t-from":k()}],"mask-image-t-to-color":[{"mask-t-to":k()}],"mask-image-r-from-pos":[{"mask-r-from":F()}],"mask-image-r-to-pos":[{"mask-r-to":F()}],"mask-image-r-from-color":[{"mask-r-from":k()}],"mask-image-r-to-color":[{"mask-r-to":k()}],"mask-image-b-from-pos":[{"mask-b-from":F()}],"mask-image-b-to-pos":[{"mask-b-to":F()}],"mask-image-b-from-color":[{"mask-b-from":k()}],"mask-image-b-to-color":[{"mask-b-to":k()}],"mask-image-l-from-pos":[{"mask-l-from":F()}],"mask-image-l-to-pos":[{"mask-l-to":F()}],"mask-image-l-from-color":[{"mask-l-from":k()}],"mask-image-l-to-color":[{"mask-l-to":k()}],"mask-image-x-from-pos":[{"mask-x-from":F()}],"mask-image-x-to-pos":[{"mask-x-to":F()}],"mask-image-x-from-color":[{"mask-x-from":k()}],"mask-image-x-to-color":[{"mask-x-to":k()}],"mask-image-y-from-pos":[{"mask-y-from":F()}],"mask-image-y-to-pos":[{"mask-y-to":F()}],"mask-image-y-from-color":[{"mask-y-from":k()}],"mask-image-y-to-color":[{"mask-y-to":k()}],"mask-image-radial":[{"mask-radial":[R,L]}],"mask-image-radial-from-pos":[{"mask-radial-from":F()}],"mask-image-radial-to-pos":[{"mask-radial-to":F()}],"mask-image-radial-from-color":[{"mask-radial-from":k()}],"mask-image-radial-to-color":[{"mask-radial-to":k()}],"mask-image-radial-shape":[{"mask-radial":[`circle`,`ellipse`]}],"mask-image-radial-size":[{"mask-radial":[{closest:[`side`,`corner`],farthest:[`side`,`corner`]}]}],"mask-image-radial-pos":[{"mask-radial-at":b()}],"mask-image-conic-pos":[{"mask-conic":[I]}],"mask-image-conic-from-pos":[{"mask-conic-from":F()}],"mask-image-conic-to-pos":[{"mask-conic-to":F()}],"mask-image-conic-from-color":[{"mask-conic-from":k()}],"mask-image-conic-to-color":[{"mask-conic-to":k()}],"mask-mode":[{mask:[`alpha`,`luminance`,`match`]}],"mask-origin":[{"mask-origin":[`border`,`padding`,`content`,`fill`,`stroke`,`view`]}],"mask-position":[{mask:A()}],"mask-repeat":[{mask:se()}],"mask-size":[{mask:ce()}],"mask-type":[{"mask-type":[`alpha`,`luminance`]}],"mask-image":[{mask:[`none`,R,L]}],filter:[{filter:[``,`none`,R,L]}],blur:[{blur:ue()}],brightness:[{brightness:[I,R,L]}],contrast:[{contrast:[I,R,L]}],"drop-shadow":[{"drop-shadow":[``,`none`,p,Ln,jn]}],"drop-shadow-color":[{"drop-shadow":k()}],grayscale:[{grayscale:[``,I,R,L]}],"hue-rotate":[{"hue-rotate":[I,R,L]}],invert:[{invert:[``,I,R,L]}],saturate:[{saturate:[I,R,L]}],sepia:[{sepia:[``,I,R,L]}],"backdrop-filter":[{"backdrop-filter":[``,`none`,R,L]}],"backdrop-blur":[{"backdrop-blur":ue()}],"backdrop-brightness":[{"backdrop-brightness":[I,R,L]}],"backdrop-contrast":[{"backdrop-contrast":[I,R,L]}],"backdrop-grayscale":[{"backdrop-grayscale":[``,I,R,L]}],"backdrop-hue-rotate":[{"backdrop-hue-rotate":[I,R,L]}],"backdrop-invert":[{"backdrop-invert":[``,I,R,L]}],"backdrop-opacity":[{"backdrop-opacity":[I,R,L]}],"backdrop-saturate":[{"backdrop-saturate":[I,R,L]}],"backdrop-sepia":[{"backdrop-sepia":[``,I,R,L]}],"border-collapse":[{border:[`collapse`,`separate`]}],"border-spacing":[{"border-spacing":C()}],"border-spacing-x":[{"border-spacing-x":C()}],"border-spacing-y":[{"border-spacing-y":C()}],"table-layout":[{table:[`auto`,`fixed`]}],caption:[{caption:[`top`,`bottom`]}],transition:[{transition:[``,`all`,`colors`,`opacity`,`shadow`,`transform`,`none`,R,L]}],"transition-behavior":[{transition:[`normal`,`discrete`]}],duration:[{duration:[I,`initial`,R,L]}],ease:[{ease:[`linear`,`initial`,_,R,L]}],delay:[{delay:[I,R,L]}],animate:[{animate:[`none`,v,R,L]}],backface:[{backface:[`hidden`,`visible`]}],perspective:[{perspective:[h,R,L]}],"perspective-origin":[{"perspective-origin":x()}],rotate:[{rotate:de()}],"rotate-x":[{"rotate-x":de()}],"rotate-y":[{"rotate-y":de()}],"rotate-z":[{"rotate-z":de()}],scale:[{scale:fe()}],"scale-x":[{"scale-x":fe()}],"scale-y":[{"scale-y":fe()}],"scale-z":[{"scale-z":fe()}],"scale-3d":[`scale-3d`],skew:[{skew:pe()}],"skew-x":[{"skew-x":pe()}],"skew-y":[{"skew-y":pe()}],transform:[{transform:[R,L,``,`none`,`gpu`,`cpu`]}],"transform-origin":[{origin:x()}],"transform-style":[{transform:[`3d`,`flat`]}],translate:[{translate:me()}],"translate-x":[{"translate-x":me()}],"translate-y":[{"translate-y":me()}],"translate-z":[{"translate-z":me()}],"translate-none":[`translate-none`],zoom:[{zoom:[mn,R,L]}],accent:[{accent:k()}],appearance:[{appearance:[`none`,`auto`]}],"caret-color":[{caret:k()}],"color-scheme":[{scheme:[`normal`,`dark`,`light`,`light-dark`,`only-dark`,`only-light`]}],cursor:[{cursor:[`auto`,`default`,`pointer`,`wait`,`text`,`move`,`help`,`not-allowed`,`none`,`context-menu`,`progress`,`cell`,`crosshair`,`vertical-text`,`alias`,`copy`,`no-drop`,`grab`,`grabbing`,`all-scroll`,`col-resize`,`row-resize`,`n-resize`,`e-resize`,`s-resize`,`w-resize`,`ne-resize`,`nw-resize`,`se-resize`,`sw-resize`,`ew-resize`,`ns-resize`,`nesw-resize`,`nwse-resize`,`zoom-in`,`zoom-out`,R,L]}],"field-sizing":[{"field-sizing":[`fixed`,`content`]}],"pointer-events":[{"pointer-events":[`auto`,`none`]}],resize:[{resize:[`none`,``,`y`,`x`]}],"scroll-behavior":[{scroll:[`auto`,`smooth`]}],"scrollbar-thumb-color":[{"scrollbar-thumb":k()}],"scrollbar-track-color":[{"scrollbar-track":k()}],"scrollbar-gutter":[{"scrollbar-gutter":[`auto`,`stable`,`both`]}],"scrollbar-w":[{scrollbar:[`auto`,`thin`,`none`]}],"scroll-m":[{"scroll-m":C()}],"scroll-mx":[{"scroll-mx":C()}],"scroll-my":[{"scroll-my":C()}],"scroll-ms":[{"scroll-ms":C()}],"scroll-me":[{"scroll-me":C()}],"scroll-mbs":[{"scroll-mbs":C()}],"scroll-mbe":[{"scroll-mbe":C()}],"scroll-mt":[{"scroll-mt":C()}],"scroll-mr":[{"scroll-mr":C()}],"scroll-mb":[{"scroll-mb":C()}],"scroll-ml":[{"scroll-ml":C()}],"scroll-p":[{"scroll-p":C()}],"scroll-px":[{"scroll-px":C()}],"scroll-py":[{"scroll-py":C()}],"scroll-ps":[{"scroll-ps":C()}],"scroll-pe":[{"scroll-pe":C()}],"scroll-pbs":[{"scroll-pbs":C()}],"scroll-pbe":[{"scroll-pbe":C()}],"scroll-pt":[{"scroll-pt":C()}],"scroll-pr":[{"scroll-pr":C()}],"scroll-pb":[{"scroll-pb":C()}],"scroll-pl":[{"scroll-pl":C()}],"snap-align":[{snap:[`start`,`end`,`center`,`align-none`]}],"snap-stop":[{snap:[`normal`,`always`]}],"snap-type":[{snap:[`none`,`x`,`y`,`both`]}],"snap-strictness":[{snap:[`mandatory`,`proximity`]}],touch:[{touch:[`auto`,`none`,`manipulation`]}],"touch-x":[{"touch-pan":[`x`,`left`,`right`]}],"touch-y":[{"touch-pan":[`y`,`up`,`down`]}],"touch-pz":[`touch-pinch-zoom`],select:[{select:[`none`,`text`,`all`,`auto`]}],"will-change":[{"will-change":[`auto`,`scroll`,`contents`,`transform`,R,L]}],fill:[{fill:[`none`,...k()]}],"stroke-w":[{stroke:[I,Mn,Tn,En]}],stroke:[{stroke:[`none`,...k()]}],"forced-color-adjust":[{"forced-color-adjust":[`auto`,`none`]}]},conflictingClassGroups:{"container-named":[`container-type`],overflow:[`overflow-x`,`overflow-y`],overscroll:[`overscroll-x`,`overscroll-y`],inset:[`inset-x`,`inset-y`,`inset-bs`,`inset-be`,`start`,`end`,`top`,`right`,`bottom`,`left`],"inset-x":[`right`,`left`],"inset-y":[`top`,`bottom`],flex:[`basis`,`grow`,`shrink`],gap:[`gap-x`,`gap-y`],p:[`px`,`py`,`ps`,`pe`,`pbs`,`pbe`,`pt`,`pr`,`pb`,`pl`],px:[`pr`,`pl`],py:[`pt`,`pb`],m:[`mx`,`my`,`ms`,`me`,`mbs`,`mbe`,`mt`,`mr`,`mb`,`ml`],mx:[`mr`,`ml`],my:[`mt`,`mb`],size:[`w`,`h`],"font-size":[`leading`],"fvn-normal":[`fvn-ordinal`,`fvn-slashed-zero`,`fvn-figure`,`fvn-spacing`,`fvn-fraction`],"fvn-ordinal":[`fvn-normal`],"fvn-slashed-zero":[`fvn-normal`],"fvn-figure":[`fvn-normal`],"fvn-spacing":[`fvn-normal`],"fvn-fraction":[`fvn-normal`],"line-clamp":[`display`,`overflow`],rounded:[`rounded-s`,`rounded-e`,`rounded-t`,`rounded-r`,`rounded-b`,`rounded-l`,`rounded-ss`,`rounded-se`,`rounded-ee`,`rounded-es`,`rounded-tl`,`rounded-tr`,`rounded-br`,`rounded-bl`],"rounded-s":[`rounded-ss`,`rounded-es`],"rounded-e":[`rounded-se`,`rounded-ee`],"rounded-t":[`rounded-tl`,`rounded-tr`],"rounded-r":[`rounded-tr`,`rounded-br`],"rounded-b":[`rounded-br`,`rounded-bl`],"rounded-l":[`rounded-tl`,`rounded-bl`],"border-spacing":[`border-spacing-x`,`border-spacing-y`],"border-w":[`border-w-x`,`border-w-y`,`border-w-s`,`border-w-e`,`border-w-bs`,`border-w-be`,`border-w-t`,`border-w-r`,`border-w-b`,`border-w-l`],"border-w-x":[`border-w-r`,`border-w-l`],"border-w-y":[`border-w-t`,`border-w-b`],"border-color":[`border-color-x`,`border-color-y`,`border-color-s`,`border-color-e`,`border-color-bs`,`border-color-be`,`border-color-t`,`border-color-r`,`border-color-b`,`border-color-l`],"border-color-x":[`border-color-r`,`border-color-l`],"border-color-y":[`border-color-t`,`border-color-b`],translate:[`translate-x`,`translate-y`,`translate-none`],"translate-none":[`translate`,`translate-x`,`translate-y`,`translate-z`],"scroll-m":[`scroll-mx`,`scroll-my`,`scroll-ms`,`scroll-me`,`scroll-mbs`,`scroll-mbe`,`scroll-mt`,`scroll-mr`,`scroll-mb`,`scroll-ml`],"scroll-mx":[`scroll-mr`,`scroll-ml`],"scroll-my":[`scroll-mt`,`scroll-mb`],"scroll-p":[`scroll-px`,`scroll-py`,`scroll-ps`,`scroll-pe`,`scroll-pbs`,`scroll-pbe`,`scroll-pt`,`scroll-pr`,`scroll-pb`,`scroll-pl`],"scroll-px":[`scroll-pr`,`scroll-pl`],"scroll-py":[`scroll-pt`,`scroll-pb`],touch:[`touch-x`,`touch-y`,`touch-pz`],"touch-x":[`touch`],"touch-y":[`touch`],"touch-pz":[`touch`]},conflictingClassGroupModifiers:{"font-size":[`leading`]},postfixLookupClassGroups:[`container-type`],orderSensitiveModifiers:[`*`,`**`,`after`,`backdrop`,`before`,`details-content`,`file`,`first-letter`,`first-line`,`marker`,`placeholder`,`selection`]}});function Xn(...e){return Yn(Ct(e))}var Zn=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),z=o(((e,t)=>{t.exports=Zn()}))();function Qn({getTarget:e,className:t,label:n,onStatus:r}){let i=(0,_.useRef)(null),a=(0,_.useRef)(null),o=(0,_.useRef)(e),[s,c]=(0,_.useState)(`loading`);return o.current=e,(0,_.useEffect)(()=>{r?.(s)},[r,s]),(0,_.useEffect)(()=>{let e=a.current;if(e&&s!==`gpu`)return bt({canvas:e,getTarget:()=>o.current()})},[s]),(0,_.useEffect)(()=>{let e=i.current;if(!e||typeof navigator>`u`||!navigator.gpu){c(`fallback`);return}let t=!1,n=xt({canvas:e,getTarget:()=>o.current(),onError:()=>{t||c(`fallback`)},onReady:()=>{t||c(`gpu`)}}),r=window.setTimeout(()=>c(e=>e===`loading`?`fallback`:e),2200);return()=>{t=!0,window.clearTimeout(r),n()}},[]),(0,z.jsxs)(`div`,{className:Xn(`orc-canvas-stack`,t),"data-renderer":s,role:`img`,"aria-label":n??`Animated liquid glass orb`,children:[(0,z.jsx)(`canvas`,{ref:a,className:`orc-canvas orc-canvas-fallback`,"aria-hidden":`true`}),(0,z.jsx)(`canvas`,{ref:i,className:`orc-canvas orc-canvas-gpu`,"data-ready":s===`gpu`?`true`:`false`,"aria-hidden":`true`})]})}function $n(){let e=new URLSearchParams(window.location.search);if(window.location.hash)return{editor:ct(),preview:it(),text:at()};let t=e.get(`style`)??e.get(`preset`),n=t&&ee.includes(t)?t:C.style,r=e.get(`state`),i=r===`idle`||r===`thinking`?r:_e;return{editor:{configuration:Ee(n),activeState:i},preview:e.get(`preview`)===`orb`?`orb`:`scene`,text:(e.get(`text`)??`Thinking...`).slice(0,280)}}function er(){let[e]=(0,_.useState)($n),[t,n]=(0,_.useState)(e.editor),[r,i]=(0,_.useState)(e.preview),[a,o]=(0,_.useState)(e.text),s=(0,_.useMemo)(()=>We(window.location.search,document.referrer),[]);(0,_.useEffect)(()=>(document.documentElement.classList.add(`is-orc-embed`),()=>document.documentElement.classList.remove(`is-orc-embed`)),[]),(0,_.useEffect)(()=>{let e=()=>{let e=$n();n(e.editor),i(e.preview),o(e.text)};return window.addEventListener(`hashchange`,e),()=>window.removeEventListener(`hashchange`,e)},[]),(0,_.useEffect)(()=>{let t=e=>{if(window.parent===window||e.source!==window.parent||!s||e.origin!==s||!Ue(e.data))return;let t=e.data;t.type===`setState`?n(e=>({...e,activeState:t.state})):t.type===`setText`?o(t.text):window.parent.postMessage({source:He,type:`pong`},s)};return window.addEventListener(`message`,t),s&&window.parent!==window&&window.parent.postMessage({source:He,type:`ready`,state:e.editor.activeState},s),()=>window.removeEventListener(`message`,t)},[e.editor.activeState,s]),(0,_.useEffect)(()=>{s&&window.parent!==window&&window.parent.postMessage({source:He,type:`state`,state:t.activeState},s)},[t.activeState,s]);let c=(0,_.useMemo)(()=>De(t.configuration,t.activeState),[t]),l=(0,_.useRef)({state:t.activeState,params:c,activationDuration:t.configuration.activationDuration,transitionDuration:t.configuration.transitionDuration});return l.current={state:t.activeState,params:c,activationDuration:t.configuration.activationDuration,transitionDuration:t.configuration.transitionDuration},(0,z.jsx)(`main`,{className:`orc-embed`,"data-state":t.activeState,"data-preview":r,children:r===`scene`?(0,z.jsxs)(`div`,{className:`orc-scene-pill`,children:[(0,z.jsx)(`div`,{className:`orc-scene-pill-orb`,children:(0,z.jsx)(Qn,{getTarget:()=>l.current})}),(0,z.jsx)(`span`,{className:`orc-scene-pill-text`,children:a||`\xA0`})]}):(0,z.jsx)(`div`,{className:`orc-embed-orb`,children:(0,z.jsx)(Qn,{getTarget:()=>l.current})})})}var tr=e=>e.replace(/([a-z0-9])([A-Z])/g,`$1-$2`).toLowerCase(),nr=e=>e.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,t,n)=>n?n.toUpperCase():t.toLowerCase()),rr=e=>{let t=nr(e);return t.charAt(0).toUpperCase()+t.slice(1)},ir=(...e)=>e.filter((e,t,n)=>!!e&&e.trim()!==``&&n.indexOf(e)===t).join(` `).trim(),ar=e=>{for(let t in e)if(t.startsWith(`aria-`)||t===`role`||t===`title`)return!0},or={xmlns:`http://www.w3.org/2000/svg`,width:24,height:24,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:2,strokeLinecap:`round`,strokeLinejoin:`round`},sr=(0,_.forwardRef)(({color:e=`currentColor`,size:t=24,strokeWidth:n=2,absoluteStrokeWidth:r,className:i=``,children:a,iconNode:o,...s},c)=>(0,_.createElement)(`svg`,{ref:c,...or,width:t,height:t,stroke:e,strokeWidth:r?Number(n)*24/Number(t):n,className:ir(`lucide`,i),...!a&&!ar(s)&&{"aria-hidden":`true`},...s},[...o.map(([e,t])=>(0,_.createElement)(e,t)),...Array.isArray(a)?a:[a]])),cr=(e,t)=>{let n=(0,_.forwardRef)(({className:n,...r},i)=>(0,_.createElement)(sr,{ref:i,iconNode:t,className:ir(`lucide-${tr(rr(e))}`,`lucide-${e}`,n),...r}));return n.displayName=rr(e),n},lr=cr(`arrow-up-right`,[[`path`,{d:`M7 7h10v10`,key:`1tivn9`}],[`path`,{d:`M7 17 17 7`,key:`1vkiza`}]]),ur=cr(`check`,[[`path`,{d:`M20 6 9 17l-5-5`,key:`1gmf2c`}]]),dr=cr(`chevron-down`,[[`path`,{d:`m6 9 6 6 6-6`,key:`qrunsl`}]]),fr=cr(`code-xml`,[[`path`,{d:`m18 16 4-4-4-4`,key:`1inbqp`}],[`path`,{d:`m6 8-4 4 4 4`,key:`15zrgr`}],[`path`,{d:`m14.5 4-5 16`,key:`e7oirm`}]]),pr=cr(`copy`,[[`rect`,{width:`14`,height:`14`,x:`8`,y:`8`,rx:`2`,ry:`2`,key:`17jyea`}],[`path`,{d:`M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2`,key:`zix9uf`}]]),mr=cr(`link-2`,[[`path`,{d:`M9 17H7A5 5 0 0 1 7 7h2`,key:`8i5ue5`}],[`path`,{d:`M15 7h2a5 5 0 1 1 0 10h-2`,key:`1b9ql8`}],[`line`,{x1:`8`,x2:`16`,y1:`12`,y2:`12`,key:`1jonct`}]]),hr=cr(`play`,[[`polygon`,{points:`6 3 20 12 6 21 6 3`,key:`1oa8hb`}]]),gr=cr(`rotate-ccw`,[[`path`,{d:`M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8`,key:`1357e3`}],[`path`,{d:`M3 3v5h5`,key:`1xhq8a`}]]),_r=cr(`square`,[[`rect`,{width:`18`,height:`18`,x:`3`,y:`3`,rx:`2`,key:`afitv7`}]]),vr=cr(`x`,[[`path`,{d:`M18 6 6 18`,key:`1bl5f8`}],[`path`,{d:`m6 6 12 12`,key:`d8bk6v`}]]);function yr({tone:e=`dark`,sheen:t=!0,radius:n=`2rem`,padding:r=`1.5rem`,className:i,style:a,children:o,...s}){let c=[`glass-panel`,e===`light`?`tone-light`:``,i??``].filter(Boolean).join(` `);return(0,z.jsxs)(`article`,{className:c,style:{borderRadius:n,padding:r,...a},...s,children:[(0,z.jsx)(`div`,{className:`glass-read`,"aria-hidden":`true`}),t?(0,z.jsx)(`div`,{className:`glass-sheen`,"aria-hidden":`true`}):null,(0,z.jsx)(`div`,{className:`type-legible`,style:{position:`relative`,zIndex:10},children:o})]})}var br=Object.defineProperty,xr=(e,t)=>br(e,`name`,{value:t,configurable:!0});function Sr(e,[t,n]){return Math.min(n,Math.max(t,e))}xr(Sr,`clamp`);var Cr=Object.defineProperty,wr=(e,t)=>Cr(e,`name`,{value:t,configurable:!0}),Tr=!!(typeof window<`u`&&window.document&&window.document.createElement);function Er(e,t,{checkForDefaultPrevented:n=!0}={}){return wr(function(r){if(e?.(r),n===!1||!r||!r.defaultPrevented)return t?.(r)},`handleEvent`)}wr(Er,`composeEventHandlers`);function Dr(e){if(!Tr)throw Error(`Cannot access window outside of the DOM`);return e?.ownerDocument?.defaultView??window}wr(Dr,`getOwnerWindow`);function Or(e){if(!Tr)throw Error(`Cannot access document outside of the DOM`);return e?.ownerDocument??document}wr(Or,`getOwnerDocument`);function kr(e,t=!1){let{activeElement:n}=Or(e);if(!n?.nodeName)return null;if(Ar(n)&&n.contentDocument)return kr(n.contentDocument.body,t);if(t){let e=n.getAttribute(`aria-activedescendant`);if(e){let t=Or(n).getElementById(e);if(t)return t}}return n}wr(kr,`getActiveElement`);function Ar(e){return e.tagName===`IFRAME`}wr(Ar,`isFrame`);var jr=Object.defineProperty,Mr=(e,t)=>jr(e,`name`,{value:t,configurable:!0});function Nr(e,t){if(typeof e==`function`)return e(t);e!=null&&(e.current=t)}Mr(Nr,`setRef`);function Pr(...e){return t=>{let n=!1,r=e.map(e=>{let r=Nr(e,t);return!n&&typeof r==`function`&&(n=!0),r});if(n)return()=>{for(let t=0;t<r.length;t++){let n=r[t];typeof n==`function`?n():Nr(e[t],null)}}}}Mr(Pr,`composeRefs`);function Fr(...e){return _.useCallback(Pr(...e),e)}Mr(Fr,`useComposedRefs`);var Ir=Object.defineProperty,Lr=(e,t)=>Ir(e,`name`,{value:t,configurable:!0});function Rr(e,t){let n=_.createContext(t);n.displayName=e+`Context`;let r=Lr(e=>{let{children:t,...r}=e,i=_.useMemo(()=>r,Object.values(r));return(0,z.jsx)(n.Provider,{value:i,children:t})},`Provider`);r.displayName=e+`Provider`;function i(r,i={}){let{optional:a=!1}=i,o=_.useContext(n);if(o)return o;if(t!==void 0)return t;if(!a)throw Error(`\`${r}\` must be used within \`${e}\``)}return Lr(i,`useContext`),[r,i]}Lr(Rr,`createContext`);function zr(e,t=[]){let n=[];function r(t,r){let i=_.createContext(r);i.displayName=t+`Context`;let a=n.length;n=[...n,r];let o=Lr(t=>{let{scope:n,children:r,...o}=t,s=n?.[e]?.[a]||i,c=_.useMemo(()=>o,Object.values(o));return(0,z.jsx)(s.Provider,{value:c,children:r})},`Provider`);o.displayName=t+`Provider`;function s(n,o,s={}){let{optional:c=!1}=s,l=o?.[e]?.[a]||i,u=_.useContext(l);if(u)return u;if(r!==void 0)return r;if(!c)throw Error(`\`${n}\` must be used within \`${t}\``)}return Lr(s,`useContext`),[o,s]}Lr(r,`createContext`);let i=Lr(()=>{let t=n.map(e=>_.createContext(e));return Lr(function(n){let r=n?.[e]||t;return _.useMemo(()=>({[`__scope${e}`]:{...n,[e]:r}}),[n,r])},`useScope`)},`createScope`);return i.scopeName=e,[r,Br(i,...t)]}Lr(zr,`createContextScope`);function Br(...e){let t=e[0];if(e.length===1)return t;let n=Lr(()=>{let n=e.map(e=>({useScope:e(),scopeName:e.scopeName}));return Lr(function(e){let r=n.reduce((t,{useScope:n,scopeName:r})=>{let i=n(e)[`__scope${r}`];return{...t,...i}},{});return _.useMemo(()=>({[`__scope${t.scopeName}`]:r}),[r])},`useComposedScopes`)},`createScope`);return n.scopeName=t.scopeName,n}Lr(Br,`composeContextScopes`);var Vr=globalThis?.document?_.useLayoutEffect:()=>{},Hr=Object.defineProperty,Ur=(e,t)=>Hr(e,`name`,{value:t,configurable:!0}),Wr=_.useEffectEvent,Gr=_.useInsertionEffect;function Kr(e){if(typeof Wr==`function`)return Wr(e);let t=_.useRef(()=>{throw Error(`Cannot call an event handler while rendering.`)});return typeof Gr==`function`?Gr(()=>{t.current=e}):Vr(()=>{t.current=e}),_.useMemo(()=>((...e)=>t.current?.(...e)),[])}Ur(Kr,`useEffectEvent`);var qr=Object.defineProperty,Jr=(e,t)=>qr(e,`name`,{value:t,configurable:!0}),Yr=_.useInsertionEffect||Vr;function Xr({prop:e,defaultProp:t,onChange:n=Jr(()=>{},`onChange`),caller:r}){let[i,a,o]=Zr({defaultProp:t,onChange:n}),s=e!==void 0;return[s?e:i,_.useCallback(t=>{if(s){let n=Qr(t)?t(e):t;n!==e&&o.current?.(n)}else a(t)},[s,e,a,o])]}Jr(Xr,`useControllableState`);function Zr({defaultProp:e,onChange:t}){let[n,r]=_.useState(e),i=_.useRef(n),a=_.useRef(t);return Yr(()=>{a.current=t},[t]),_.useEffect(()=>{i.current!==n&&(a.current?.(n),i.current=n)},[n,i]),[n,r,a]}Jr(Zr,`useUncontrolledState`);function Qr(e){return typeof e==`function`}Jr(Qr,`isFunction`);var $r=Symbol(`RADIX:SYNC_STATE`);function ei(e,t,n,r){let{prop:i,defaultProp:a,onChange:o,caller:s}=t,c=i!==void 0,l=Kr(o),u=[{...n,state:a}];r&&u.push(r);let[d,f]=_.useReducer((t,n)=>{if(n.type===$r)return{...t,state:n.state};let r=e(t,n);return c&&!Object.is(r.state,t.state)&&l(r.state),r},...u),p=d.state,m=_.useRef(p);_.useEffect(()=>{m.current!==p&&(m.current=p,c||l(p))},[p,m,c]);let h=_.useMemo(()=>i===void 0?d:{...d,state:i},[d,i]);return _.useEffect(()=>{c&&!Object.is(i,d.state)&&f({type:$r,state:i})},[i,d.state,c]),[h,f]}Jr(ei,`useControllableStateReducer`);var ti=Object.defineProperty,ni=(e,t)=>ti(e,`name`,{value:t,configurable:!0}),ri=_.createContext(void 0);function ii(e){let t=_.useContext(ri);return e||t||`ltr`}ni(ii,`useDirection`);var ai=Object.defineProperty,oi=(e,t)=>ai(e,`name`,{value:t,configurable:!0});function si(e){let t=_.useRef({value:e,previous:e});return _.useMemo(()=>(t.current.value!==e&&(t.current.previous=t.current.value,t.current.value=e),t.current.previous),[e])}oi(si,`usePrevious`);var ci=Object.defineProperty,li=(e,t)=>ci(e,`name`,{value:t,configurable:!0});function ui(e){let[t,n]=_.useState(void 0);return Vr(()=>{if(e){n({width:e.offsetWidth,height:e.offsetHeight});let t=new ResizeObserver(t=>{if(!Array.isArray(t)||!t.length)return;let r=t[0],i,a;if(`borderBoxSize`in r){let e=r.borderBoxSize,t=Array.isArray(e)?e[0]:e;i=t.inlineSize,a=t.blockSize}else i=e.offsetWidth,a=e.offsetHeight;n({width:i,height:a})});return t.observe(e,{box:`border-box`}),()=>t.unobserve(e)}n(void 0)},[e]),t}li(ui,`useSize`);var di=c(m(),1),fi=Object.defineProperty,pi=(e,t)=>fi(e,`name`,{value:t,configurable:!0});function mi(e){let t=_.forwardRef((t,n)=>{let{children:r,...i}=t,a=null,o=!1,s=[];Si(r)&&typeof Ei==`function`&&(r=Ei(r._payload)),_.Children.forEach(r,e=>{if(bi(e)){o=!0;let t=e,n=`child`in t.props?t.props.child:t.props.children;Si(n)&&typeof Ei==`function`&&(n=Ei(n._payload)),a=_i(t,n),s.push(a?.props?.children)}else s.push(e)}),a?a=_.cloneElement(a,void 0,s):!o&&_.Children.count(r)===1&&_.isValidElement(r)&&(a=r);let c=a?yi(a):void 0,l=Fr(n,c);if(!a){if(r||r===0)throw Error(o?Ti(e):wi(e));return r}let u=vi(i,a.props??{});return a.type!==_.Fragment&&(u.ref=n?l:c),_.cloneElement(a,u)});return t.displayName=`${e}.Slot`,t}pi(mi,`createSlot`);var hi=Symbol.for(`radix.slottable`);function gi(e){let t=pi(e=>`child`in e?e.children(e.child):e.children,`Slottable`);return t.displayName=`${e}.Slottable`,t.__radixId=hi,t}pi(gi,`createSlottable`);var _i=pi((e,t)=>{if(`child`in e.props){let t=e.props.child;return _.isValidElement(t)?_.cloneElement(t,void 0,e.props.children(t.props.children)):null}return _.isValidElement(t)?t:null},`getSlottableElementFromSlottable`);function vi(e,t){let n={...t};for(let r in t){let i=e[r],a=t[r];/^on[A-Z]/.test(r)?i&&a?n[r]=(...e)=>{let t=a(...e);return i(...e),t}:i&&(n[r]=i):r===`style`?n[r]={...i,...a}:r===`className`&&(n[r]=[i,a].filter(Boolean).join(` `))}return{...e,...n}}pi(vi,`mergeProps`);function yi(e){let t=Object.getOwnPropertyDescriptor(e.props,`ref`)?.get,n=t&&`isReactWarning`in t&&t.isReactWarning;return n?e.ref:(t=Object.getOwnPropertyDescriptor(e,`ref`)?.get,n=t&&`isReactWarning`in t&&t.isReactWarning,n?e.props.ref:e.props.ref||e.ref)}pi(yi,`getElementRef`);function bi(e){return _.isValidElement(e)&&typeof e.type==`function`&&`__radixId`in e.type&&e.type.__radixId===hi}pi(bi,`isSlottable`);var xi=Symbol.for(`react.lazy`);function Si(e){return typeof e==`object`&&!!e&&`$$typeof`in e&&e.$$typeof===xi&&`_payload`in e&&Ci(e._payload)}pi(Si,`isLazyComponent`);function Ci(e){return typeof e==`object`&&!!e&&`then`in e}pi(Ci,`isPromiseLike`);var wi=pi(e=>`${e} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`,`createSlotError`),Ti=pi(e=>`${e} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`,`createSlottableError`),Ei=_.use,Di=Object.defineProperty,Oi=(e,t)=>Di(e,`name`,{value:t,configurable:!0}),ki=[`a`,`button`,`div`,`form`,`h2`,`h3`,`img`,`input`,`label`,`li`,`nav`,`ol`,`p`,`select`,`span`,`svg`,`ul`].reduce((e,t)=>{let n=mi(`Primitive.${t}`),r=_.forwardRef((e,r)=>{let{asChild:i,...a}=e,o=i?n:t;return typeof window<`u`&&(window[Symbol.for(`radix-ui`)]=!0),(0,z.jsx)(o,{...a,ref:r})});return r.displayName=`Primitive.${t}`,{...e,[t]:r}},{});function Ai(e,t){e&&di.flushSync(()=>e.dispatchEvent(t))}Oi(Ai,`dispatchDiscreteCustomEvent`);var ji=Object.defineProperty,B=(e,t)=>ji(e,`name`,{value:t,configurable:!0});function V(e){let t=e+`CollectionProvider`,[n,r]=zr(t),[i,a]=n(t,{collectionRef:{current:null},itemMap:new Map}),o=B(e=>{let{scope:t,children:n}=e,r=_.useRef(null),a=_.useRef(new Map).current;return(0,z.jsx)(i,{scope:t,itemMap:a,collectionRef:r,children:n})},`CollectionProvider`);o.displayName=t;let s=e+`CollectionSlot`,c=mi(s),l=_.forwardRef((e,t)=>{let{scope:n,children:r}=e,i=Fr(t,a(s,n).collectionRef);return(0,z.jsx)(c,{ref:i,children:r})});l.displayName=s;let u=e+`CollectionItemSlot`,d=`data-radix-collection-item`,f=mi(u),p=_.forwardRef((e,t)=>{let{scope:n,children:r,...i}=e,o=_.useRef(null),s=Fr(t,o),c=a(u,n);return _.useEffect(()=>(c.itemMap.set(o,{ref:o,...i}),()=>void c.itemMap.delete(o))),(0,z.jsx)(f,{[d]:``,ref:s,children:r})});p.displayName=u;function m(t){let n=a(e+`CollectionConsumer`,t);return _.useCallback(()=>{let e=n.collectionRef.current;if(!e)return[];let t=Array.from(e.querySelectorAll(`[${d}]`));return Array.from(n.itemMap.values()).sort((e,n)=>t.indexOf(e.ref.current)-t.indexOf(n.ref.current))},[n.collectionRef,n.itemMap])}return B(m,`useCollection`),[{Provider:o,Slot:l,ItemSlot:p},m,r]}B(V,`createCollection`);var H=new WeakMap,Mi=class e extends Map{static{B(this,`OrderedDict`)}#e;constructor(e){super(e),this.#e=[...super.keys()],H.set(this,!0)}set(e,t){return H.get(this)&&(this.has(e)?this.#e[this.#e.indexOf(e)]=e:this.#e.push(e)),super.set(e,t),this}insert(e,t,n){let r=this.has(t),i=this.#e.length,a=Fi(e),o=a>=0?a:i+a,s=o<0||o>=i?-1:o;if(s===this.size||r&&s===this.size-1||s===-1)return this.set(t,n),this;let c=this.size+ +!r;a<0&&o++;let l=[...this.#e],u,d=!1;for(let e=o;e<c;e++)if(o===e){let i=l[e];l[e]===t&&(i=l[e+1]),r&&this.delete(t),u=this.get(i),this.set(t,n)}else{!d&&l[e-1]===t&&(d=!0);let n=l[d?e:e-1],r=u;u=this.get(n),this.delete(n),this.set(n,r)}return this}with(t,n,r){let i=new e(this);return i.insert(t,n,r),i}before(e){let t=this.#e.indexOf(e)-1;if(!(t<0))return this.entryAt(t)}setBefore(e,t,n){let r=this.#e.indexOf(e);return r===-1?this:this.insert(r,t,n)}after(e){let t=this.#e.indexOf(e);if(t=t===-1||t===this.size-1?-1:t+1,t!==-1)return this.entryAt(t)}setAfter(e,t,n){let r=this.#e.indexOf(e);return r===-1?this:this.insert(r+1,t,n)}first(){return this.entryAt(0)}last(){return this.entryAt(-1)}clear(){return this.#e=[],super.clear()}delete(e){let t=super.delete(e);return t&&this.#e.splice(this.#e.indexOf(e),1),t}deleteAt(e){let t=this.keyAt(e);return t!==void 0&&this.delete(t)}at(e){let t=Ni(this.#e,e);if(t!==void 0)return this.get(t)}entryAt(e){let t=Ni(this.#e,e);if(t!==void 0)return[t,this.get(t)]}indexOf(e){return this.#e.indexOf(e)}keyAt(e){return Ni(this.#e,e)}from(e,t){let n=this.indexOf(e);if(n===-1)return;let r=n+t;return r<0&&(r=0),r>=this.size&&(r=this.size-1),this.at(r)}keyFrom(e,t){let n=this.indexOf(e);if(n===-1)return;let r=n+t;return r<0&&(r=0),r>=this.size&&(r=this.size-1),this.keyAt(r)}find(e,t){let n=0;for(let r of this){if(Reflect.apply(e,t,[r,n,this]))return r;n++}}findIndex(e,t){let n=0;for(let r of this){if(Reflect.apply(e,t,[r,n,this]))return n;n++}return-1}filter(t,n){let r=[],i=0;for(let e of this)Reflect.apply(t,n,[e,i,this])&&r.push(e),i++;return new e(r)}map(t,n){let r=[],i=0;for(let e of this)r.push([e[0],Reflect.apply(t,n,[e,i,this])]),i++;return new e(r)}reduce(...e){let[t,n]=e,r=0,i=n??this.at(0);for(let n of this)i=r===0&&e.length===1?n:Reflect.apply(t,this,[i,n,r,this]),r++;return i}reduceRight(...e){let[t,n]=e,r=n??this.at(-1);for(let n=this.size-1;n>=0;n--){let i=this.at(n);r=n===this.size-1&&e.length===1?i:Reflect.apply(t,this,[r,i,n,this])}return r}toSorted(t){let n=[...this.entries()].sort(t);return new e(n)}toReversed(){let t=new e;for(let e=this.size-1;e>=0;e--){let n=this.keyAt(e),r=this.get(n);t.set(n,r)}return t}toSpliced(...t){let n=[...this.entries()];return n.splice(...t),new e(n)}slice(t,n){let r=new e,i=this.size-1;if(t===void 0)return r;t<0&&(t+=this.size),n!==void 0&&n>0&&(i=n-1);for(let e=t;e<=i;e++){let t=this.keyAt(e),n=this.get(t);r.set(t,n)}return r}every(e,t){let n=0;for(let r of this){if(!Reflect.apply(e,t,[r,n,this]))return!1;n++}return!0}some(e,t){let n=0;for(let r of this){if(Reflect.apply(e,t,[r,n,this]))return!0;n++}return!1}};function Ni(e,t){if(`at`in Array.prototype)return Array.prototype.at.call(e,t);let n=Pi(e,t);return n===-1?void 0:e[n]}B(Ni,`at`);function Pi(e,t){let n=e.length,r=Fi(t),i=r>=0?r:n+r;return i<0||i>=n?-1:i}B(Pi,`toSafeIndex`);function Fi(e){return e!==e||e===0?0:Math.trunc(e)}B(Fi,`toSafeInteger`);function Ii(e){let t=e+`CollectionProvider`,[n,r]=zr(t),[i,a]=n(t,{collectionElement:null,collectionRef:{current:null},collectionRefObject:{current:null},itemMap:new Mi,setItemMap:B(()=>void 0,`setItemMap`)}),o=B(({state:e,...t})=>e?(0,z.jsx)(c,{...t,state:e}):(0,z.jsx)(s,{...t}),`CollectionProvider`);o.displayName=t;let s=B(e=>{let t=h();return(0,z.jsx)(c,{...e,state:t})},`CollectionInit`);s.displayName=t+`Init`;let c=B(e=>{let{scope:t,children:n,state:r}=e,a=_.useRef(null),[o,s]=_.useState(null),c=Fr(a,s),[l,u]=r;return _.useEffect(()=>{if(!o)return;let e=Bi(()=>{});return e.observe(o,{childList:!0,subtree:!0}),()=>{e.disconnect()}},[o]),(0,z.jsx)(i,{scope:t,itemMap:l,setItemMap:u,collectionRef:c,collectionRefObject:a,collectionElement:o,children:n})},`CollectionProviderImpl`);c.displayName=t+`Impl`;let l=e+`CollectionSlot`,u=mi(l),d=_.forwardRef((e,t)=>{let{scope:n,children:r}=e,i=Fr(t,a(l,n).collectionRef);return(0,z.jsx)(u,{ref:i,children:r})});d.displayName=l;let f=e+`CollectionItemSlot`,p=mi(f),m=_.forwardRef((e,t)=>{let{scope:n,children:r,...i}=e,o=_.useRef(null),[s,c]=_.useState(null),l=Fr(t,o,c),{setItemMap:u}=a(f,n),d=_.useRef(i);Li(d.current,i)||(d.current=i);let m=d.current;return _.useEffect(()=>{let e=m;return u(t=>s?t.has(s)?t.set(s,{...e,element:s}).toSorted(zi):(t.set(s,{...e,element:s}),t.toSorted(zi)):t),()=>{u(e=>!s||!e.has(s)?e:(e.delete(s),new Mi(e)))}},[s,m,u]),(0,z.jsx)(p,{"data-radix-collection-item":``,ref:l,children:r})});m.displayName=f;function h(){return _.useState(new Mi)}B(h,`useInitCollection`);function g(t){let{itemMap:n}=a(e+`CollectionConsumer`,t);return n}return B(g,`useCollection`),[{Provider:o,Slot:d,ItemSlot:m},{createCollectionScope:r,useCollection:g,useInitCollection:h}]}B(Ii,`createCollection`);function Li(e,t){if(e===t)return!0;if(typeof e!=`object`||typeof t!=`object`||e==null||t==null)return!1;let n=Object.keys(e),r=Object.keys(t);if(n.length!==r.length)return!1;for(let r of n)if(!Object.prototype.hasOwnProperty.call(t,r)||e[r]!==t[r])return!1;return!0}B(Li,`shallowEqual`);function Ri(e,t){return!!(t.compareDocumentPosition(e)&Node.DOCUMENT_POSITION_PRECEDING)}B(Ri,`isElementPreceding`);function zi(e,t){return!e[1].element||!t[1].element?0:Ri(e[1].element,t[1].element)?-1:1}B(zi,`sortByDocumentPosition`);function Bi(e){return new MutationObserver(t=>{for(let n of t)if(n.type===`childList`){e();return}})}B(Bi,`getChildListObserver`);var Vi=Object.defineProperty,U=(e,t)=>Vi(e,`name`,{value:t,configurable:!0}),Hi=[`PageUp`,`PageDown`],Ui=[`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`],Wi={"from-left":[`Home`,`PageDown`,`ArrowDown`,`ArrowLeft`],"from-right":[`Home`,`PageDown`,`ArrowDown`,`ArrowRight`],"from-bottom":[`Home`,`PageDown`,`ArrowDown`,`ArrowLeft`],"from-top":[`Home`,`PageDown`,`ArrowUp`,`ArrowLeft`]},Gi=`Slider`,[Ki,qi,Ji]=V(Gi),[Yi,Xi]=zr(Gi,[Ji]),[Zi,Qi]=Yi(Gi),$i=_.forwardRef(U(function(e,t){let{name:n,min:r=0,max:i=100,step:a=1,orientation:o=`horizontal`,disabled:s=!1,minStepsBetweenThumbs:c=0,defaultValue:l=[r],value:u,onValueChange:d=U(()=>{},`onValueChange`),onValueCommit:f=U(()=>{},`onValueCommit`),inverted:p=!1,form:m,...h}=e,g=_.useRef(new Set),v=_.useRef(0),y=_.useRef(!1),b=o===`horizontal`?na:ra,[x,ee]=_.useState(null),S=Fr(t,ee),[C=[],w]=Xr({prop:u,defaultProp:l,onChange:U(e=>{[...g.current][v.current]?.focus({preventScroll:!0,focusVisible:y.current}),y.current=!1,d(e)},`onChange`)}),T=_.useRef(C),te=_.useRef(C);_.useEffect(()=>{let e=m?x?.ownerDocument.getElementById(m):x?.closest(`form`);if(e instanceof HTMLFormElement){let t=U(()=>w(te.current),`reset`);return e.addEventListener(`reset`,t),()=>e.removeEventListener(`reset`,t)}},[x,m,w]);function E(e){D(e,xa(C,e))}U(E,`handleSlideStart`);function ne(e){D(e,v.current)}U(ne,`handleSlideMove`);function re(){String(C)!==String(T.current)&&f(C)}U(re,`handleSlideEnd`);function D(e,t,{commit:n}={commit:!1}){let o=Ea(a),s=Sr(Da(Math.round((e-r)/a)*a+r,o),[r,i]);w((e=[])=>{let r=va(e,s,t);if(wa(r,c*a)){v.current=r.indexOf(s);let t=String(r)!==String(e);return t&&n&&f(r),t?r:e}return e})}return U(D,`updateValues`),(0,z.jsx)(Zi,{scope:e.__scopeSlider,name:n,disabled:s,min:r,max:i,valueIndexToChangeRef:v,thumbs:g.current,values:C,orientation:o,form:m,children:(0,z.jsx)(Ki.Provider,{scope:e.__scopeSlider,children:(0,z.jsx)(Ki.Slot,{scope:e.__scopeSlider,children:(0,z.jsx)(b,{"aria-disabled":s,"data-disabled":s?``:void 0,...h,ref:S,onPointerDown:Er(h.onPointerDown,()=>{s||(T.current=C,y.current=!1)}),min:r,max:i,inverted:p,onSlideStart:s?void 0:E,onSlideMove:s?void 0:ne,onSlideEnd:s?void 0:re,onHomeKeyDown:()=>{s||(y.current=!0,D(r,0,{commit:!0}))},onEndKeyDown:()=>{s||(y.current=!0,D(i,C.length-1,{commit:!0}))},onStepKeyDown:({event:e,direction:t})=>{if(!s){y.current=!0;let n=Hi.includes(e.key)||e.shiftKey&&Ui.includes(e.key)?10:1,i=v.current,o=C[i];D(Oa(o,{min:r,step:a,direction:t,multiplier:n}),i,{commit:!0})}}})})})})},`Slider`)),[ea,ta]=Yi(Gi,{startEdge:`left`,endEdge:`right`,size:`width`,direction:1}),na=_.forwardRef(U(function(e,t){let{min:n,max:r,dir:i,inverted:a,onSlideStart:o,onSlideMove:s,onSlideEnd:c,onStepKeyDown:l,...u}=e,[d,f]=_.useState(null),p=Fr(t,f),m=_.useRef(void 0),h=ii(i),g=h===`ltr`,v=g&&!a||!g&&a;function y(e){let t=m.current||d.getBoundingClientRect(),i=Ta([0,t.width],v?[n,r]:[r,n]);return m.current=t,i(e-t.left)}return U(y,`getValueFromPointer`),(0,z.jsx)(ea,{scope:e.__scopeSlider,startEdge:v?`left`:`right`,endEdge:v?`right`:`left`,direction:v?1:-1,size:`width`,children:(0,z.jsx)(ia,{dir:h,"data-orientation":`horizontal`,...u,ref:p,style:{...u.style,"--radix-slider-thumb-transform":`translateX(-50%)`},onSlideStart:e=>{let t=y(e.clientX);o?.(t)},onSlideMove:e=>{let t=y(e.clientX);s?.(t)},onSlideEnd:()=>{m.current=void 0,c?.()},onStepKeyDown:e=>{let t=Wi[v?`from-left`:`from-right`].includes(e.key);l?.({event:e,direction:t?-1:1})}})})},`SliderHorizontal`)),ra=_.forwardRef(U(function(e,t){let{min:n,max:r,inverted:i,onSlideStart:a,onSlideMove:o,onSlideEnd:s,onStepKeyDown:c,...l}=e,u=_.useRef(null),d=Fr(t,u),f=_.useRef(void 0),p=!i;function m(e){let t=f.current||u.current.getBoundingClientRect(),i=Ta([0,t.height],p?[r,n]:[n,r]);return f.current=t,i(e-t.top)}return U(m,`getValueFromPointer`),(0,z.jsx)(ea,{scope:e.__scopeSlider,startEdge:p?`bottom`:`top`,endEdge:p?`top`:`bottom`,size:`height`,direction:p?1:-1,children:(0,z.jsx)(ia,{"data-orientation":`vertical`,...l,ref:d,style:{...l.style,"--radix-slider-thumb-transform":`translateY(50%)`},onSlideStart:e=>{let t=m(e.clientY);a?.(t)},onSlideMove:e=>{let t=m(e.clientY);o?.(t)},onSlideEnd:()=>{f.current=void 0,s?.()},onStepKeyDown:e=>{let t=Wi[p?`from-bottom`:`from-top`].includes(e.key);c?.({event:e,direction:t?-1:1})}})})},`SliderVertical`)),ia=_.forwardRef(U(function(e,t){let{__scopeSlider:n,onSlideStart:r,onSlideMove:i,onSlideEnd:a,onHomeKeyDown:o,onEndKeyDown:s,onStepKeyDown:c,...l}=e,u=Qi(Gi,n);return(0,z.jsx)(ki.span,{...l,ref:t,onKeyDown:Er(e.onKeyDown,e=>{e.key===`Home`?(o(e),e.preventDefault()):e.key===`End`?(s(e),e.preventDefault()):Hi.concat(Ui).includes(e.key)&&(c(e),e.preventDefault())}),onPointerDown:Er(e.onPointerDown,e=>{let t=e.target;t.setPointerCapture(e.pointerId),e.preventDefault(),u.thumbs.has(t)?t.focus({preventScroll:!0,focusVisible:!1}):r(e)}),onPointerMove:Er(e.onPointerMove,e=>{e.target.hasPointerCapture(e.pointerId)&&i(e)}),onPointerUp:Er(e.onPointerUp,e=>{let t=e.target;t.hasPointerCapture(e.pointerId)&&(t.releasePointerCapture(e.pointerId),a(e))})})},`SliderImpl`)),aa=`SliderTrack`,oa=_.forwardRef(U(function(e,t){let{__scopeSlider:n,...r}=e,i=Qi(aa,n);return(0,z.jsx)(ki.span,{"data-disabled":i.disabled?``:void 0,"data-orientation":i.orientation,...r,ref:t})},`SliderTrack`)),sa=`SliderRange`,ca=_.forwardRef(U(function(e,t){let{__scopeSlider:n,...r}=e,i=Qi(sa,n),a=ta(sa,n),o=Fr(t,_.useRef(null)),s=i.values.length,c=i.values.map(e=>ya(e,i.min,i.max)),l=s>1?Math.min(...c):0,u=100-Math.max(...c);return(0,z.jsx)(ki.span,{"data-orientation":i.orientation,"data-disabled":i.disabled?``:void 0,...r,ref:o,style:{...e.style,[a.startEdge]:l+`%`,[a.endEdge]:u+`%`}})},`SliderRange`)),[la,ua]=Yi(`SliderThumb`),da=`SliderThumbProvider`;function fa(e){let{__scopeSlider:t,name:n,children:r,internal_do_not_use_render:i}=e,a=Qi(da,t),o=qi(t),[s,c]=_.useState(null),l=_.useMemo(()=>s?o().findIndex(e=>e.ref.current===s):-1,[o,s]),u=ui(s),d=!s||!!a.form||!!s.closest(`form`),f=a.values[l],p=n??(a.name?a.name+(a.values.length>1?`[]`:``):void 0),m=f===void 0?0:ya(f,a.min,a.max);_.useEffect(()=>{if(s)return a.thumbs.add(s),()=>{a.thumbs.delete(s)}},[s,a.thumbs]);let h={value:f,name:p,form:a.form,isFormControl:d,index:l,thumb:s,onThumbChange:c,percent:m,size:u};return(0,z.jsx)(la,{scope:t,...h,children:ka(i)?i(h):r})}U(fa,`SliderThumbProvider`);var pa=`SliderThumbTrigger`,ma=_.forwardRef(U(function(e,t){let{__scopeSlider:n,...r}=e,i=Qi(pa,n),a=ta(pa,n),{index:o,value:s,percent:c,size:l,onThumbChange:u}=ua(pa,n),d=Fr(t,u),f=ba(o,i.values.length),p=l?.[a.size],m=p?Sa(p,c,a.direction):0;return(0,z.jsx)(`span`,{style:{transform:`var(--radix-slider-thumb-transform)`,position:`absolute`,[a.startEdge]:`calc(${c}% + ${m}px)`},children:(0,z.jsx)(Ki.ItemSlot,{scope:n,children:(0,z.jsx)(ki.span,{role:`slider`,"aria-label":e[`aria-label`]||f,"aria-valuemin":i.min,"aria-valuenow":s,"aria-valuemax":i.max,"aria-orientation":i.orientation,"data-orientation":i.orientation,"data-disabled":i.disabled?``:void 0,tabIndex:i.disabled?void 0:0,...r,ref:d,style:s===void 0?{display:`none`}:e.style,onFocus:Er(e.onFocus,()=>{i.valueIndexToChangeRef.current=o})})})})},`SliderThumbTrigger`)),ha=_.forwardRef(U(function(e,t){let{__scopeSlider:n,name:r,...i}=e;return(0,z.jsx)(fa,{__scopeSlider:n,name:r,internal_do_not_use_render:({index:e,isFormControl:r})=>(0,z.jsxs)(z.Fragment,{children:[(0,z.jsx)(ma,{...i,ref:t,__scopeSlider:n}),r?(0,z.jsx)(_a,{__scopeSlider:n},e):null]})})},`SliderThumb`)),ga=`SliderBubbleInput`,_a=_.forwardRef(U(function({__scopeSlider:e,...t},n){let{value:r,name:i,form:a}=ua(ga,e),o=_.useRef(null),s=Fr(o,n),c=si(r);return _.useEffect(()=>{let e=o.current;if(!e)return;let t=window.HTMLInputElement.prototype,n=Object.getOwnPropertyDescriptor(t,`value`).set;if(c!==r&&n){let t=new Event(`input`,{bubbles:!0});n.call(e,r),e.dispatchEvent(t)}},[c,r]),(0,z.jsx)(ki.input,{style:{display:`none`},name:i,form:a,...t,ref:s,defaultValue:r})},`SliderBubbleInput`));function va(e=[],t,n){let r=[...e];return r[n]=t,r.sort((e,t)=>e-t)}U(va,`getNextSortedValues`);function ya(e,t,n){return Sr(100/(n-t)*(e-t),[0,100])}U(ya,`convertValueToPercentage`);function ba(e,t){if(t>2)return`Value ${e+1} of ${t}`;if(t===2)return[`Minimum`,`Maximum`][e]}U(ba,`getLabel`);function xa(e,t){if(e.length===1)return 0;let n=e.map(e=>Math.abs(e-t)),r=Math.min(...n);return n.indexOf(r)}U(xa,`getClosestValueIndex`);function Sa(e,t,n){let r=e/2;return(r-Ta([0,50],[0,r])(t)*n)*n}U(Sa,`getThumbInBoundsOffset`);function Ca(e){return e.slice(0,-1).map((t,n)=>e[n+1]-t)}U(Ca,`getStepsBetweenValues`);function wa(e,t){if(t>0){let n=Ca(e);return Math.min(...n)>=t}return!0}U(wa,`hasMinStepsBetweenValues`);function Ta(e,t){return n=>{if(e[0]===e[1]||t[0]===t[1])return t[0];let r=(t[1]-t[0])/(e[1]-e[0]);return t[0]+r*(n-e[0])}}U(Ta,`linearScale`);function Ea(e){if(!Number.isFinite(e))return 0;let t=e.toString();if(t.includes(`e`)){let[e,n]=t.split(`e`),r=e.split(`.`)[1]||``,i=Number(n);return Math.max(0,r.length-i)}let n=t.split(`.`)[1];return n?n.length:0}U(Ea,`getDecimalCount`);function Da(e,t){let n=10**t;return Math.round(e*n)/n}U(Da,`roundValue`);function Oa(e,{min:t,step:n,direction:r,multiplier:i}){let a=Ea(n),o=(e-t)/n,s=Math.round(o),c=Da(s*n+t,a)===Da(e,a),l;return l=c?s+i*r:r>0?Math.ceil(o):Math.floor(o),Da(l*n+t,a)}U(Oa,`getNextStepValue`);function ka(e){return typeof e==`function`}U(ka,`isFunction`);function Aa({title:e,open:t,onToggle:n,children:r}){return(0,z.jsxs)(`section`,{className:`orc-section`,children:[(0,z.jsxs)(`button`,{type:`button`,className:`orc-section-head`,onClick:n,"aria-expanded":t,children:[(0,z.jsx)(`span`,{children:e}),(0,z.jsx)(dr,{className:Xn(`orc-section-chevron`,t&&`is-open`)})]}),t?(0,z.jsx)(`div`,{className:`orc-section-body`,children:r}):null]})}function ja({label:e,value:t,min:n,max:r,step:i,onChange:a,unit:o}){let s=i<.01?3:i<1?2:0,c=`${t.toFixed(s)}${o??``}`;return(0,z.jsxs)(`div`,{className:`orc-slider`,children:[(0,z.jsxs)(`div`,{className:`orc-slider-head`,children:[(0,z.jsx)(`span`,{children:e}),(0,z.jsx)(`span`,{className:`orc-slider-value`,children:c})]}),(0,z.jsxs)($i,{className:`orc-slider-root`,min:n,max:r,step:i,value:[t],onValueChange:e=>a(e[0]??n),children:[(0,z.jsx)(oa,{className:`orc-slider-track`,children:(0,z.jsx)(ca,{className:`orc-slider-range`})}),(0,z.jsx)(ha,{className:`orc-slider-thumb`,"aria-label":e})]})]})}function Ma({label:e,hex:t,onChange:n}){return(0,z.jsxs)(`label`,{className:`orc-swatch`,children:[(0,z.jsx)(`input`,{type:`color`,value:t.toLowerCase(),"aria-label":e,onChange:e=>n(e.target.value.toUpperCase())}),(0,z.jsxs)(`span`,{className:`orc-swatch-meta`,children:[(0,z.jsx)(`span`,{className:`orc-swatch-label`,children:e}),(0,z.jsx)(`span`,{className:`orc-swatch-hex`,children:t})]})]})}function Na({value:e,options:t,ariaLabel:n,onChange:r}){return(0,z.jsx)(`div`,{className:`orc-segmented`,role:`radiogroup`,"aria-label":n,children:t.map(t=>(0,z.jsx)(`button`,{type:`button`,role:`radio`,"aria-checked":e===t.value,className:Xn(`orc-segment`,e===t.value&&`is-active`),onClick:()=>r(t.value),children:t.label},t.value))})}function Pa({label:e,checked:t,onChange:n}){return(0,z.jsxs)(`label`,{className:`orc-toggle`,children:[(0,z.jsx)(`span`,{children:e}),(0,z.jsx)(`button`,{type:`button`,role:`switch`,"aria-checked":t,className:Xn(`orc-switch`,t&&`is-on`),onClick:()=>n(!t),children:(0,z.jsx)(`span`,{className:`orc-switch-knob`})})]})}var Fa=[{label:`中`,value:`zh`},{label:`EN`,value:`en`}],Ia={zh:{siri:`Siri 波澜`,voiceWave:`声纹薄膜`,spectrum:`彩色声场`,aurora:`极光帷幕`,frost:`冰霜流体`,plasma:`神经电浆`,chrome:`液态铬`,opal:`虹彩欧泊`,blueDrop:`蓝晶液滴`,violetEmber:`紫焰流核`,refractiveBlob:`折射软体`,particleRibbon:`量子丝带`,chromaticMetal:`色差液态金属`},en:{siri:`Siri Wave`,voiceWave:`Voice Membrane`,spectrum:`Prismatic Field`,aurora:`Aurora Veil`,frost:`Frost Flow`,plasma:`Neural Plasma`,chrome:`Liquid Chrome`,opal:`Iridescent Opal`,blueDrop:`Crystal Drop`,violetEmber:`Violet Ember`,refractiveBlob:`Refractive Gel`,particleRibbon:`Particle Ribbons`,chromaticMetal:`Chromatic Metal`}},La={zh:{speed:`速度`,radius:`半径`,contourDeform:`轮廓形变`,zoom:`缩放`,warp:`扭曲`,ridgeAmt:`脊线`,sharp:`锐度`,bandDensity:`重复次数`,metalDepth:`金属深度`,metalRoughness:`表面粗糙度`,chromaticShift:`RGB 分离`,metalScale:`图案缩放`,metalStretch:`纵横拉伸`,metalAngle:`流带角度`,metalOffset:`图案偏移`,metalPhase:`循环相位`,metalEvolution:`演化幅度`,particleDensity:`粒子密度`,ribbonCount:`丝带层数`,ribbonWidth:`丝带宽度`,ribbonTwist:`扭转强度`,ribbonFold:`折叠幅度`,ribbonBreath:`呼吸幅度`,particleSize:`粒子尺寸`,particleBloom:`粒子辉光`,shade:`明暗`,exposure:`曝光`,sheen:`边缘高光`,gloss:`色散`,glassOpacity:`折射强度`,shellMidAlpha:`折射宽度`,shellEdgeAlpha:`边缘强度`,edgeSoftness:`边缘柔化`,edgeGlow:`外发光强度`},en:{speed:`Speed`,radius:`Radius`,contourDeform:`Contour Motion`,zoom:`Flow Scale`,warp:`Flow Distortion`,ridgeAmt:`Ridge Detail`,sharp:`Sharpness`,bandDensity:`Band Count`,metalDepth:`Metallic Depth`,metalRoughness:`Roughness`,chromaticShift:`RGB Split`,metalScale:`Pattern Scale`,metalStretch:`Aspect Stretch`,metalAngle:`Band Angle`,metalOffset:`Pattern Offset`,metalPhase:`Loop Phase`,metalEvolution:`Flow Evolution`,particleDensity:`Particle Density`,ribbonCount:`Ribbon Layers`,ribbonWidth:`Ribbon Width`,ribbonTwist:`Twist`,ribbonFold:`Folding`,ribbonBreath:`Breathing`,particleSize:`Particle Size`,particleBloom:`Particle Bloom`,shade:`Shading`,exposure:`Exposure`,sheen:`Rim Highlight`,gloss:`Dispersion`,glassOpacity:`Refraction Strength`,shellMidAlpha:`Refraction Width`,shellEdgeAlpha:`Edge Intensity`,edgeSoftness:`Edge Softness`,edgeGlow:`Outer Glow`}},Ra={zh:{colorA:`颜色 A`,colorB:`颜色 B`,colorC:`颜色 C`,colorD:`颜色 D`,highlightColor:`提亮色`,shellInner:`折射底色`,shellMid:`冷色散`,shellEdge:`暖色散`,sheenColor:`主高光色`,specColor:`辅高光色`,canvasColor:`背景颜色`,glowColor:`外发光颜色`},en:{colorA:`Color A`,colorB:`Color B`,colorC:`Color C`,colorD:`Color D`,highlightColor:`Highlight Tint`,shellInner:`Refraction Base`,shellMid:`Cool Dispersion`,shellEdge:`Warm Dispersion`,sheenColor:`Key Highlight`,specColor:`Fill Highlight`,canvasColor:`Background`,glowColor:`Glow Color`}},za={zh:{documentTitle:`液态玻璃球编辑器`,presets:`效果预设`,animatedPresets:`动态预设`,orbControls:`球体参数`,collapsePresets:`收起预设面板`,expandPresets:`展开预设面板`,collapseControls:`收起参数面板`,expandControls:`展开参数面板`,resetControls:`重置全部参数`,previewMode:`预览模式`,switchPreviewMode:`切换预览模式`,orbMode:`球体`,sceneMode:`场景`,switchLanguage:`切换界面语言`,orbPreview:`液态玻璃球预览`,scenePreview:`实际场景预览`,staticOrbPreview:`液态玻璃球静态预览`,animatedOrbPreview:`动态液态玻璃球`,loadingOrb:`正在加载球体`,renderFallback:`WebGPU 不可用，当前显示静态预览`,renderErrorTitle:`WebGPU 渲染失败`,sceneText:e=>`场景文字：${e}`,copyCode:`复制代码`,viewSource:`在 GitHub 查看源码`,sceneSection:`场景预览`,displayText:`显示文字`,sceneTextLimit:`最多 20 个字符`,stateSection:`AI 状态`,orbState:`当前状态`,switchOrbState:`切换 AI 球状态`,idleState:`空闲`,thinkingState:`思考中`,activationDuration:`启动时长`,transitionDuration:`回落时长`,collapseSection:e=>`收起${e}`,expandSection:e=>`展开${e}`,editValue:e=>`编辑${e}数值`,selectColor:e=>`选择${e}`,hexValue:e=>`${e}十六进制值`,hexColor:`十六进制颜色`,colorSurface:`颜色饱和度和亮度`,colorChannel:`通道`,cssColorValue:`CSS 颜色值`,hue:`色相`,motionSection:`动态`,colorsSection:`颜色`,shapeSection:`形状动画`,glassSection:`玻璃罩`,enableGlass:`开启玻璃罩`,edgeSection:`边缘与外发光`,copyFailed:`复制失败`,copied:`已复制`,close:`关闭`,webCode:`Web 代码`,swiftCode:`SwiftUI 代码`},en:{documentTitle:`Liquid Orb Editor`,presets:`Presets`,animatedPresets:`Animated presets`,orbControls:`Orb Controls`,collapsePresets:`Collapse presets`,expandPresets:`Expand presets`,collapseControls:`Collapse controls`,expandControls:`Expand controls`,resetControls:`Reset all controls`,previewMode:`Preview`,switchPreviewMode:`Switch preview mode`,orbMode:`Orb`,sceneMode:`Scene`,switchLanguage:`Switch interface language`,orbPreview:`Liquid glass orb preview`,scenePreview:`In-context preview`,staticOrbPreview:`Static liquid glass orb preview`,animatedOrbPreview:`Animated liquid glass orb`,loadingOrb:`Loading orb`,renderFallback:`WebGPU is unavailable. Showing the fallback preview.`,renderErrorTitle:`WebGPU rendering failed`,sceneText:e=>`Scene text: ${e}`,copyCode:`Copy Code`,viewSource:`View source on GitHub`,sceneSection:`Scene Preview`,displayText:`Display Text`,sceneTextLimit:`Up to 20 characters`,stateSection:`AI State`,orbState:`Current State`,switchOrbState:`Switch AI orb state`,idleState:`Idle`,thinkingState:`Thinking`,activationDuration:`Activation Duration`,transitionDuration:`Settle Duration`,collapseSection:e=>`Collapse ${e}`,expandSection:e=>`Expand ${e}`,editValue:e=>`Edit ${e} value`,selectColor:e=>`Choose ${e}`,hexValue:e=>`${e} hex value`,hexColor:`Hex color`,colorSurface:`Color saturation and brightness`,colorChannel:`channel`,cssColorValue:`CSS color value`,hue:`Hue`,motionSection:`Motion`,colorsSection:`Color`,shapeSection:`Shape Motion`,glassSection:`Glass Shell`,enableGlass:`Enable Glass Shell`,edgeSection:`Edge & Glow`,copyFailed:`Copy Failed`,copied:`Copied`,close:`Close`,webCode:`Web code`,swiftCode:`SwiftUI code`}},Ba={zh:{appName:`Apple Orc`,appTag:`液态玻璃球工作台`,embedIframe:`iframe 嵌入`,embedReact:`React 组件`,embedDropin:`项目内引用`,embedJson:`JSON 配置`,widgetHint:`把调好的球体嵌入其它网站或工作台。iframe 适合任意站点；JSON 与组件适合本仓库其它项目。`,hostApi:`宿主可通过 postMessage 切换 idle / thinking。`,originNote:`嵌入地址使用当前站点。部署后把域名换成你的公开地址即可。`,fallbackNote:`当前环境没有 WebGPU，已使用画布回退预览。`,gpuReady:`WebGPU 实时渲染`,shareLink:`复制分享链接`,linkCopied:`链接已复制`},en:{appName:`Apple Orc`,appTag:`Liquid glass orb workbench`,embedIframe:`iframe embed`,embedReact:`React embed`,embedDropin:`In-project import`,embedJson:`JSON config`,widgetHint:`Drop the tuned orb into another site or workbench. Use iframe for any page; JSON and the component for other projects in this repo.`,hostApi:`The host page can switch idle / thinking over postMessage.`,originNote:`Embed URLs use this origin. After deploy, swap in your public domain.`,fallbackNote:`WebGPU is unavailable here. Showing a canvas fallback preview.`,gpuReady:`Live WebGPU render`,shareLink:`Copy share link`,linkCopied:`Link copied`}},Va=[`shellInner`,`shellMid`,`shellEdge`,`sheenColor`,`specColor`],Ha=[`colorA`,`colorB`,`colorC`,`colorD`,`highlightColor`,`canvasColor`];function Ua(){let[e,t]=(0,_.useState)(`en`),[n,r]=(0,_.useState)(()=>({configuration:Ee(C.style),activeState:_e})),[i,a]=(0,_.useState)(`orb`),[o,s]=(0,_.useState)(w),[c,l]=(0,_.useState)(1),[u,d]=(0,_.useState)(!1),[f,p]=(0,_.useState)(`iframe`),[m,h]=(0,_.useState)(null),[g,v]=(0,_.useState)(`loading`),[y,b]=(0,_.useState)({scene:!0,state:!0,motion:!0,colors:!1,shape:!1,glass:!0,edge:!0}),x=(0,_.useRef)(null),S=za[e],T=Ba[e],ne=De(n.configuration,n.activeState),re=(0,_.useRef)({state:n.activeState,params:ne,activationDuration:n.configuration.activationDuration,transitionDuration:n.configuration.transitionDuration});re.current={state:n.activeState,params:ne,activationDuration:n.configuration.activationDuration,transitionDuration:n.configuration.transitionDuration},(0,_.useEffect)(()=>{t(tt()),r(ct()),a(it()),s(at())},[]),(0,_.useEffect)(()=>{nt(e),typeof document<`u`&&(document.documentElement.lang=e===`zh`?`zh-CN`:`en`)},[e]),(0,_.useEffect)(()=>{let e=window.setTimeout(()=>{ut(n,i,o)},500);return()=>window.clearTimeout(e)},[n,i,o]),(0,_.useEffect)(()=>{let e=x.current;if(!e)return;let t=e=>{if(e.target instanceof Element&&e.target.closest(`[data-stage-controls]`))return;e.preventDefault();let t=ce(-e.deltaY*.001,-.1,.1);l(e=>Math.round(ce(e+t,.6,1.6)*100)/100)};return e.addEventListener(`wheel`,t,{passive:!1}),()=>e.removeEventListener(`wheel`,t)},[]);let D=(0,_.useCallback)((e,t)=>{r(n=>({...n,configuration:Oe(n.configuration,n.activeState,e,t)}))},[]),O=(0,_.useCallback)(e=>{r(t=>({activeState:t.activeState,configuration:{...Ee(e),activationDuration:t.configuration.activationDuration,transitionDuration:t.configuration.transitionDuration}}))},[]),ie=(0,_.useCallback)(()=>{r({activeState:_e,configuration:Ee(C.style)}),s(w),l(1)},[]),ae=(0,_.useMemo)(()=>lt(n,i,o),[n,i,o]),k=typeof window>`u`?``:Ge(window.location.origin,`/Apple-orc/`),le=(0,_.useMemo)(()=>$e(n,k,ae,i,o),[n,ae,k,i,o]),N=(0,_.useCallback)(async(e,t)=>{try{await navigator.clipboard.writeText(e),h(t)}catch{h(`error`)}window.setTimeout(()=>h(null),1600)},[]);function P(t){let n=oe.get(t);return!n||!M(n,ne.style)?null:(0,z.jsx)(ja,{label:La[e][t],value:ne[t],min:n.min,max:n.max,step:n.step,onChange:e=>D(t,e)},t)}function F(t){return(0,z.jsx)(Ma,{label:Ra[e][t],hex:ne[t],onChange:e=>D(t,e)},t)}let ue=e=>()=>{b(t=>({...t,[e]:!t[e]}))};return(0,z.jsxs)(`div`,{className:`orc-app`,children:[(0,z.jsx)(`div`,{className:`orc-bg`,"aria-hidden":`true`}),(0,z.jsx)(`aside`,{className:`orc-rail orc-rail-left`,children:(0,z.jsxs)(yr,{sheen:!1,radius:`1.5rem`,padding:`0.9rem`,className:`orc-panel`,children:[(0,z.jsx)(`div`,{className:`orc-panel-title`,children:S.presets}),(0,z.jsx)(`div`,{className:`orc-preset-grid`,children:ee.map(t=>(0,z.jsxs)(`button`,{type:`button`,"aria-pressed":ne.style===t,className:Xn(`orc-preset`,ne.style===t&&`is-active`),onClick:()=>O(t),"aria-label":Ia[e][t],children:[(0,z.jsx)(`img`,{src:se[t],alt:``,className:Xn(`orc-preset-thumb`,A.has(t)&&`is-compact`)}),(0,z.jsx)(`span`,{children:Ia[e][t]})]},t))})]})}),(0,z.jsxs)(`section`,{ref:x,className:`orc-stage`,"data-preview-mode":i,"aria-label":i===`scene`?S.scenePreview:S.orbPreview,children:[(0,z.jsxs)(`div`,{className:`orc-stage-top`,"data-stage-controls":!0,children:[(0,z.jsx)(Na,{ariaLabel:S.switchLanguage,value:e,options:Fa,onChange:t}),(0,z.jsx)(Na,{ariaLabel:S.switchPreviewMode,value:i,options:[{label:S.orbMode,value:`orb`},{label:S.sceneMode,value:`scene`}],onChange:e=>{a(e),l(1)}})]}),(0,z.jsx)(`div`,{className:Xn(`orc-preview`,i===`scene`&&`is-scene`),style:{transform:`scale(${c})`},children:i===`scene`?(0,z.jsxs)(`div`,{className:`orc-scene-pill`,children:[(0,z.jsx)(`div`,{className:`orc-scene-pill-orb`,children:(0,z.jsx)(Qn,{getTarget:()=>re.current,label:S.animatedOrbPreview,onStatus:v})}),(0,z.jsx)(`span`,{className:`orc-scene-pill-text`,children:o||`\xA0`})]}):(0,z.jsx)(`div`,{className:`orc-orb-frame`,children:(0,z.jsx)(Qn,{getTarget:()=>re.current,label:S.animatedOrbPreview,onStatus:v})})}),g===`fallback`?(0,z.jsx)(`p`,{className:`orc-fallback-note`,children:T.fallbackNote}):null,(0,z.jsxs)(`div`,{className:`orc-stage-bottom`,"data-stage-controls":!0,children:[(0,z.jsxs)(`button`,{type:`button`,className:`orc-code-btn`,onClick:()=>d(!0),children:[(0,z.jsx)(fr,{size:16}),S.copyCode]}),(0,z.jsx)(`button`,{type:`button`,className:`orc-icon-btn`,onClick:()=>{let e=`${window.location.origin}${window.location.pathname}#${ae}`;N(e,`link`)},"aria-label":T.shareLink,children:(0,z.jsx)(mr,{size:16})})]})]}),(0,z.jsx)(`aside`,{className:`orc-rail orc-rail-right`,children:(0,z.jsxs)(yr,{sheen:!1,radius:`1.5rem`,padding:`0.85rem`,className:`orc-panel orc-controls`,children:[(0,z.jsxs)(`div`,{className:`orc-panel-title-row`,children:[(0,z.jsx)(`div`,{className:`orc-panel-title`,children:S.orbControls}),(0,z.jsx)(`button`,{type:`button`,className:`orc-icon-btn`,onClick:ie,"aria-label":S.resetControls,children:(0,z.jsx)(gr,{size:14})})]}),(0,z.jsxs)(`div`,{className:`orc-controls-scroll`,children:[i===`scene`?(0,z.jsx)(Aa,{title:S.sceneSection,open:y.scene,onToggle:ue(`scene`),children:(0,z.jsxs)(`label`,{className:`orc-field`,children:[(0,z.jsxs)(`span`,{className:`orc-field-label`,children:[S.displayText,(0,z.jsxs)(`span`,{children:[Array.from(o).length,`/20`]})]}),(0,z.jsx)(`input`,{className:`orc-text-input`,value:o,maxLength:40,onChange:e=>s(j(e.target.value))})]})}):null,(0,z.jsxs)(Aa,{title:S.stateSection,open:y.state,onToggle:ue(`state`),children:[(0,z.jsx)(Na,{ariaLabel:S.switchOrbState,value:n.activeState,options:[{label:S.idleState,value:`idle`},{label:S.thinkingState,value:`thinking`}],onChange:e=>r(t=>({...t,activeState:e}))}),(0,z.jsx)(ja,{label:S.activationDuration,value:n.configuration.activationDuration,min:te.min,max:te.max,step:te.step,unit:`s`,onChange:e=>r(t=>({...t,configuration:{...t.configuration,activationDuration:e}}))}),(0,z.jsx)(ja,{label:S.transitionDuration,value:n.configuration.transitionDuration,min:E.min,max:E.max,step:E.step,unit:`s`,onChange:e=>r(t=>({...t,configuration:{...t.configuration,transitionDuration:e}}))})]}),(0,z.jsx)(Aa,{title:S.motionSection,open:y.motion,onToggle:ue(`motion`),children:P(`speed`)}),(0,z.jsxs)(Aa,{title:S.colorsSection,open:y.colors,onToggle:ue(`colors`),children:[(0,z.jsx)(`div`,{className:`orc-swatch-grid`,children:Ha.map(F)}),P(`shade`),P(`exposure`)]}),(0,z.jsxs)(Aa,{title:S.shapeSection,open:y.shape,onToggle:ue(`shape`),children:[P(`radius`),P(`contourDeform`),P(`zoom`),P(`warp`),P(`ridgeAmt`),P(`sharp`),P(`metalDepth`),P(`metalRoughness`),P(`chromaticShift`),P(`metalScale`),P(`metalStretch`),P(`metalAngle`),P(`bandDensity`),P(`metalOffset`),P(`metalPhase`),P(`metalEvolution`),P(`particleDensity`),P(`ribbonCount`),P(`ribbonWidth`),P(`ribbonTwist`),P(`ribbonFold`),P(`ribbonBreath`),P(`particleSize`),P(`particleBloom`)]}),(0,z.jsxs)(Aa,{title:S.glassSection,open:y.glass,onToggle:ue(`glass`),children:[(0,z.jsx)(Pa,{label:S.enableGlass,checked:ne.glassEnabled,onChange:e=>D(`glassEnabled`,e)}),ne.glassEnabled?(0,z.jsxs)(z.Fragment,{children:[P(`glassOpacity`),P(`sheen`),P(`gloss`),P(`shellMidAlpha`),P(`shellEdgeAlpha`),(0,z.jsx)(`div`,{className:`orc-swatch-grid`,children:Va.map(F)})]}):null]}),(0,z.jsxs)(Aa,{title:S.edgeSection,open:y.edge,onToggle:ue(`edge`),children:[P(`edgeSoftness`),P(`edgeGlow`),F(`glowColor`)]})]})]})}),u?(0,z.jsx)(`div`,{className:`orc-sheet-backdrop`,role:`presentation`,onClick:()=>d(!1),children:(0,z.jsx)(`div`,{className:`orc-sheet`,role:`dialog`,"aria-modal":`true`,"aria-labelledby":`orc-copy-title`,onClick:e=>e.stopPropagation(),children:(0,z.jsxs)(yr,{sheen:!1,radius:`1.6rem`,padding:`1.1rem`,className:`orc-sheet-card`,children:[(0,z.jsxs)(`div`,{className:`orc-sheet-head`,children:[(0,z.jsxs)(`div`,{children:[(0,z.jsx)(`h2`,{id:`orc-copy-title`,children:S.copyCode}),(0,z.jsx)(`p`,{children:T.widgetHint})]}),(0,z.jsx)(`button`,{type:`button`,className:`orc-icon-btn`,onClick:()=>d(!1),"aria-label":S.close,children:(0,z.jsx)(vr,{size:16})})]}),(0,z.jsx)(`div`,{className:`orc-sheet-tabs`,children:[[`iframe`,T.embedIframe],[`react`,T.embedReact],[`dropin`,T.embedDropin],[`json`,T.embedJson],[`web`,S.webCode],[`swift`,S.swiftCode]].map(([e,t])=>(0,z.jsx)(`button`,{type:`button`,className:Xn(`orc-tab`,f===e&&`is-active`),onClick:()=>p(e),children:t},e))}),(0,z.jsx)(`pre`,{className:`orc-code`,children:(0,z.jsx)(`code`,{children:le[f]})}),(0,z.jsxs)(`div`,{className:`orc-sheet-actions`,children:[(0,z.jsx)(`p`,{className:`orc-sheet-hint`,children:T.hostApi}),(0,z.jsxs)(`button`,{type:`button`,className:`orc-code-btn`,onClick:()=>void N(le[f],f),children:[(0,z.jsx)(pr,{size:16}),m===`error`?S.copyFailed:m===f?S.copied:S.copyCode]})]})]})})}):null,m===`link`?(0,z.jsx)(`div`,{className:`orc-toast`,role:`status`,children:T.linkCopied}):null]})}function Wa({preset:e=`siri`,state:t=`thinking`,size:n=72,label:r,params:i,className:a,activationDuration:o=ve,transitionDuration:s=ye}){let c=(0,_.useMemo)(()=>{let t=Ee(e);return i?{...t,activationDuration:o,transitionDuration:s,shared:{...t.shared,...Ga(i)},profiles:{idle:{...t.profiles.idle,...Ka(i)},thinking:{...t.profiles.thinking,...Ka(i)}}}:{...t,activationDuration:o,transitionDuration:s}},[o,i,e,s]),l=De(c,t),u=(0,_.useRef)({state:t,params:l,activationDuration:c.activationDuration,transitionDuration:c.transitionDuration});u.current={state:t,params:l,activationDuration:c.activationDuration,transitionDuration:c.transitionDuration};let d=(0,z.jsx)(Qn,{getTarget:()=>u.current,className:`orc-widget-canvas`,label:r?`${r} orb`:`Apple Orc`});return r?(0,z.jsxs)(`div`,{className:Xn(`orc-scene-pill`,a),children:[(0,z.jsx)(`div`,{className:`orc-scene-pill-orb`,style:{width:n,height:n},children:d}),(0,z.jsx)(`span`,{className:`orc-scene-pill-text`,children:r})]}):(0,z.jsx)(`div`,{className:Xn(`orc-widget`,a),style:{width:n,height:n},children:d})}function Ga(e){let t={...e};return delete t.speed,delete t.contourDeform,delete t.zoom,delete t.warp,delete t.ridgeAmt,delete t.sharp,delete t.shade,delete t.exposure,delete t.edgeGlow,delete t.colorA,delete t.colorB,delete t.colorC,delete t.colorD,delete t.highlightColor,delete t.glowColor,t}function Ka(e){let t=[`speed`,`contourDeform`,`bandDensity`,`chromaticShift`,`metalStretch`,`metalEvolution`,`metalRoughness`,`metalDepth`,`ribbonWidth`,`ribbonTwist`,`ribbonFold`,`ribbonBreath`,`zoom`,`warp`,`ridgeAmt`,`sharp`,`shade`,`exposure`,`edgeGlow`,`colorA`,`colorB`,`colorC`,`colorD`,`highlightColor`,`glowColor`],n={};for(let r of t)e[r]!==void 0&&Object.assign(n,{[r]:e[r]});return n}var qa=`https://github.com/Simon66-workshop/Apple-orc`,Ja=`/Apple-orc/`,Ya=[`interface`,`presets`,`embed`],Xa={interface:`In your interface`,presets:`Preset library`,embed:`iframe lab`};function Za({children:e}){let[t,n]=(0,_.useState)(!1),[r,i]=(0,_.useState)(!1);async function a(){try{await navigator.clipboard.writeText(e),n(!0),i(!1)}catch{i(!0)}}return(0,_.useEffect)(()=>{if(!t)return;let e=setTimeout(()=>n(!1),1800);return()=>clearTimeout(e)},[t]),(0,z.jsxs)(`div`,{className:`showcase-code`,children:[(0,z.jsxs)(`div`,{className:`code-caption`,children:[(0,z.jsx)(`span`,{children:`Integration example`}),(0,z.jsxs)(`button`,{onClick:a,"aria-label":`Copy integration code`,children:[t?(0,z.jsx)(ur,{size:15}):(0,z.jsx)(pr,{size:15}),` `,t?`Copied`:`Copy`]})]}),(0,z.jsx)(`pre`,{tabIndex:0,children:(0,z.jsx)(`code`,{children:e})}),r&&(0,z.jsx)(`p`,{role:`status`,children:`Clipboard unavailable. Select and copy the code.`})]})}function Qa(){let[e,t]=(0,_.useState)(`thinking`),[n,r]=(0,_.useState)(`siri`),[i,a]=(0,_.useState)(`Thinking it through`);return(0,z.jsxs)(`div`,{className:`showcase-interface`,children:[(0,z.jsxs)(`section`,{className:`showcase-intro`,children:[(0,z.jsxs)(`h1`,{children:[`A little presence.`,(0,z.jsx)(`br`,{}),(0,z.jsx)(`span`,{children:`A clearer state.`})]}),(0,z.jsx)(`p`,{children:`A liquid-glass orb for the moments between a question and an answer. Tune its look, then put it in your own interface.`}),(0,z.jsxs)(`div`,{className:`showcase-facts`,children:[`13 presets `,(0,z.jsx)(`span`,{children:`·`}),` React + iframe `,(0,z.jsx)(`span`,{children:`·`}),` MIT`]}),(0,z.jsxs)(`a`,{className:`showcase-primary`,href:Ja,children:[`Open the workbench `,(0,z.jsx)(lr,{size:18})]}),(0,z.jsx)(`p`,{className:`showcase-small`,children:`Interactive component demo. No model or microphone connected.`})]}),(0,z.jsxs)(`section`,{className:`interface-example`,"aria-label":`Live React integration`,children:[(0,z.jsxs)(`div`,{className:`example-top`,children:[(0,z.jsx)(`span`,{children:`Assistant interface`}),(0,z.jsx)(`span`,{className:`local-label`,children:`Local demo`})]}),(0,z.jsx)(`div`,{className:`example-orb`,children:(0,z.jsx)(Wa,{preset:n,state:e,size:260})}),(0,z.jsx)(`h2`,{children:e===`thinking`?i||`Thinking`:`Ready when you are`}),(0,z.jsxs)(`p`,{children:[`The component follows your app state.`,(0,z.jsx)(`br`,{}),`The rest of the conversation is yours.`]}),(0,z.jsxs)(`div`,{className:`state-buttons`,role:`group`,"aria-label":`Component state`,children:[(0,z.jsxs)(`button`,{"aria-pressed":e===`idle`,onClick:()=>t(`idle`),children:[(0,z.jsx)(_r,{size:14}),` Idle`]}),(0,z.jsxs)(`button`,{"aria-pressed":e===`thinking`,onClick:()=>t(`thinking`),children:[(0,z.jsx)(hr,{size:14}),` Thinking`]})]}),(0,z.jsxs)(`div`,{className:`example-config`,children:[(0,z.jsxs)(`label`,{children:[`Preset`,(0,z.jsx)(`select`,{"aria-label":`Preset`,value:n,onChange:e=>r(e.target.value),children:ee.map(e=>(0,z.jsx)(`option`,{value:e,children:Ia.en[e]},e))})]}),(0,z.jsxs)(`label`,{children:[`Status text`,(0,z.jsx)(`input`,{value:i,maxLength:60,onChange:e=>a(e.target.value)})]})]})]}),(0,z.jsxs)(`div`,{className:`interface-code`,children:[(0,z.jsx)(Za,{children:`import { AppleOrc } from "@/lib/orb";\n\n<AppleOrc\n  preset="${n}"\n  state="${e}"\n  size={72}\n  label="${e===`thinking`?`Thinking...`:`Ready`}"\n/>`}),(0,z.jsxs)(`p`,{className:`showcase-small`,children:[`Source import, not an npm package. `,(0,z.jsx)(`a`,{href:`${qa}/blob/main/docs/INTEGRATION.md`,children:`Integration guide ↗`})]})]})]})}var $a=[`siri`,`aurora`,`chromaticMetal`,`plasma`,`opal`,`particleRibbon`];function eo(){let[e,t]=(0,_.useState)(`thinking`),[n,r]=(0,_.useState)(`siri`);return(0,z.jsxs)(`section`,{className:`preset-showcase`,children:[(0,z.jsxs)(`div`,{className:`section-heading`,children:[(0,z.jsxs)(`div`,{children:[(0,z.jsxs)(`h1`,{children:[`Same component.`,(0,z.jsx)(`br`,{}),(0,z.jsx)(`span`,{children:`A different character.`})]}),(0,z.jsx)(`p`,{children:`Six choices from 13 presets. The selected orb is live; the others are preset thumbnails.`})]}),(0,z.jsxs)(`div`,{className:`state-buttons`,"aria-label":`Gallery state`,role:`group`,children:[(0,z.jsx)(`button`,{"aria-pressed":e===`idle`,onClick:()=>t(`idle`),children:`Idle`}),(0,z.jsx)(`button`,{"aria-pressed":e===`thinking`,onClick:()=>t(`thinking`),children:`Thinking`})]})]}),(0,z.jsx)(`div`,{className:`live-preset-grid`,children:$a.map((t,i)=>(0,z.jsxs)(`article`,{"data-active":n===t,children:[(0,z.jsx)(`button`,{className:`preset-orb`,"data-preset":t,"aria-label":`Preview ${Ia.en[t]}`,"aria-pressed":n===t,onClick:()=>r(t),children:n===t?(0,z.jsx)(Wa,{preset:t,state:e,size:170}):(0,z.jsx)(`img`,{src:`${Ja}presets/${t}.png`,width:170,height:170,alt:``})}),(0,z.jsxs)(`div`,{children:[(0,z.jsxs)(`span`,{className:`preset-number`,children:[`0`,i+1,n===t?` · LIVE`:``]}),(0,z.jsx)(`h2`,{children:Ia.en[t]}),(0,z.jsx)(`code`,{children:t})]})]},t))}),(0,z.jsxs)(`a`,{className:`showcase-secondary`,href:Ja,children:[`Tune all 13 presets in the workbench `,(0,z.jsx)(lr,{size:17})]})]})}function to(){let e=(0,_.useRef)(null),[t,n]=(0,_.useState)(!1),[r,i]=(0,_.useState)(`idle`),[a,o]=(0,_.useState)(`Ready when you are`),[s,c]=(0,_.useState)(`Waiting for widget`),l=window.location.origin,u=`${l}${Ja}embed.html?style=aurora&state=idle&preview=scene&text=Ready%20when%20you%20are&parentOrigin=${encodeURIComponent(l)}`;(0,_.useEffect)(()=>{let t=t=>{if(t.source!==e.current?.contentWindow||t.origin!==l||t.data?.source!==`apple-orc`)return;let r=t.data;r.type===`ready`&&(n(!0),c(`ready · parent origin verified`)),r.type===`state`&&(r.state===`idle`||r.state===`thinking`)&&(i(r.state),c(`state · ${r.state}`)),r.type===`pong`&&(n(!0),c(`pong · round trip confirmed`))};return window.addEventListener(`message`,t),()=>window.removeEventListener(`message`,t)},[l]);function d(t,n={}){e.current?.contentWindow?.postMessage({source:`apple-orc`,type:t,...n},l)}function f(e){d(`setState`,{state:e}),d(`setText`,{text:e===`thinking`?`Thinking it through`:a})}return(0,z.jsxs)(`section`,{className:`embed-showcase`,children:[(0,z.jsxs)(`div`,{className:`section-heading`,children:[(0,z.jsxs)(`div`,{children:[(0,z.jsxs)(`h1`,{children:[`Your page.`,(0,z.jsx)(`br`,{}),(0,z.jsx)(`span`,{children:`One small embed.`})]}),(0,z.jsx)(`p`,{children:`This panel controls an actual iframe. The widget replies with its state.`})]}),(0,z.jsx)(fr,{size:32,strokeWidth:1})]}),(0,z.jsxs)(`div`,{className:`embed-layout`,children:[(0,z.jsxs)(`div`,{className:`embed-live`,children:[(0,z.jsxs)(`div`,{className:`example-top`,children:[(0,z.jsx)(`span`,{children:`Host application`}),(0,z.jsx)(`span`,{className:`local-label`,children:`Live iframe`})]}),(0,z.jsxs)(`div`,{className:`embed-stage`,children:[(0,z.jsx)(`iframe`,{title:`Live Apple Orc widget`,ref:e,src:u,onLoad:()=>d(`ping`)}),(0,z.jsx)(`span`,{className:`embed-boundary-label`,children:`The iframe boundary`})]}),(0,z.jsxs)(`div`,{className:`embed-controls`,children:[(0,z.jsxs)(`div`,{className:`state-buttons`,role:`group`,"aria-label":`Iframe state`,children:[(0,z.jsx)(`button`,{disabled:!t,"aria-pressed":r===`idle`,onClick:()=>f(`idle`),children:`Idle`}),(0,z.jsx)(`button`,{disabled:!t,"aria-pressed":r===`thinking`,onClick:()=>f(`thinking`),children:`Thinking`})]}),(0,z.jsxs)(`label`,{children:[`Widget text`,(0,z.jsx)(`input`,{value:a,maxLength:280,onChange:e=>{o(e.target.value),d(`setText`,{text:e.target.value})}})]}),(0,z.jsx)(`button`,{className:`showcase-secondary`,disabled:!t,onClick:()=>d(`ping`),children:`Ping widget`}),(0,z.jsx)(`output`,{"aria-live":`polite`,"data-testid":`widget-event`,children:s})]})]}),(0,z.jsxs)(`div`,{children:[(0,z.jsx)(Za,{children:`const frame = document.querySelector("iframe");
...
);`}),(0,z.jsxs)(`div`,{className:`embed-notes`,children:[(0,z.jsx)(`h2`,{children:`A small, explicit contract.`}),(0,z.jsxs)(`p`,{children:[(0,z.jsx)(`code`,{children:`setState`}),` — idle or thinking`]}),(0,z.jsxs)(`p`,{children:[(0,z.jsx)(`code`,{children:`setText`}),` — up to 280 characters`]}),(0,z.jsxs)(`p`,{children:[(0,z.jsx)(`code`,{children:`ping → pong`}),` — connection check`]}),(0,z.jsx)(`p`,{children:`Messages are checked against the parent window, parent origin and payload schema.`}),(0,z.jsx)(`a`,{href:`${qa}/blob/main/docs/INTEGRATION.md`,children:`Read the integration guide ↗`})]})]})]})]})}function no(){let e=new URLSearchParams(window.location.search).get(`view`),[t,n]=(0,_.useState)(Ya.includes(e)?e:`interface`);function r(e){n(e);let t=new URL(window.location.href);t.searchParams.set(`view`,e),window.history.replaceState(null,``,t)}return(0,_.useEffect)(()=>{document.title=`Apple Orc — Live integration examples`},[]),(0,z.jsxs)(`div`,{className:`showcase-app`,children:[(0,z.jsxs)(`header`,{className:`orc-product-bar`,children:[(0,z.jsxs)(`a`,{className:`orc-wordmark`,href:Ja,children:[`Apple Orc `,(0,z.jsx)(`span`,{children:`by 66Workshop`})]}),(0,z.jsx)(`nav`,{"aria-label":`Showcase views`,children:Ya.map(e=>(0,z.jsx)(`button`,{onClick:()=>r(e),"aria-current":t===e?`page`:void 0,children:Xa[e]},e))}),(0,z.jsxs)(`a`,{className:`github-link`,href:qa,target:`_blank`,rel:`noreferrer`,children:[`GitHub `,(0,z.jsx)(lr,{size:15})]})]}),(0,z.jsx)(`main`,{children:t===`interface`?(0,z.jsx)(Qa,{}):t===`presets`?(0,z.jsx)(eo,{}):(0,z.jsx)(to,{})}),(0,z.jsxs)(`footer`,{children:[(0,z.jsx)(`span`,{children:`Open source. Small by design.`}),(0,z.jsxs)(`span`,{children:[`Shader & motion: `,(0,z.jsx)(`a`,{href:`https://github.com/LerSent001/orb`,children:`LerSent001/orb`}),` · MIT · Independent of Apple`]})]})]})}var ro=`/Apple-orc/`,io=window.location.pathname,ao=/(?:^|\/)embed(?:\.html)?\/?$/.test(io),oo=/(?:^|\/)showcase(?:\.html)?\/?$/.test(io);function so(){return(0,z.jsxs)(`div`,{className:`orc-workbench-shell`,children:[(0,z.jsxs)(`header`,{className:`orc-product-bar`,children:[(0,z.jsxs)(`a`,{href:ro,className:`orc-wordmark`,children:[`Apple Orc `,(0,z.jsx)(`span`,{children:`by 66Workshop`})]}),(0,z.jsxs)(`nav`,{"aria-label":`Product links`,children:[(0,z.jsx)(`a`,{href:`${ro}showcase.html`,children:`Live examples`}),(0,z.jsx)(`a`,{href:`https://github.com/Simon66-workshop/Apple-orc`,target:`_blank`,rel:`noreferrer`,children:`GitHub ↗`})]})]}),(0,z.jsx)(Ua,{})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,z.jsx)(_.StrictMode,{children:ao?(0,z.jsx)(er,{}):oo?(0,z.jsx)(no,{}):(0,z.jsx)(so,{})}));